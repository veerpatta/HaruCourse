...
export const lessonOneFlow: LessonAction[] = [
  { id: 'welcome', section: 'learn', step: 1, kind: 'intro', title: 'What a product designer actually does', instruction: 'A product designer helps decide which problem is worth solving, then shapes the whole experience people use. You will follow one small task, separate facts from guesses, and propose two improvements. Keep this course open beside your chosen app. You can stop after any answer.' },
  { id: 'see-example', section: 'learn', step: 1, kind: 'example', title: 'See UI, UX and product design in one familiar problem', instruction: 'Read the made-up pottery-booking example. The Reserve button is UI. Finding, understanding and booking the class is UX. Deciding whether the real problem deserves a button change, clearer price information or something else is product design.' },

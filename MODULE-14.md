...
**Where to work:** Reading and observation. If you cannot observe a team, the assigned standard and a public project's issue tracker give enough structure to map the stages.
...
Input artifact: Your handover document and system pages.
...
## Review and handoff
- The path is mapped with decision-makers named: [evidence reference]
- Three change points are identified with examples: [evidence reference]
- Presence versus specification is decided per stage: [evidence reference]
- Two failing standard outcomes are named: [evidence reference]
...
**Where to work:** Written work in any text file. Trackers are common in teams and are not required for the exercise.
...
Input artifact: Your findings and a feature you want built.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- Each story names person, capability and reason: [evidence reference]
- Each is independently valuable: [evidence reference]
- Sizes are estimated and large ones re-sliced: [evidence reference]
- At least one re-slice is by outcome, not layer: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** Written criteria beside each story. No tooling required.
...
Input artifact: Your stories and accessibility requirements.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- Criteria are observable by someone without context: [evidence reference]
- Failure paths are covered as well as success: [evidence reference]
- Accessibility criteria come from the m11 work: [evidence reference]
- Criteria describe outcomes rather than implementations: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** Written work. The discipline is deciding and recording, not tooling.
...
Input artifact: Your stories, criteria and the feature they describe.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- An appetite is set before scoping, with a reason: [evidence reference]
- The scope fits and still delivers the outcome: [evidence reference]
- Cuts are recorded with evidence-based return conditions: [evidence reference]
- At least one item is refused outright: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** Conversation and notes. If no engineer is available, ask an informed reader to identify what they could not answer from your story and criteria; the unanswerable parts are the unknowns.
...
Input artifact: Your stories with criteria.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- Three estimates are collected with reasoning: [evidence reference]
- The uncertainty behind each is named and classified: [evidence reference]
- One story is redesigned to remove an unknown: [evidence reference]
- Decisions are separated from genuine effort: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** Your existing documents plus a written decision record. No handover tool is required.
...
Input artifact: Your handover document and criteria.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- Artefacts were sent before the conversation: [evidence reference]
- A decision record exists and was circulated: [evidence reference]
- At least one design change came from the conversation: [evidence reference]
- An escalation route is agreed with a default: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** The built feature, your criteria and a phone. No QA tool is required; a written list is the deliverable.
...
Input artifact: Your criteria and something built to check.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- Every criterion is checked and recorded: [evidence reference]
- Defects and requests are separated and labelled: [evidence reference]
- States including failures were forced and checked: [evidence reference]
- The list is prioritised by harm and actionable: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** Written reports with a screenshot or a short screen recording where it helps. No bug tracker is required for the exercise, though most teams use one.
...
Input artifact: Your QA list with its defects.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- Each report has steps, observed and expected results: [evidence reference]
- Conditions are complete enough to reproduce: [evidence reference]
- The contradicted criterion is quoted: [evidence reference]
- Reproduction was attempted by someone else: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** Written work. One page, or five sentences in a message; the format matters less than the translation.
...
Input artifact: Your research findings and delivery lists.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- The decision criteria are stated, not assumed: [evidence reference]
- Observation and inference are labelled separately: [evidence reference]
- A smaller version exists with what it omits: [evidence reference]
- The honest weakness is written: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** A written agenda, a question, and notes. No meeting tool is required.
...
Input artifact: Work in progress worth discussing.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- Each meeting had a stated purpose and question: [evidence reference]
- Critique produced problems, not approval: [evidence reference]
- Review produced written decisions with owners: [evidence reference]
- The next action has an owner and a date: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** A written plan. Counting support contacts or asking three people needs no analytics tool, and both are legitimate at this scale.
...
Input artifact: A feature ready to release and its criteria.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- What ships and what is held back is decided: [evidence reference]
- Success and failure signals are named in advance: [evidence reference]
- A reversal condition exists with an owner: [evidence reference]
- Unmeasurable things are named with how you will ask: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** A written retrospective and a change log. No facilitation tool is needed for a team of one or a few.
...
Input artifact: Your delivery artefacts from this module.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- Events are described without blaming people: [evidence reference]
- Problems are ranked by cost with estimates: [evidence reference]
- One change is committed with an owner and a date: [evidence reference]
- A check for the change is decided in advance: [evidence reference]
What remains untested:
Next action when I return:

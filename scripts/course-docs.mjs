...
function flowDoc(l) {
  ...
  if(a.beginner) parts.unshift('### Start here: in everyday words\n\n'+a.beginner.plain+'\n\n'+(a.beginner.terms.length?'**Words you will use**\n\n'+a.beginner.terms.map(t=>`- **${t.term}:** ${t.meaning}`).join('\n')+'\n\n':'')+'**Quick example.** '+a.beginner.example+'\n\nThe reader demonstrates and guides the task before asking for “'+a.beginner.returnLabel+'”.\n');
  if(a.beginner && a.ai) parts.push(details('Optional: learn with an AI app',a.ai.purpose+'\n\n'+list(a.ai.setup)+'\n\n```text\n'+a.ai.prompt+'\n```\n\n**Come back to the course:** '+a.ai.followUp+'\n\n**Continue without AI:** '+a.ai.alternative));

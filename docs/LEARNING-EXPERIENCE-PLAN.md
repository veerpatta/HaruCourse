...
| week1-day2-v1 (Frame the problem before the feature) | Worksheet-enabled 7 September 2026: in-app route, 26-field worksheet and five guided steps. Beginner teaching review remains open | Functional evidence and release remain as recorded in docs/VERIFICATION-GUIDED.md. No Haru validation | Re-review after Day 1 pattern is validated |
| week1-day3-v1 (Ask about real experiences) | Worksheet-enabled 7 September 2026; beginner teaching review remains open. No video assigned because VIDC01's segment was not verified | Content checker passes; rendered in the browser sweep. No Haru validation | Re-review after Day 1 pattern; verify VIDC01 before assignment |
| week1-day4-v1 (Map the task and its failures) | Worksheet-enabled: paper route and 15-field worksheet. Beginner teaching review remains open | Content checker, browser render and 320 px layout passed; no Haru validation | Re-review after Day 1 pattern |
| week1-day5-v1 (Make the interface understandable) | Worksheet-enabled: paper route and 16-field worksheet. Beginner teaching review remains open | Content checker and browser sweep passed; no Haru validation | Re-review after Day 1 pattern |
| week1-day6-v1 (Critique and repair, optional) | Worksheet-enabled: 11-field critique, repair, comparison and limitations worksheet. Beginner teaching review remains open | Content checker and browser sweep passed; no Haru validation | Re-review after Day 1 pattern |
| week1-day7-v1 (Explain decisions, optional) | Worksheet-enabled: 14-field decision note. Beginner teaching review remains open | Content checker and browser sweep passed; no Haru validation | Re-review after Day 1 pattern |

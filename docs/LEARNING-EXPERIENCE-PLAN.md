...
| week1-day2-v1 (Frame the problem before the feature) | Refined 7 September 2026: in-app route, 26-field worksheet (unverified explanations, three frames, six assumptions with two priorities and disconfirming evidence, three responses with constraint and weakness, decision), five guided steps with help | Content checker, unit and thirteen-group backend checks pass; browser save and API readback of a frame with the test account; see docs/VERIFICATION-GUIDED.md | Pilot with Haru after lesson 1 |

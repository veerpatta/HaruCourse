...
| Published teaching | src/lessons.ts and src/week2.ts; baseline src/course.ts | App/MCP import these; WEEK-01.md/WEEK-02.md are generated compatibility views |
...
The twelve legacy lessons have teaching, examples, practice, checks and criteria, but are introductory. Deep per-criterion remediation and formal assessment remain authoring/software work. Do not treat the generic repair guidance as a finished assessment system.

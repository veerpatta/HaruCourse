...
| Published teaching | src/lessons.ts, src/week2.ts, src/module3.ts and src/module4.ts; baseline src/course.ts; shared model src/teaching.ts | App/MCP import these; WEEK-01.md, WEEK-02.md, MODULE-03.md, MODULE-04.md and BASELINE-DIAGNOSTIC.md are generated views |

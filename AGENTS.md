...
## Beginner comprehension and optional AI learning plan — 13 September 2026

The creator reports that the detailed course still feels confusing to a beginner and requests a researched brainstorm and plan for every lesson, with plain explanations, exact what/where/how guidance, optional copy/paste AI learning activities, and understandable timer/progress presentation. This request is **Markdown planning only**; it does not authorize implementation or a new release. Read [the beginner experience plan](docs/BEGINNER-EXPERIENCE-PLAN.md), [research](docs/BEGINNER-RESEARCH.md), [AI activity guide](docs/AI-LEARNING-ACTIVITIES.md) and [224-lesson improvement map](docs/BEGINNER-LESSON-PLAN.md) after the authorities below.

Future teaching should explain a familiar situation and demonstrate the thinking before asking for independent work. Keep essential plain-language explanation and examples visible beside the answer; the earlier terse-bullets-only rule must not hide needed teaching. Preserve all required work, IDs, records, Learn → Do → Check → Your work and the established visual style. AI is optional, bounded, text-only, paired with a complete local alternative and a learner-owned return task. It cannot guarantee current facts or replace research/independent work. The diagnostic remains uncoached. Keep automatic active-course time, manually added external time and explicit practice completion distinct. The new plan is not learner validation; pilot and observation gates remain open.

...
**Where to work:** Written work. The system itself will live in Markdown and a stylesheet; no design tool, subscription or documentation platform is needed.
...
Input artifact: Your inventory, token sheet and built pages.
...
## Review and handoff
- Three problems are stated for named people: [evidence reference]
- The current audience is named, not aspirational: [evidence reference]
- An out-of-scope list exists: [evidence reference]
- Maintenance cost and rigidity are stated: [evidence reference]
...
**Where to work:** A Markdown page plus your stylesheet's custom properties. Screenshots or hand-drawn examples for the do-and-do-not pairs; no documentation platform or design tool is required.
...
Input artifact: Your token and interaction sheets.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- Each foundation group has values, rules and reasons: [evidence reference]
- Contrast is measured and permitted pairs listed: [evidence reference]
- Motion values include reduced-motion pairs: [evidence reference]
- Do-and-do-not pairs come from real mistakes: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** A Markdown page with a table for the state grid, plus screenshots or drawings of the variants. Building the component in HTML and CSS makes the states demonstrable and costs an evening.
...
Input artifact: Your inventory and key tables.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- Anatomy names every part including optional ones: [evidence reference]
- The variant-by-state grid is complete: [evidence reference]
- Content rules cover long, missing and unusual values: [evidence reference]
- Keyboard behaviour and boundaries are specified: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** A text editor and a browser, using your token custom properties from m12. The states page is one HTML file; no framework, build step or documentation tool is required.
...
Input artifact: Your component specification and a text editor.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- The component is built entirely from tokens: [evidence reference]
- Every state is demonstrable on one page: [evidence reference]
- Awkward content cases are rendered: [evidence reference]
- Specification problems found are recorded: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** Written decisions plus your existing inventory. Nothing new is built here.
...
Input artifact: Your inventory and one built component.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- A reusable test is written down: [evidence reference]
- Three cases are decided by applying it: [evidence reference]
- Variant counts are checked against a limit: [evidence reference]
- One decision against reuse is recorded: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** Markdown files beside your code, or one HTML page per component with the live example embedded. No documentation platform, account or static-site tool is required.
...
Input artifact: Two specified components.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- Pages open with when to use and when not to: [evidence reference]
- Live examples sit beside the specification: [evidence reference]
- Content rules are where a writer will find them: [evidence reference]
- Reader questions were recorded and turned into content: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** A Markdown page and a decision log file. Issue trackers help and are not required; the process matters more than the tool.
...
Input artifact: Your system purpose and component pages.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- A proposal route with required evidence exists: [evidence reference]
- The decider and response time are named: [evidence reference]
- Acceptance criteria include a composition check: [evidence reference]
- A decision log records at least one rejection with its reason: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** A version number in your documentation and a changelog file. Nothing else is required; the discipline is the deliverable.
...
Input artifact: Your documented components and their change history.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- The system carries a version and a stated scope: [evidence reference]
- Three changes are classified by effect, not size: [evidence reference]
- A change note states what to do and by when: [evidence reference]
- A deprecation rule exists: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** Your existing files. Counting elements by hand on two screens takes fifteen minutes and is accurate enough to steer decisions.
...
Input artifact: Your system and two existing screens.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- Two real screens are migrated: [evidence reference]
- Adoption is measured with a stated method: [evidence reference]
- Blockers are listed with decisions: [evidence reference]
- Product changes made to fit the system are recorded: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** Your existing checks written up as a repeatable list. No auditing tool or service is required at this scale.
...
Input artifact: Your m11 results and component pages.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- Guarantees are limited to component-level properties: [evidence reference]
- Each guarantee has a re-runnable check that was run: [evidence reference]
- Responsibilities left to the user are specific: [evidence reference]
- No page-level conformance is claimed: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** Your existing files. The audit is a comparison by eye and by measurement; nothing needs syncing software.
...
Input artifact: Your documentation and built components.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- An authoritative representation is named with a reason: [evidence reference]
- Copies state what they reflect and when: [evidence reference]
- A drift audit covers at least three components: [evidence reference]
- The change process updates every representation: [evidence reference]
What remains untested:
Next action when I return:
...
**Where to work:** Your existing artefacts and a written plan. Nothing new is required.
...
Input artifact: Your adoption data and decision log.
Source labels: real observation / hypothesis / simulation / self-pilot
...
## Review and handoff
- Usage is reviewed and unused components identified: [evidence reference]
- At least one removal or deprecation went through the process: [evidence reference]
- Workarounds are found in real screens and decided: [evidence reference]
- The plan has an honest estimate and a skip order: [evidence reference]
What remains untested:
Next action when I return:

...
Bring: Your project, its history and its current decisions.
...
What makes a choice strategic rather than tactical, in your own words.
...
**Start here:** Write the difference in one sentence, using the word rules out.
...
Section: practice-plan. Stable action: write-what-makes-strategic.

A strategic choice rules something out. A tactical one decides how to do what was already ruled in.

**Answer:** What makes a choice strategic rather than tactical, in your own words
...
What is always accommodated, what is cut first, and who is never refused, read from behaviour rather than from a document.

- List what the team always accommodates and always cuts.
- List who is never refused and what is never prioritised.

**Start here:** Write what went first the last three times something had to be cut.
...
Made-up example. Reading what a team always cuts, and asking them.
...
**Wrong turn:** The wrong turn is asking what gets cut, because people answer honestly about what they intend. The operating strategy is made of decisions nobody remembers making, which is exactly why the behaviour has to be read rather than reported.

**Trade-off:** Reading three releases takes an afternoon and produces a sentence that contradicts what colleagues sincerely believe about themselves.

**Unknown:** Still unknown: whether the pattern holds over more than three. Three is what I could look at, and the sentence says so.


### What is always accommodated, however small
...
Section: practice-plan. Stable action: write-always-cut.

Write your answer for “What is cut first when time is short”. Use the task instructions below to decide what to include.

**Answer:** What is cut first when time is short
...
Three implied choices, each written as a preference between two things, with the behaviour it is read from.

- Turn the patterns into three stated choices.
- Write each as a preference between two things.

**Start here:** Take your strongest pattern and write it as this over that.
...
Made-up example. Reading the strategy at Northside Tool Library, and reading the document.
...
Section: practice-plan. Stable action: write-choice-1.

Write your answer for “Choice 1 · the preference, and the behaviour it is read from”. Use the task instructions below to decide what to include.

**Answer:** Choice 1 · the preference, and the behaviour it is read from
...
Example (made up): retention over acquisition, read from every request from the two long-standing clients being accommodated while the first-time experience is cut.
...
Section: practice-plan. Stable action: write-choice-2.

Write your answer for “Choice 2 · the preference, and the behaviour it is read from”. Use the task instructions below to decide what to include.

**Answer:** Choice 2 · the preference, and the behaviour it is read from
...
Section: practice-plan. Stable action: write-choice-3.

Write your answer for “Choice 3 · the preference, and the behaviour it is read from”. Use the task instructions below to decide what to include.

**Answer:** Choice 3 · the preference, and the behaviour it is read from
...
What the choices rule out, or a plain statement that they rule nothing out.

- Write what these choices rule out.
- If nothing is ruled out, say so plainly.

**Start here:** For each choice, finish this sentence: “which means we will not …”.
...
Now test your own three choices: does each rule something out?
...
Section: practice-plan. Stable action: write-ruled-out.

Write your answer for “What these choices rule out”. Use the task instructions below to decide what to include.

**Answer:** What these choices rule out
...
Section: practice-plan. Stable action: write-excludes-nothing.

A strategy that excludes nothing is not one. Saying so is a finding rather than a failure of the exercise.

**Answer:** If nothing is ruled out, say so plainly
...
Check again: Each choice names something that actually happened.

Answers to revisit: choice-1, choice-2, choice-3, improvement-made
...
Check again: Step 4 contains either exclusions or a plain statement that there are none.

Answers to revisit: ruled-out, excludes-nothing, improvement-made
...
Check again: Your evidence does not require knowing what anybody meant.

Answers to revisit: never-deliberate, how-you-can-tell, improvement-made
...
Any implied choice that was never deliberately made, with how you can tell.

- Mark any implied choice that was never deliberately made.
- Save the reading with the choices.

**Start here:** Ask of each choice whether anybody would defend it out loud.
...
Section: practice. Stable action: write-never-deliberate.

Write your answer for “Any implied choice you believe was never deliberately made”. Use the task instructions below to decide what to include.

**Answer:** Any implied choice you believe was never deliberately made
...
Section: practice. Stable action: write-how-you-can-tell.

Write your answer for “How you can tell it was an accident rather than a decision”. Use the task instructions below to decide what to include.

**Answer:** How you can tell it was an accident rather than a decision
...
Open Your work and choose Ready for review. The next lesson asks how this product pays for itself.
...
- R47: [Ryan Singer: Shape Up](https://basecamp.com/shapeup/webbook) — Setting the appetite, fixed time with variable scope, and the betting table. Purpose: Supplies a concrete account of strategy as recurring choices under constraint. Free to read online; a print edition is sold and not required. Verified 2026-09-06. It teaches scope strategy and deciding what not to build. It is explicitly not a market-positioning source, and this course has no verified free source for positioning. Fallback: R07.
- R19: [GOV.UK: Service Standard](https://www.gov.uk/service-manual/service-standard) — The point on solving a whole problem for users. Purpose: Gives an outcome-based frame for judging whether a pattern of choices serves anyone. Free reading, no account. Verified 2026-09-06. Public-service obligations differ from commercial ones; take the outcome framing. Fallback: R07.
...
Repair: List the last ten decisions and what each preferred; the pattern is the strategy. Recheck: The behavioural reading.
...
Repair: Rewrite each choice as “we prefer … over …” and check it is falsifiable. Recheck: The three choices.
...
Repair: Ask what request would be refused. If none would, write that down. Recheck: The exclusion list.
...
Bring: Your project and its business context.
...
The exchange written in plain words, with both sides checked as real rather than aspirational.

- Write what each side gives and gets, in plain words.
- Check both sides are real rather than aspirational.

**Start here:** Write what somebody gives up to use this, including time and inconvenience.
...
Example (made up): a member gives a returnable deposit and a trip across town, and gets a tool for a weekend job without buying one. The library gives a tool and staff time, and gets a subscription and a member who stays.

</details>


### How you checked both sides are real rather than aspirational
...
Who pays and who uses, with whose experience wins under conflict and who decided that.
...
Made-up example. Writing the exchange for Northside Tool Library, and writing the nice version.
...
**Wrong turn:** The wrong turn is writing the exchange the organisation would like to be true, because it is on the wall and some of it is real. An aspirational exchange hides the costs people actually pay, and those are where the design decisions are.

**Trade-off:** The honest version is less appealing to read and it makes the library sound like a rental shop, which somebody on the committee will resent.

**Unknown:** Still unknown: how many members are in it for the community. Two conversations found two who were not, and both versions are probably true of somebody.


### Who pays and who uses

Section: practice-plan. Stable action: write-payer-user.

Write your answer for “Who pays and who uses”. Use the task instructions below to decide what to include.

**Answer:** Who pays and who uses




### Where they differ, whose experience wins under conflict, and who decided that

Section: practice-plan. Stable action: write-conflict.

A parent booking for a child, an employer paying for staff, a council funding a service. Someone always loses when they conflict.

**Answer:** Where they differ, whose experience wins under conflict, and who decided that
...
Costs in money, staff time, risk and attention, with the ones your design affects marked.

- List costs in money, staff time, risk and attention.
- Mark which ones your design affects.

**Start here:** Ask what happens after somebody uses your product, and who deals with it.
...
Section: practice-plan. Stable action: write-cost-list.

Write your answer for “Costs in money, staff time, risk and attention”. Use the task instructions below to decide what to include.

**Answer:** Costs in money, staff time, risk and attention
...
Section: practice-plan. Stable action: write-design-affects.

Write your answer for “Which of those your design affects”. Use the task instructions below to decide what to include.

**Answer:** Which of those your design affects
...
One design decision that changes a cost or a value directly, with the mechanism.

- Identify one design decision that changes a cost or a value directly.
- Write the mechanism without inventing figures.

**Start here:** Take the largest cost your design touches and trace how one change would reduce it.
...
Made-up example. Finding a design lever at the tool library, and finding one nobody could act on.
...
**Wrong turn:** The wrong turn is proposing the change that would help most, because the arithmetic on it is obvious. A lever is something your own decisions can move, and the obvious big change is usually somebody else’s to make.

**Trade-off:** The screen change addresses a symptom rather than the cause, and the evening spreadsheet is still the real constraint.
...
Write your answer for “One design decision that changes a cost or a value directly, and the mechanism”. Use the task instructions below to decide what to include.

**Answer:** One design decision that changes a cost or a value directly, and the mechanism
...
Example (made up): making payment status unambiguous removes the phone calls, which is time one member of staff currently spends on the phone rather than checking tools in.
...
Check again: Your description names costs without inventing numbers.
...
Check again: No figure in your description is one you cannot account for.

Answers to revisit: numbers-removed, improvement-made
...
Any unsourced number removed, and the repair the Check questions asked for.

- Remove any number you cannot source.
- Save the description with the lever.

**Start here:** Search your description for every digit and ask where each came from.
...
### Any number you removed because you could not source it

Section: practice. Stable action: write-numbers-removed.
...
**Answer:** Any number you removed because you could not source it
...
Open Your work and choose Ready for review. The next lesson draws what happens behind the interface.
...
- R07: [GOV.UK: discovery phase](https://www.gov.uk/service-manual/agile-delivery/how-the-discovery-phase-works) — What a discovery establishes about constraints and viability. Purpose: Frames the economic description as part of understanding the problem rather than a separate discipline. Free reading, no account. Verified 2026-09-06; published 18 November 2016. Written for public services with no revenue model, so the exchange framing here is the course's own. Fallback: R19.
- R35: [GOV.UK: start by learning user needs](https://www.gov.uk/service-manual/user-research/start-by-learning-user-needs) — Needs across the whole journey, including staff needs. Purpose: Brings the provider's time and effort into view as a real cost. Free reading, no account. Verified 2026-09-06. Its supporting-staff framing is directly useful; it does not discuss commercial exchange. Fallback: R08.
...
Repair: Write what each party actually hands over and actually receives. Recheck: The exchange.
...
Repair: Find a case where the payer and the user want different things and write who wins. Recheck: The payer analysis.
...
Repair: Ask what each design failure costs in someone's time and add it. Recheck: The cost list.
...
One journey chosen, with its stages laid out as the top band from your existing experience map.
...
**Start here:** Take a long sheet of paper and rule three horizontal bands before writing anything.
...
Section: practice-plan. Stable action: write-journey-stages.

Write your answer for “The stages from your existing experience map, as the top band”. Use the task instructions below to decide what to include.

**Answer:** The stages from your existing experience map, as the top band
...
Section: practice-plan. Stable action: write-which-journey.

Write your answer for “Which journey, and why this one”. Use the task instructions below to decide what to include.

**Answer:** Which journey, and why this one




### Add the visible service

Section: practice-plan. Stable action: step-2-brief.

What the service shows or says at each stage, with the line of visibility drawn.

- Add what the product or a person shows or says at each stage.
- Mark the line between visible and invisible.

**Start here:** Draw the line before filling the band below it, so you can see how much is hidden.
...
Made-up example. Drawing the visible band for a tool-library booking, and leaving the waiting out.
...
**Wrong turn:** The wrong turn is drawing the stages the interface has, because those are the screens and the screens are what you designed. Waiting is a stage, and leaving it out hides the longest and worst part of most services.

**Trade-off:** Drawing waiting to scale makes the blueprint ugly and mostly empty, which is an accurate picture of the service.

**Unknown:** Still unknown: what people do during the wait. One rang twice; the others may have done nothing at all, and the blueprint cannot say.


### What the product or a person shows or says at each stage

Section: practice-plan. Stable action: write-visible-band.

Write your answer for “What the product or a person shows or says at each stage”. Use the task instructions below to decide what to include.

**Answer:** What the product or a person shows or says at each stage




### Where the line between visible and invisible falls

Section: practice-plan. Stable action: write-line-marked.

Draw it. Everything below it is invisible to the person and decides most of their experience.

**Answer:** Where the line between visible and invisible falls
...
What staff do and what systems are involved at each stage, with waits and agreements marked, and assumptions labelled.
...
**Start here:** Ask what happens after payment, step by step, until the confirmation goes out.
...
Made-up example. Blueprinting a booking at Northside Tool Library, and treating the delay as an operations problem.
...
**Wrong turn:** The wrong turn is calling it an operations problem, because the cause genuinely is behind the line. A person waiting does not distinguish your interface from your staffing, and a design promising what the operation cannot deliver is the design at fault.

**Trade-off:** The honest pending state is much less satisfying than a confirmation, and somebody will say it makes the product look slow. It is slow, and the person now knows what to expect.

**Unknown:** Still unknown: whether members would prefer a faster process. Changing the evening update is a real option and it belongs to somebody else, and the blueprint is how it gets raised.


### What staff do and what systems are involved at each stage
...
Section: practice-plan. Stable action: write-waits-and-agrees.

Write your answer for “Where work waits for a person, and where two systems must agree”. Use the task instructions below to decide what to include.

**Answer:** Where work waits for a person, and where two systems must agree




### Find the decisive constraints

Section: practice-plan. Stable action: step-4-brief.

Two back-stage facts that determine the front-stage experience, each with what it determines.
...
**Start here:** Go along the back-stage band and ask of each item what the person would notice if it changed.
...
Now mark your own back-stage band the same way, and take your two decisive facts from the first group.
...
Section: practice-plan. Stable action: write-decisive-one.

Write your answer for “Back-stage fact 1, and what it determines about the front-stage experience”. Use the task instructions below to decide what to include.

**Answer:** Back-stage fact 1, and what it determines about the front-stage experience
...
Example (made up): the spreadsheet is updated by hand each evening, so confirmation is not immediate however the screen is designed.
...
Section: practice-plan. Stable action: write-decisive-two.

Write your answer for “Back-stage fact 2, and what it determines”. Use the task instructions below to decide what to include.

**Answer:** Back-stage fact 2, and what it determines
...
Check again: Nothing in your front stage promises something the back stage cannot deliver.

Answers to revisit: front-change, assumed, improvement-made
...
Check again: Assumptions and observations are distinguishable on your blueprint.
...
One front-stage change made because of a back-stage constraint, with anything assumed rather than observed marked.

- Change a front-stage design because of a back-stage constraint.
- Save the blueprint with the change.

**Start here:** Take the decisive fact you cannot change and make the front stage honest about it.
...
Write your answer for “One front-stage change you made because of a back-stage constraint”. Use the task instructions below to decide what to include.

**Answer:** One front-stage change you made because of a back-stage constraint
...
Section: practice. Stable action: write-assumed.

Write your answer for “Anything in the blueprint you had to assume rather than observe”. Use the task instructions below to decide what to include.

**Answer:** Anything in the blueprint you had to assume rather than observe
...
Open Your work and choose Ready for review. The next lesson deals with the case where the person paying is not the person using it.
...
Repair: Add the band beneath your map for what staff and systems do at each stage. Recheck: The blueprint.
...
Repair: Look for where work waits for a person and where systems must agree. Recheck: The two facts.
...
Bring: Your product and its role thinking.
...
What the permission reading gives you and what it does not.
...
**Start here:** Read it for the vocabulary and note the question it leaves open.
...
### What the assigned overview gives you, and what it does not

Section: practice-plan. Stable action: write-vocabulary-note.

It is infrastructure vocabulary. It says nothing about what a screen should show, which is this lesson’s work.

**Answer:** What the assigned overview gives you, and what it does not
...
Three roles described by what they want and are accountable for, with the one who chose the product named.

- Write what each role wants and is accountable for.
- Note which of them chose the product.

**Start here:** Write what each is accountable for rather than what they would like.
...
Example (made up): an office manager buying classes for staff, accountable for the budget and for showing the scheme is used.
...
Section: practice-plan. Stable action: write-administrator.

Write your answer for “The administrator · what they want and what they are accountable for”. Use the task instructions below to decide what to include.

**Answer:** The administrator · what they want and what they are accountable for
...
Section: practice-plan. Stable action: write-everyday-user.

Write your answer for “The everyday user · what they want and what they are accountable for”. Use the task instructions below to decide what to include.

**Answer:** The everyday user · what they want and what they are accountable for
...
Section: practice-plan. Stable action: write-who-chose.

Write your answer for “Which of them chose the product”. Use the task instructions below to decide what to include.

**Answer:** Which of them chose the product
...
Two conflicts named, each with the pair of roles and who currently wins.

- Name two places where the roles want incompatible things.
- Say who currently wins and why.

**Start here:** Ask what the buyer would want that the everyday user would dislike.
...
Made-up example. Designing the business version of a class-booking product, and designing for whoever signed.
...
**Wrong turn:** The wrong turn is building what the buyer asked for, because the buyer signed and the request is reasonable. The buyer decides once; the everyday user decides whether it is still used in a year, and a feature that costs them usage destroys the thing the buyer was buying.
...
Section: practice-plan. Stable action: write-conflict-one.

Write your answer for “Conflict 1 · what two roles want incompatibly, and who currently wins”. Use the task instructions below to decide what to include.

**Answer:** Conflict 1 · what two roles want incompatibly, and who currently wins
...
Example (made up): the buyer wants attendance reporting; the staff member experiences it as surveillance. The buyer wins, because the buyer signed.
...
Section: practice-plan. Stable action: write-conflict-two.

Write your answer for “Conflict 2 · the same, for a different pair”. Use the task instructions below to decide what to include.

**Answer:** Conflict 2 · the same, for a different pair
...
One screen serving two roles without failing the third, showing the everyday user what others can see about them.
...
- serves the administrator at the user’s cost
...
Section: practice-plan. Stable action: write-screen-design.

Write your answer for “The screen, and which two roles it serves”. Use the task instructions below to decide what to include.

**Answer:** The screen, and which two roles it serves




### How it shows the everyday user what others can see about them

Section: practice-plan. Stable action: write-visible-to-others.

Somebody who does not know what their employer sees assumes the worst, which is usually accurate and always corrosive.

**Answer:** How it shows the everyday user what others can see about them
...
Section: practice-plan. Stable action: write-not-failing-third.

Write your answer for “How the third role is not failed by it”. Use the task instructions below to decide what to include.

**Answer:** How the third role is not failed by it
...
Check again: Both conflicts say who wins rather than only that a tension exists.

Answers to revisit: conflict-one, conflict-two, improvement-made
...
Check again: Your alternative answers what the buyer has to show.

Answers to revisit: buyer-instead, improvement-made
...
Check again: The everyday user can see what others can see about them.

Answers to revisit: screen-design, visible-to-others, not-failing-third, improvement-made

</details>


### Give the buyer evidence
...
**Start here:** Write what the buyer has to be able to show, then find the smallest thing that shows it.
...
Made-up example. Answering a buyer’s reporting need, and answering it with less of the same thing.
...
**Wrong turn:** The wrong turn is offering a reduced version of the thing you objected to, because it feels like meeting somebody halfway. A smaller dose of the same harm changes the amount and not the kind.

**Trade-off:** The aggregate genuinely cannot answer a manager asking about one named person, and occasionally somebody has a legitimate reason to ask.

**Unknown:** Still unknown: whether the buyer will accept it at renewal. She has what she needs for the case she has to make, and somebody above her may ask for more.


### What the buyer gets instead of the feature that would cost the user

Section: practice. Stable action: write-buyer-instead.

Write your answer for “What the buyer gets instead of the feature that would cost the user”. Use the task instructions below to decide what to include.

**Answer:** What the buyer gets instead of the feature that would cost the user
...
Open Your work and choose Ready for review. The next lesson traces what happens after people adapt to your design.
...
- R44: [Google Cloud: IAM overview](https://docs.cloud.google.com/iam/docs/overview) — Principals, roles, permissions, inheritance and least privilege. Purpose: Supplies precise vocabulary for describing multi-role products. Free reading, no account. Verified 2026-09-06. Cloud infrastructure documentation, not a role-based interface pattern library: every interface decision here is the course's own. Fallback: R19.
- R19: [GOV.UK: Service Standard](https://www.gov.uk/service-manual/service-standard) — The points on solving a whole problem for users and on making sure everyone can use the service. Purpose: Supports designing for the person who did not choose the product. Free reading, no account. Verified 2026-09-06. Public services have no buyer-user split of this kind; the application is the course's own. Fallback: R07.
...
Repair: For each role write what they are judged on; that explains what they want. Recheck: The role descriptions.
...
Repair: Look for a feature one role wants that another would experience as a cost. Recheck: The conflict list.
...
Repair: Walk the screen as the role you did not design for and write what it costs them. Recheck: The screen.
...
Bring: Your service blueprint.

Starting route: Recommended route: Draw the loop your change sets off, with the delay marked on each arrow on paper, then record what you drew in the worksheet here so it is saved and reviewable. Photograph the sheet if you can and note the file name; the photo stays in your own folder. Alternative route: Prefer one file on your computer? Use the local text-file route below with the copyable starter table, and note the file location in Your work.
...
One change chosen, with what people will do differently once it exists.

- Take a change you have made or plan to make.
- Write what people will do differently once it exists.

**Start here:** Ask what your change makes cheap that used to be expensive.
...
Section: practice-plan. Stable action: write-what-people-do.

The adaptation, not the intention. What does it now make easy that was not easy before?

**Answer:** What people will do differently once it exists
...
The chain traced from adaptation to system effect, whether it feeds back, and the delay on each arrow.
...
Made-up example. Making cancellation one tap at a class provider, and watching the consequence arrive somewhere else.
...
**Wrong turn:** The wrong turn is stopping at the first effect, because it is the one you designed and it was good. Six weeks of delay means the turned-away attendees get attributed to overbooking rather than to a cancellation button.

**Trade-off:** Tracing loops before shipping produces objections to changes that are genuinely improvements, and most of the loops you trace will not happen.

**Unknown:** Still unknown: how much of the rise in late cancellations came from the change. Bookings rose too, and nobody separated the two.


### The chain from the adaptation to its effect on the system

Section: practice-plan. Stable action: write-loop-traced.

Write your answer for “The chain from the adaptation to its effect on the system”. Use the task instructions below to decide what to include.

**Answer:** The chain from the adaptation to its effect on the system
...
Example (made up): one-tap cancellation removes friction, casual bookings rise, late cancellations rise, classes run half-full, the provider reads demand as unreliable.
...
Section: practice-plan. Stable action: write-feeds-back.

Write your answer for “Whether that effect feeds back to the original cause, and how”. Use the task instructions below to decide what to include.

**Answer:** Whether that effect feeds back to the original cause, and how




### The delay on each arrow

Section: practice-plan. Stable action: write-delays.

Delays are what hide loops. An effect six weeks later gets attributed to something else entirely.

**Answer:** The delay on each arrow
...
What each party is rewarded or measured on, and whether your change rewards anything harmful.

- Write what each party is rewarded or measured on.
- Check your change does not reward something harmful.

**Start here:** Write what each party would do more of if they were trying to score well.
...
Made-up example. Checking incentives at a class provider, and checking only the members.
...
**Wrong turn:** The wrong turn is checking the incentives of the people your design is for, because those are the ones you have been thinking about. Everybody in the loop responds to something, and the harmful step is usually somebody else being rational.

**Trade-off:** Taking the provider’s incentive seriously means designing around a behaviour you would rather she did not have, instead of asking her to stop.

**Unknown:** Still unknown: whether she would have stopped overbooking if asked. Possibly, and the structural answer works whether or not she does.


### What each party is rewarded or measured on

Section: practice-plan. Stable action: write-rewarded-for.

Write your answer for “What each party is rewarded or measured on”. Use the task instructions below to decide what to include.

**Answer:** What each party is rewarded or measured on
...
Section: practice-plan. Stable action: write-rewarding-harm.

Write your answer for “Whether your change rewards anything harmful”. Use the task instructions below to decide what to include.

**Answer:** Whether your change rewards anything harmful
...
A structural response that changes what is easy or visible, with a check that it does not create its own loop.

- Change what is easy or visible rather than adding a warning.
- Check the response does not create its own loop.

**Start here:** Ask what would close the loop without anybody having to remember anything.
...
Six responses to the made up cancellation loop. For each one, decide what it would do.

A late cancellation offers the place to a short waiting list automatically.

- a structural response
- a warning in disguise
- a response that creates its own loop
...
### What you changed about what is easy or visible

Section: practice-plan. Stable action: write-structural-response.

Not a warning. A warning asks the person to solve a structural problem by being more careful.

**Answer:** What you changed about what is easy or visible
...
Section: practice-plan. Stable action: write-own-loop.

Write your answer for “Whether your response creates a loop of its own”. Use the task instructions below to decide what to include.

**Answer:** Whether your response creates a loop of its own
...
Check again: Your diagram has times on the arrows.

Answers to revisit: loop-traced, feeds-back, delays, improvement-made
...
Check again: Your response works without anybody remembering anything.

Answers to revisit: structural-response, own-loop, improvement-made
...
Check again: You have looked for a second loop rather than assuming there is none.
...
What you would watch for and when it would appear, and the repair the Check questions asked for.

- Write what you would watch for, and when it would appear.
- Save the loop and the response.

**Start here:** Take the longest delay on your diagram and count forward from the ship date.
...
Section: practice. Stable action: write-watch-for.

Write your answer for “What you would watch for, and when it would appear”. Use the task instructions below to decide what to include.

**Answer:** What you would watch for, and when it would appear
...
Open Your work and choose Ready for review. The next lesson maps the people who can stop any of this happening.
...
- R19: [GOV.UK: Service Standard](https://www.gov.uk/service-manual/service-standard) — The points on solving a whole problem for users and on iterating and improving frequently. Purpose: Frames second-order effects as part of solving the problem rather than as surprises. Free reading, no account. Verified 2026-09-06. It does not teach systems modelling; the loops and delays here are the course's own. Fallback: R07.
- R36: [NN/g: preventing user errors](https://www.nngroup.com/articles/user-mistakes/) — Slips, mistakes and how design shapes behaviour. Purpose: Supports the argument that structure changes behaviour where warnings do not. Free reading, no account. Verified 2026-09-06. Written about individual errors rather than system loops; the extension is this lesson's. Fallback: R02.
...
Repair: Ask what people will do differently once the change exists, then what that causes. Recheck: The effect statement.
...
Repair: Follow your chain until something affects the original cause, and estimate how long each step takes. Recheck: The loop.
...
Repair: Ask what each person is judged on; that predicts what they will do with your change. Recheck: The incentive list.
...
Bring: Your project and its pending decisions.
...
Everybody who can affect or block the work listed by what they are accountable for.
...
### Everybody who can affect or block the work, and what each is accountable for
...
Each person placed on interest and on influence, with the high-interest allies who decide nothing identified.

- Place each on interest and influence.
- Mark the allies with interest and no influence.

**Start here:** Place the two axes on paper and put people on it rather than writing a list.
...
Made-up example. Placing stakeholders for booking work, and placing them by how much they talk.
...
**Wrong turn:** The wrong turn is placing people by how much they contribute in meetings, because volume is the visible signal. It confuses interest with influence and hides the person who knows most.

**Trade-off:** Treating a quiet colleague as the best source means a weekly conversation with somebody whose time is not formally yours to take.

**Unknown:** Still unknown: whether the committee member’s low interest is permanent. Interest changes when something goes wrong, and the map is a snapshot.


### Each person placed on interest and on influence
...
Whose opposition would cost most, and why it is rational from where they stand.

- For the costliest opposition, write why their position is rational.
- Name the cost your work imposes on them.

**Start here:** Write their objection in the first person, as they would put it.
...
Made-up example. Mapping stakeholders for booking work, and reading opposition as obstruction.
...
**Wrong turn:** The wrong turn is reading opposition as obstruction, because that is what it feels like from the other side of it. An objection you cannot construct a rational basis for is one you have not understood, and you cannot answer what you have not understood.

**Trade-off:** Reshaping the proposal around somebody else’s accountability means a smaller piece of work, later, in two parts.

**Unknown:** Still unknown: whether he would have agreed to the original after the date passed. Possibly, and the six weeks of waiting would have cost more than the split did.
...
Section: practice-plan. Stable action: write-rational-basis.

It nearly always is. If you cannot construct it, you have not understood their accountability yet.

**Answer:** Why their opposition is rational from where they stand
...
What your work does for them, or an honest statement that you are asking a favour, with the approach designed.

- Remove or reduce the cost where you can.
- Where you cannot, acknowledge it and say what you are asking for.

**Start here:** Ask what you could change about the proposal rather than about their mind.
...
Six approaches to a made up stakeholder whose objection is rational. For each one, decide what it would achieve.

Cut the scope so it fits inside the time before their committed date.

- addresses their accountability
- ignores it
- makes it worse
...
### What your work does for them, or that you are asking a favour

Section: practice-plan. Stable action: write-what-it-does-for-them.

Both are legitimate. Asking a favour while pretending it is a benefit is not.

**Answer:** What your work does for them, or that you are asking a favour
...
Section: practice-plan. Stable action: write-approach-designed.

Write your answer for “The approach: what you would change, offer or ask”. Use the task instructions below to decide what to include.

**Answer:** The approach: what you would change, offer or ask
...
Check again: You could argue their side convincingly.

Answers to revisit: costliest-opposition, rational-basis, improvement-made
...
Check again: Nobody on your map is described by title alone.

Answers to revisit: people-listed, no-team-route, improvement-made
...
The quiet blocker identified, with what their unstated reservation probably is.

- Identify who could simply never prioritise this.
- Write what would make them prioritise it.

**Start here:** Look for somebody who has been agreeable in every meeting and has done nothing.
...
### The quiet blocker: somebody whose unstated reservations could stop this
...
Open Your work and choose Ready for review. The next lesson decides what to do when the information is not going to arrive.
...
Repair: For each person write what they are judged on at the end of a quarter. Recheck: The accountability map.
...
Repair: Place each person on both axes and look at who cares but cannot act. Recheck: The placement.
...
Repair: Write what your work costs that person in time, risk or accountability. Recheck: The opposition account.
...
Bring: One decision you have been postponing.
...
One open decision, with knowns, assumptions and guesses separated, and which the decision depends on.
...
Made-up example. Listing what was known before a decision, and listing what everybody said.
...
**Wrong turn:** The wrong turn is writing down what everybody believes, because agreement feels like evidence. Repetition inside your own documents is how an assumption becomes a known without anybody checking it.

**Trade-off:** Crossing off most of your knowns is uncomfortable and makes the decision look less well-founded than it felt an hour earlier.

**Unknown:** Still unknown: whether payment confusion is actually common. It is back in the assumption column, where it was all along.
...
Section: practice-plan. Stable action: write-know-assume-guess.

Three separate lists. Most things people call knowns are assumptions with a long history.

**Answer:** What you know, what you assume, and what you are guessing
...
Section: practice-plan. Stable action: write-depends-on.

Write your answer for “Which of them the decision actually depends on”. Use the task instructions below to decide what to include.

**Answer:** Which of them the decision actually depends on




### Assess cost and reversibility

Section: practice-plan. Stable action: step-2-brief.

What being wrong would cost and to whom, how reversible it is for everybody affected, and how much certainty that justifies.

- Write what being wrong would cost and how hard it would be to undo.
- Decide how much certainty this level of cost justifies.

**Start here:** Ask who pays if this is wrong, and whether they can get it back.
...
Section: practice-plan. Stable action: write-cost-if-wrong.

Write your answer for “What being wrong would cost, and to whom”. Use the task instructions below to decide what to include.

**Answer:** What being wrong would cost, and to whom




### How hard it would be to undo, for everybody affected

Section: practice-plan. Stable action: write-how-reversible.

Not how hard for you. The consequences are what have to be reversible.

**Answer:** How hard it would be to undo, for everybody affected
...
Section: practice-plan. Stable action: write-certainty-justified.

Write your answer for “How much certainty this level of cost justifies”. Use the task instructions below to decide what to include.

**Answer:** How much certainty this level of cost justifies




### Find the decisive question

Section: practice-plan. Stable action: step-3-brief.

The finding that would produce a different decision, or a written statement that none would.

- Write which finding would produce a different decision.
- If none would, decide now and record that.

**Start here:** List everything research could tell you, then cross off everything that would not change the choice.
...
Made-up example. Deciding what to build first at a class provider, and asking for more research.
...
**Wrong turn:** The wrong turn is asking for more research without naming what it would change, because it sounds rigorous and postpones a difficult choice. Four of the five things I wanted to know were interesting and irrelevant to the decision in front of me.

**Trade-off:** Deciding on one twenty-minute check means the other four questions stay unanswered, and one of them might have mattered for something else.

**Unknown:** Still unknown: whether a waiting list will actually fill those places. That is the assumption the decision rests on, and it is written down with a check at four weeks.
...
Write your answer for “Which finding would produce a different decision”. Use the task instructions below to decide what to include.

**Answer:** Which finding would produce a different decision




### If no finding would change it, write that and decide now

Section: practice-plan. Stable action: write-none-would.

This is the commonest honest answer, and it is what turns more research into a delay rather than a step.

**Answer:** If no finding would change it, write that and decide now

This is the commonest honest answer, and it is what turns more research into a delay rather than a step.


### Reduce it cheaply if you can

Section: practice-plan. Stable action: step-4-brief.

The cheapest way to reduce the one uncertainty that matters, done if it takes under an hour, with what it showed.
...
**Start here:** Ask what already exists that would answer the decisive question.
...
Six responses to a made up decision that has to be made this week. For each one, decide what it is.

Twenty minutes counting late cancellations in the provider’s existing records.

- a cheap check worth doing
- a delay with a research budget
- deciding with the assumption stated
...
Now find your own cheapest check, and do it if it is under an hour.
...
### The cheapest way to reduce the one uncertainty that matters, and whether you did it

Section: practice-plan. Stable action: write-cheap-check.

Under an hour: do it. Longer: decide with the assumption stated.

**Answer:** The cheapest way to reduce the one uncertainty that matters, and whether you did it
...
Section: practice-plan. Stable action: write-what-it-showed.

Write your answer for “What it showed”. Use the task instructions below to decide what to include.

**Answer:** What it showed
...
Check again: You can name the decisive finding or say there is none.

Answers to revisit: would-change, none-would, improvement-made
...
Check again: Your certainty judgement is proportionate to what being wrong would cost.

Answers to revisit: cost-if-wrong, how-reversible, certainty-justified, improvement-made
...
Check again: Somebody could tell, on the date, whether your assumption held.

Answers to revisit: decision-recorded, check-date, improvement-made

</details>


### Record and set a check

Section: practice. Stable action: step-5-brief.

The decision, the assumption, the reasoning, and a date to check whether the assumption held.

- Record the decision, the assumption and the reasoning.
- Set a date to check whether the assumption held.

**Start here:** Write the assumption in the form: this is right if ….
...
Section: practice. Stable action: write-decision-recorded.

Write your answer for “The decision, the assumption it rests on, and the reasoning”. Use the task instructions below to decide what to include.

**Answer:** The decision, the assumption it rests on, and the reasoning
...
Section: practice. Stable action: write-check-date.

Write your answer for “The date you will check whether the assumption held, and what you will look at”. Use the task instructions below to decide what to include.

**Answer:** The date you will check whether the assumption held, and what you will look at
...
Open Your work and choose Ready for review. The next lesson looks at a gap this course cannot fill for you.
...
Repair: Label each input and ask what evidence you actually have for it. Recheck: The three lists.
...
Repair: Write what happens if this is wrong and how long it would take to undo. Recheck: The assessment.
...
Bring: Your operating-strategy reading and the catalog's rules.
...
The positioning questions you cannot answer, and which design decisions would change with an answer.
...
**Start here:** Write the questions as questions rather than as a topic.
...
Made-up example. Stating a learning gap, and stating it as a subject.
...
**Wrong turn:** The wrong turn is naming the subject, because that is how gaps feel: a topic you do not know. A subject cannot be closed, cannot be assessed against, and cannot be prioritised.
...
Section: practice-plan. Stable action: write-questions-cannot-answer.

Write your answer for “The questions about positioning you cannot currently answer”. Use the task instructions below to decide what to include.

**Answer:** The questions about positioning you cannot currently answer
...
Example (made up): how to describe where a product sits relative to the alternatives people actually consider, without inventing a category.

</details>


### Which of your design decisions would change with an answer

Section: practice-plan. Stable action: write-which-decisions.

If none would, the gap is interesting rather than urgent, and saying so is a useful result.

**Answer:** Which of your design decisions would change with an answer
...
The five checks written out, taken from this course’s own selection rules.

- Read this course's verification and selection rules.
- Write the five checks you will apply to any candidate.

**Start here:** Copy the rules out rather than paraphrasing them.
...
### The five checks you will apply to any candidate source
...
One candidate retrieved and each check applied with its result.

- Find one candidate source and retrieve it.
- Apply each check and record the result.

**Start here:** Open the candidate and look for a date before reading anything else.
...
Made-up example. Looking for a source on positioning, and finding a very good article.
...
**Wrong turn:** The wrong turn is making an exception for quality, because the checks are about verifiability and the article is obviously good. Persuasive is what promotional writing is for, and it is exactly the property that cannot be checked.

**Trade-off:** Rejecting it leaves the gap open, and the alternative route is a library book that takes a fortnight to reach.

**Unknown:** Still unknown: whether its claims are sound. Rejecting it is not saying it is wrong; it is saying I cannot tell, which is a different and more honest position.


### The candidate source, and how you found it

Section: practice-plan. Stable action: write-candidate-found.

Write your answer for “The candidate source, and how you found it”. Use the task instructions below to decide what to include.

**Answer:** The candidate source, and how you found it
...
Section: practice-plan. Stable action: write-check-results.

Write your answer for “Each check applied, with the result”. Use the task instructions below to decide what to include.

**Answer:** Each check applied, with the result
...
A verdict with reasons, and what the source does not cover whatever the verdict.

- Accept, reject or mark it partial, with reasons.
- Write what it does not cover, whatever the verdict.

**Start here:** Write the verdict and then the reason, so the reason does not become an argument for the verdict.
...
Now record your own verdict, with the reasons written so somebody else could check your judgement.
...
Section: practice-plan. Stable action: write-verdict-recorded.

Write your answer for “Accept, reject or partial, with reasons”. Use the task instructions below to decide what to include.

**Answer:** Accept, reject or partial, with reasons
...
Section: practice-plan. Stable action: write-what-not-covered.

Write your answer for “What it does not cover, whatever the verdict”. Use the task instructions below to decide what to include.

**Answer:** What it does not cover, whatever the verdict
...
Check again: Your five checks are about verifiability rather than quality.

Answers to revisit: five-checks, improvement-made
...
Check again: Your verdict rests on the checks rather than on how good the writing is.

Answers to revisit: verdict-recorded, what-not-covered, improvement-made
...
Check again: The gap is documented rather than left as a vague intention.

Answers to revisit: how-to-fill, avoid-claiming, improvement-made
...
A plan for closing the gap without an unverified source, and what you will avoid claiming meanwhile.

- Write how you will fill this without an unverified source.
- Note what you will avoid claiming until you have.

**Start here:** Write what you will not claim before writing how you will learn it.
...
### How you will fill this without an unverified source

Section: practice. Stable action: write-how-to-fill.

A library book is a legitimate route this course cannot link to. Using one is not a paid dependency.

**Answer:** How you will fill this without an unverified source
...
Section: practice. Stable action: write-avoid-claiming.

Write your answer for “What you will avoid claiming until you have”. Use the task instructions below to decide what to include.

**Answer:** What you will avoid claiming until you have
...
Open Your work and choose Ready for review. The next lesson compares the same feature for a consumer and a business context.
...
- R47: [Ryan Singer: Shape Up](https://basecamp.com/shapeup/webbook) — The chapters on appetite and deciding what not to build, re-read as the strategy content this course can verify. Purpose: Marks the boundary between what is sourced here and what is not. Free to read online; print edition sold and not required. Verified 2026-09-06. It is explicitly not a positioning or segmentation source, which is the gap this lesson addresses. Fallback: R07.
- R19: [GOV.UK: Service Standard](https://www.gov.uk/service-manual/service-standard) — The points on understanding users and their needs and on solving a whole problem for users, as the alternative footing for strategic argument. Purpose: Gives a verified basis for strategic reasoning that does not depend on positioning theory. Free reading, no account. Verified 2026-09-06. Public-service framing with no market context, which is precisely why the gap remains. Fallback: R07.
...
Repair: Write the positioning questions someone could ask you that you could not answer. Recheck: The gap statement.
...
Repair: Open the page, apply the five checks and write the answers. Recheck: The assessment.
...
Repair: Write the verdict and the boundary in the same form the catalog uses. Recheck: The verdict.
...
Bring: Your role mapping from earlier in this module.

Starting route: Recommended route: Draw the same feature twice, once for a consumer and once for a business context on paper, then record what you drew in the worksheet here so it is saved and reviewable. Photograph the sheet if you can and note the file name; the photo stays in your own folder. Alternative route: Prefer one file on your computer? Use the local text-file route below with the copyable starter table, and note the file location in Your work.
...
What a business context adds that a consumer one does not.
...
**Start here:** List what changes when the person did not choose the product.
...
Made-up example. Listing what a business context adds, and listing features.
...
**Wrong turn:** The wrong turn is listing what business software has, because those products exist and their features are visible. Copying the features produces a screen that looks like enterprise software without being right for anybody.

**Trade-off:** Deriving from conditions is slower and produces a shorter list, and it will omit features somebody expects to see because other products have them.

**Unknown:** Still unknown: whether single sign-on matters here. It is on nobody’s list of conditions and it may be the first thing a buyer asks about.


### What a business context adds that a consumer one does not

Section: practice-plan. Stable action: write-business-adds.

Administrators, auditability, somebody else’s money, mandatory use, and a person who will do this monthly for two years.

**Answer:** What a business context adds that a consumer one does not

Administrators, auditability, somebody else’s money, mandatory use, and a person who will do this monthly for two years.


### Design the consumer version

Section: practice-plan. Stable action: step-2-brief.

The feature designed for a first-time, self-selected user, with what you optimised for.

- Design for a first-time, self-selected user.
- Note what you optimised for.

**Start here:** Design it for somebody who has never seen your product and may not come back.
...
Section: practice-plan. Stable action: write-consumer-optimised.

Write your answer for “What you optimised for”. Use the task instructions below to decide what to include.

**Answer:** What you optimised for




### Design the business version

Section: practice-plan. Stable action: step-3-brief.

The same feature for somebody doing it monthly for staff with somebody else’s money, with the administrator’s task designed.

- Design for someone doing this repeatedly on behalf of others.
- Include the administrator's configuration task.

**Start here:** Count how many times the person will do this in two years before drawing anything.
...
Made-up example. Designing the business version of a booking screen, and designing the consumer one again.
...
**Wrong turn:** The wrong turn is applying consumer instincts to repeated work, because they are good instincts and they feel like quality. A flow optimised for a confident first use, met hourly, produces a product people resent for reasons they cannot articulate.

**Trade-off:** The dense version is genuinely worse for a first-time administrator, and somebody in their first week will find it forbidding. A short introduction is a smaller cost than forty minutes a month for ever.

**Unknown:** Still unknown: how long the first week is. Nobody has watched a new administrator learn it, and the density is a judgement about a trade rather than a measurement of it.


### The same feature for somebody doing it monthly, for staff, with somebody else’s money

Section: practice-plan. Stable action: write-business-design.

Write your answer for “The same feature for somebody doing it monthly, for staff, with somebody else’s money”. Use the task instructions below to decide what to include.

**Answer:** The same feature for somebody doing it monthly, for staff, with somebody else’s money




### The administrator’s task, designed rather than assumed

Section: practice-plan. Stable action: write-admin-task.

They are a user with their own work. Designing for them last is how business software becomes hated.

**Answer:** The administrator’s task, designed rather than assumed
...
Three decisions that differ between the two versions, each with its structural reason.

- Write the three decisions that differ and the structural reason for each.
- Check none of them is merely aesthetic.

**Start here:** For each difference, finish this sentence: “because somebody doing this monthly …”.
...
Six design decisions for the same made up booking feature. For each one, decide which context it suits.
...
Now write your own three differences, with the structural reason rather than the preference behind each.
...
Section: practice-plan. Stable action: write-differ-1.

Write your answer for “Difference 1 · what differs, and the structural reason”. Use the task instructions below to decide what to include.

**Answer:** Difference 1 · what differs, and the structural reason
...
Example (made up): density over spaciousness, because somebody doing this monthly for two years needs to see more at once and is not being introduced to anything.
...
Section: practice-plan. Stable action: write-differ-2.

Write your answer for “Difference 2 · what differs, and the structural reason”. Use the task instructions below to decide what to include.

**Answer:** Difference 2 · what differs, and the structural reason
...
Section: practice-plan. Stable action: write-differ-3.

Write your answer for “Difference 3 · what differs, and the structural reason”. Use the task instructions below to decide what to include.

**Answer:** Difference 3 · what differs, and the structural reason
...
Check again: No difference is justified by preference.

Answers to revisit: differ-1, differ-2, differ-3, improvement-made
...
Check again: Your business version is designed for repetition rather than for a first visit.

Answers to revisit: business-design, admin-task, improvement-made
...
Check again: The administrator’s task is designed rather than borrowed.
...
**Start here:** Ask whether your main user chose the product and how often they use it.
...
Write your answer for “Which context your project actually is, and what follows from that”. Use the task instructions below to decide what to include.

**Answer:** Which context your project actually is, and what follows from that
...
Open Your work and choose Ready for review. The next lesson deals with pressure to design something you should not.
...
- R44: [Google Cloud: IAM overview](https://docs.cloud.google.com/iam/docs/overview) — Roles, inheritance and least privilege. Purpose: Supplies the vocabulary for the administrative surface a business product needs. Free reading, no account. Verified 2026-09-06. Infrastructure documentation rather than an interface pattern library; the administrator's task design is the course's own. Fallback: R19.
- R19: [GOV.UK: Service Standard](https://www.gov.uk/service-manual/service-standard) — The points on having a multidisciplinary team and on solving a whole problem for users. Purpose: Grounds auditability and obligation as design surfaces rather than compliance chores. Free reading, no account. Verified 2026-09-06. Public-sector obligations differ from commercial ones; take the framing. Fallback: R07.
...
Repair: Redesign the business version for someone doing this forty times a week. Recheck: The two designs.
...
Repair: For each difference ask what about the context forced it; if nothing did, it is taste. Recheck: The difference list.
...
Repair: Design the setup task; it is where business software usually fails. Recheck: The administrator design.
...
Bring: Your economics reading and stakeholder map.
...
Three plausible requests, each named as the pattern it is an instance of.

- List requests you could plausibly receive on your product.
- Name the pattern each one is an instance of.

**Start here:** Write requests somebody could plausibly make on a Monday, not ones nobody would make.
...
### Request 1 · what is asked for, and the pattern it is an instance of
...
Example (made up): a countdown saying the place is released in five minutes when it is not. Manufactured urgency, and a false statement.
...
Write your answer for “Request 2 · what is asked for, and the pattern it is an instance of”. Use the task instructions below to decide what to include.

**Answer:** Request 2 · what is asked for, and the pattern it is an instance of
...
Write your answer for “Request 3 · what is asked for, and the pattern it is an instance of”. Use the task instructions below to decide what to include.

**Answer:** Request 3 · what is asked for, and the pattern it is an instance of
...
The legitimate business need underneath each request, checked as real.

- For each, write the legitimate business need underneath.
- Check the need is real rather than a rationalisation.

**Start here:** For each request, ask what somebody is being asked about that made them think of it.
...
Made-up example. Finding the need under a request at a class provider, and accepting the stated one.
...
**Wrong turn:** The wrong turn is designing an honest version of the stated need, because it is right in front of you and it is a real need. Asking why it matters once more usually finds something the original request was only an attempt at.

**Trade-off:** Asking why twice can read as obstruction, particularly from somebody who has already been told no once.

**Unknown:** Still unknown: whether the newsletter is the better route for some classes. It probably is for the ones announced months ahead, and both can exist.


### For each: the legitimate business need underneath

Section: practice-plan. Stable action: write-legitimate-needs.

There nearly always is one. Somebody is accountable for something, and this was their idea of how to reach it.

**Answer:** For each: the legitimate business need underneath
...
Section: practice-plan. Stable action: write-need-real.

Write your answer for “How you checked the need is real rather than a rationalisation”. Use the task instructions below to decide what to include.

**Answer:** How you checked the need is real rather than a rationalisation
...
One honest alternative designed, with what it costs compared with the dishonest version.

- Design an honest way to serve one of those needs.
- Estimate what it would cost compared with the dishonest version.

**Start here:** Take the need and ask what would serve it if the person read everything carefully.
...
Made-up example. Refusing a countdown at a class provider, and refusing it on principle.
...
**Wrong turn:** The wrong turn is refusing on principle without an alternative, because the principle is sound and stating it feels like the whole job. The problem is still there, somebody else solves it worse, and you are no longer in the conversation.
...
Section: practice-plan. Stable action: write-alternative-designed.

Write your answer for “An honest way to serve one of those needs”. Use the task instructions below to decide what to include.

**Answer:** An honest way to serve one of those needs
...
Example (made up): show the genuine number of places left, which is true, urgent when it is urgent, and stops being urgent when it is not.
...
Section: practice-plan. Stable action: write-cost-compared.

Write your answer for “What it would cost compared with the dishonest version”. Use the task instructions below to decide what to include.

**Answer:** What it would cost compared with the dishonest version
...
The sentence you would use to refuse, naming the cost, practised aloud.

- Write the sentence you would use to refuse, naming the cost.
- Practise it aloud so it is available under pressure.

**Start here:** Write the sentence, then say it out loud once. It will be shorter the second time.
...
Six replies to a made up request for a false countdown. For each one, decide what it would achieve.
...
- holds the line and keeps the room
- holds the line and loses the room
- gives way
...
Now write your own sentence, and check it names a cost and offers something.
...
### The sentence you would use to refuse, naming the cost

Section: practice-plan. Stable action: write-refusal-sentence.

Refunds, complaints, staff time, reputation. A refusal in terms of principle alone rarely survives a deadline.

**Answer:** The sentence you would use to refuse, naming the cost
...
Write your answer for “How you practised it, and what was hard to say”. Use the task instructions below to decide what to include.

**Answer:** How you practised it, and what was hard to say
...
Check again: Each request is identified as an instance of something.

Answers to revisit: request-1, request-2, request-3, improvement-made
...
Check again: Your refusal offers something to say yes to.

Answers to revisit: alternative-designed, cost-compared, refusal-sentence, said-aloud, improvement-made
...
Answers to revisit: the-line, improvement-made
...
The line you will not cross, written before anybody asks, and the repair the Check questions asked for.

- Write the line you will not cross, before being asked.
- Save the refusals, the alternative and the limits.

**Start here:** Finish this sentence: “I will not write, draw or specify anything that …”.
...
Section: practice. Stable action: write-the-line.

Write your answer for “The line you will not cross, written before anybody asks”. Use the task instructions below to decide what to include.

**Answer:** The line you will not cross, written before anybody asks
...
Open Your work and choose Ready for review. The next lesson compares your work against one employer’s published expectations.
...
- R36: [NN/g: preventing user errors](https://www.nngroup.com/articles/user-mistakes/) — How design shapes behaviour, and the difference between preventing errors and exploiting them. Purpose: Supports the argument that these patterns work by causing failure rather than by persuading. Free reading, no account. Verified 2026-09-06. It is about error prevention rather than manipulative patterns; the naming and the refusals here are the course's own. Fallback: R02.
- R19: [GOV.UK: Service Standard](https://www.gov.uk/service-manual/service-standard) — The points on making sure everyone can use the service and on solving a whole problem for users. Purpose: Gives a stated standard to cite rather than only a personal preference. Free reading, no account. Verified 2026-09-06. Public-service obligations; a commercial product has no equivalent obligation, which is why the written limits matter. Fallback: R07.
...
Repair: Think of what a provider under revenue pressure would ask for, not what a villain would. Recheck: The three requests.
...
Repair: Ask what the requester is actually trying to achieve, and write that. Recheck: The needs list.
...
Repair: Design the version you would be happy to explain to the person affected. Recheck: The alternative.
...
Bring: Your portfolio of work so far.
...
Each expectation matched to an artefact, or marked read-about where none exists.

- For each expectation, name the artefact that evidences it.
- Where none exists, write read-about rather than done.

**Start here:** For each expectation, name the file or the artefact before deciding whether you can do it.
...
Made-up example. Comparing work against published expectations, and comparing against understanding.
...
**Wrong turn:** The wrong turn is marking what you understand rather than what you can evidence, because understanding is what reading a module produces and it feels like competence. Nothing is dishonest about it until somebody asks for an example.

**Trade-off:** The honest comparison is much shorter and reads as though you have done far less than you have. It is also the only version that produces a plan.

**Unknown:** Still unknown: whether four evidenced expectations is a lot or a little for somebody at this stage. One employer’s page cannot say, and comparing myself to it is the only thing this exercise does.


### For each expectation: the artefact that evidences it

Section: practice-plan. Stable action: write-can-evidence.

A specific artefact from this course or your own work. Not a belief that you could do it.

**Answer:** For each expectation: the artefact that evidences it

A specific artefact from this course or your own work. Not a belief that you could do it.


### Where no artefact exists, marked read-about rather than done

Section: practice-plan. Stable action: write-read-about.

This distinction is the whole value of the exercise. Read-about is honest and it is not evidence.

**Answer:** Where no artefact exists, marked read-about rather than done
...
The expectation whose absence most limits you, with how it is practisable on work you have.

- Choose the expectation whose absence most limits you.
- Check it is practisable on work you actually have.

**Start here:** Ask which gap has already cost you something in the last three months.
...
Write your answer for “The expectation whose absence most limits you, and why”. Use the task instructions below to decide what to include.

**Answer:** The expectation whose absence most limits you, and why




### How it is practisable on work you actually have

Section: practice-plan. Stable action: write-practisable.

If it needs a team you do not have, choose another. A gap you cannot practise is a note rather than a plan.

**Answer:** How it is practisable on work you actually have
...
A plan naming what you will do, on which work, and when, with the evidence it would produce.

- Write what you will do, on which work, and when.
- Name what evidence it would produce.

**Start here:** Write the date before writing the activity; a plan without one is an intention.
...
Six plans for practising a made up leadership expectation. For each one, decide whether it would produce evidence.
...
- needs something you do not have
...
Now write your own plan, and check it produces something somebody could look at.
...
Section: practice-plan. Stable action: write-what-when.

Write your answer for “What you will do, on which work, and when”. Use the task instructions below to decide what to include.

**Answer:** What you will do, on which work, and when
...
Section: practice-plan. Stable action: write-evidence-produced.

Write your answer for “What evidence it would produce”. Use the task instructions below to decide what to include.

**Answer:** What evidence it would produce
...
Check again: Every claimed expectation has something somebody could look at.

Answers to revisit: can-evidence, read-about, improvement-made
...
Check again: Evidenced and read-about are separated in your comparison.
...
Check again: Nobody could read your comparison as a market claim.

Answers to revisit: one-employer, improvement-made
...
A note that this is one employer’s published expectation rather than a market standard, and the repair the Check questions asked for.

- Note that this is one employer's published expectation.
- Save the comparison and the plan.

**Start here:** Write the sentence at the top of the comparison rather than at the end.
...
Made-up example. Recording the limits of a level comparison, and recording them where they would be read last.
...
**Wrong turn:** The wrong turn is putting the limitation at the end, which is where limitations conventionally go. The person most likely to forget the caveat is you, and you read your own documents from the top.

**Trade-off:** Opening with a caveat makes the comparison look weaker before anybody has read it, which is an accurate impression.

**Unknown:** Still unknown: how much these expectations differ between organisations. This course has no verified source that compares them, which is itself worth writing in the learning list.


### The note that this is one employer’s published expectation rather than a market standard

Section: practice. Stable action: write-one-employer.

Write your answer for “The note that this is one employer’s published expectation rather than a market standard”. Use the task instructions below to decide what to include.

**Answer:** The note that this is one employer’s published expectation rather than a market standard
...
Open Your work and choose Ready for review. The last lesson of the module writes the strategy note for your own project.
...
- R48: [GitLab job families: product design management](https://handbook.gitlab.com/job-families/product/product-design-management/) — One management level's expectations: strategic partnership, stakeholder influence, team development and how success is measured. Purpose: Supplies specific published expectations to compare your artefacts against. Free reading, no account. Verified 2026-09-06. One employer's published expectations, not a market standard; its performance measures are its own and this course has no second comparable source. Fallback: R23.
- R19: [GOV.UK: Service Standard](https://www.gov.uk/service-manual/service-standard) — The point on having a multidisciplinary team. Purpose: Frames influence as part of a team's shared accountability rather than as personal advancement. Free reading, no account. Verified 2026-09-06. Public-sector context; the leadership behaviours here come from the job-family source and this course's own framing. Fallback: R07.
...
Repair: For each expectation, name the file or document that demonstrates it. Recheck: The comparison.
...
Repair: Go through and mark anything you cannot point to an artefact for. Recheck: The markers.
...
Repair: Choose the gap you can act on this month with the work you already have. Recheck: The chosen gap.
...
Bring: All this module's outputs.
...
Three choices stated as preferences between real alternatives, each capable of being disagreed with.

- State three choices as preferences between real alternatives.
- Check each one could be disagreed with.

**Start here:** Write each as this over that, and then ask who would argue for that over this.
...
Made-up example. Writing the choices for a strategy note, and writing them as things to do.
...
**Wrong turn:** The wrong turn is writing priorities, because they are what strategy documents usually contain and they all sound right. A priority with no alternative attached is a value, and nobody can disagree with it or be held to it.

**Trade-off:** Writing the other half means naming what you are giving up, in a document somebody else will read, before anybody has complained about it.

**Unknown:** Still unknown: whether the speed trade is right. Nobody knows how many bookings come from repeat members, which is the first item on the learning list for exactly this reason.
...
Example (made up): first-time confidence over power-user speed, because most people book twice a year and never become fluent.
...
Section: practice-plan. Stable action: write-choice-two.

Write your answer for “Choice 2”. Use the task instructions below to decide what to include.
...
Section: practice-plan. Stable action: write-choice-three.

Write your answer for “Choice 3”. Use the task instructions below to decide what to include.
...
Section: practice-plan. Stable action: write-disagreeable.

Write your answer for “How you checked each could be disagreed with”. Use the task instructions below to decide what to include.

**Answer:** How you checked each could be disagreed with
...
What the strategy rules out, including at least one thing you would like to do.

- List what the strategy rules out for this period.
- Include at least one thing you would like to do.

**Start here:** List what you have been meaning to do, and put one of them on the exclusion list.
...
Section: practice-plan. Stable action: write-exclusion-list.

Write your answer for “What the strategy rules out for this period”. Use the task instructions below to decide what to include.

**Answer:** What the strategy rules out for this period




### At least one thing on that list you would like to do

Section: practice-plan. Stable action: write-would-like.

If every exclusion is something you did not want anyway, nothing is being given up.

**Answer:** At least one thing on that list you would like to do
...
Constraints recorded honestly, including the inconvenient ones.

- List the real constraints, including staffing and tooling.
- Do not assume any of them away.

**Start here:** Write the constraints you would rather not write down first.
...
Made-up example. Writing a strategy note for a class-booking project, and writing the constraints selectively.
...
**Wrong turn:** The wrong turn is listing the constraints that reflect well on you, because a note is read by other people and the honest ones sound like complaints or excuses. A plan built on the flattering half is a plan for a different project.

**Trade-off:** Writing your own limited time into a strategy note means it is written down where somebody can read it, and somebody will.

**Unknown:** Still unknown: whether six hours a week is stable. It is what the last two months were, and the note says that rather than promising it.


### The constraints, including the ones you dislike

Section: practice-plan. Stable action: write-constraints-recorded.

Write your answer for “The constraints, including the ones you dislike”. Use the task instructions below to decide what to include.

**Answer:** The constraints, including the ones you dislike
...
Example (made up): one developer part-time, no analytics, a payment provider that cannot be changed, and a provider unavailable between ten and four.

</details>


### List risks and signals

Section: practice-plan. Stable action: step-4-brief.

Risks listed, each with the signal that would tell you it is materialising.
...
**Start here:** Take your traced loop from earlier in the module; it is already a risk with a delay attached.
...
Now read your own note the same way, and cut anything nobody could disagree with.
...
### The risks, each with what would tell you it is materialising

Section: practice-plan. Stable action: write-risks-signals.

A risk with no signal is a worry. The signal is what makes it something you can act on.

**Answer:** The risks, each with what would tell you it is materialising
...
Check again: Somebody could argue for the opposite of each choice.

Answers to revisit: choice-one, choice-two, choice-three, disagreeable, improvement-made
...
Check again: At least one exclusion costs you something.

Answers to revisit: exclusion-list, would-like, improvement-made
...
Check again: At least one constraint is about you or somebody you like.

Answers to revisit: constraints-recorded, improvement-made

</details>


### State what you need to learn

Section: practice. Stable action: step-5-brief.

What you need to learn including this course’s gaps, and confirmation that the note fits on two pages.

- Include this course's recorded gaps where they affect you.
- Save the note where decisions will be made from it.

**Start here:** List what nobody currently knows about your own product before listing what you have not read.
...
### What you would need to learn, including this course’s gaps

Section: practice. Stable action: write-need-to-learn.

Positioning is one of them. So is anything nobody currently knows about your own product.

**Answer:** What you would need to learn, including this course’s gaps
...
Section: practice. Stable action: write-two-pages.

Write your answer for “Confirm it fits on two pages, and what you cut to get there”. Use the task instructions below to decide what to include.

**Answer:** Confirm it fits on two pages, and what you cut to get there
...
Open Your work and choose Ready for review. This closes Module 17. Module 18 is the independent project, where all of this is used on work that is entirely yours.
...
- R47: [Ryan Singer: Shape Up](https://basecamp.com/shapeup/webbook) — Appetite, betting and deciding what not to build. Purpose: Supplies the framing for choices, exclusions and bounded commitments. Free to read online; print edition sold and not required. Verified 2026-09-06. Scope strategy rather than market positioning, which this course still cannot source. Fallback: R07.
- R19: [GOV.UK: Service Standard](https://www.gov.uk/service-manual/service-standard) — The points on solving a whole problem for users, iterating and improving frequently, and defining what success looks like. Purpose: Keeps the note connected to outcomes rather than to intentions. Free reading, no account. Verified 2026-09-06. Public-service framing; the commercial constraints in your note are your own. Fallback: R07.
...
Repair: Rewrite each choice until someone reasonable could argue for the other side. Recheck: The choices.
...
Repair: Add the thing you keep wanting to build and are choosing not to. Recheck: The exclusion list.
...
Repair: List who is available when, and what cannot be changed, then check your choices against them. Recheck: The constraint list.

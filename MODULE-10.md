...
### Every question about this design you still cannot answer
...
**Answer:** Every question about this design you still cannot answer
...
Example (made up): “does the price surprise people at the last step?” — wording and order.
...
One fidelity per question, with the cheaper level named and what it could not have told you.
...
**Start here:** Take your first question and ask what paper could not tell you. If the answer is nothing, it is a paper prototype.
...
Made-up example. Choosing a prototype for a question about wording, and starting far too high.
...
**Trade-off:** Paper feels unimpressive and you will want to apologise for it. It also gets built in an afternoon, so you can rewrite it after the first person hesitates.

**Unknown:** Still unknown: whether people read wording differently on paper than on a screen. That is a real risk, and it is smaller than never asking the question at all.
...
Section: practice-plan. Stable action: write-plan-1.

Write your answer for “Prototype 1 · the question, the fidelity you chose, and what the cheaper level could not answer”. Use the task instructions below to decide what to include.

**Answer:** Prototype 1 · the question, the fidelity you chose, and what the cheaper level could not answer
...
Example (made up): can people find how to change a booking — a clickable prototype of six screens — paper cannot answer it, because on paper I hand over the next sheet and that is me doing the finding.
...
Section: practice-plan. Stable action: write-plan-2.

Write your answer for “Prototype 2 · the question, the fidelity you chose, and what the cheaper level could not answer”. Use the task instructions below to decide what to include.

**Answer:** Prototype 2 · the question, the fidelity you chose, and what the cheaper level could not answer
...
Section: practice-plan. Stable action: write-plan-3.

Write your answer for “Prototype 3 · the question, the fidelity you chose, and what the cheaper level could not answer”. Use the task instructions below to decide what to include.

**Answer:** Prototype 3 · the question, the fidelity you chose, and what the cheaper level could not answer




### Write the untestable lists

Section: practice-plan. Stable action: step-3-brief.

For each prototype, what it cannot establish and the sentence you would like to claim from it.
...
**Start here:** Walk your own prototype and note everything that is pretend: the prices, the waiting, the single path that works.

**Enough:** Each list names a specific sentence you might otherwise have written, not a general limitation.
...
Made-up example. Writing what a paper prototype cannot establish, and writing modesty instead of a limit.
...
**Wrong turn:** The wrong turn is writing the untestable list as modesty about the prototype rather than as a limit on your own sentences. Modesty is comfortable, it sounds honest, and it constrains nothing you write afterwards.

**Trade-off:** Naming the limits leaves you with a narrow claim full of conditions, and somebody will read it and ask whether that is really all you found. You also have to write the list while the prototype still feels promising, which is exactly when you least want to.

**Unknown:** Still unknown: whether the date was easy to read because of the wording or because there was only one item on the sheet. Nothing but a version with six items on it can separate those two.


### For each prototype: the list of things it cannot establish

Section: practice-plan. Stable action: write-untestable-lists.

Invented prices, faked waiting, one working path only, three items where there will one day be sixty.

**Answer:** For each prototype: the list of things it cannot establish
...
Section: practice-plan. Stable action: write-tempting-claim.

Write your answer for “For each prototype: the strongest sentence you would like to claim from it, and whether it is allowed”. Use the task instructions below to decide what to include.

**Answer:** For each prototype: the strongest sentence you would like to claim from it, and whether it is allowed
...
Example (made up): “people find the change route easily.” Not allowed — the prototype has one working path, so finding it is easier there than it will ever be.

</details>


### Start the lowest one

Section: practice-plan. Stable action: step-4-brief.

One prototype built at the lowest fidelity that answers its question, including one failure path.
...
**Start here:** Build only the screens the question needs, then add the one failure from your Module 7 exception table.

**Enough:** You could hand it to somebody and they could reach both the ordinary ending and the failure.
...
Section: practice-plan. Stable action: write-prototype-scope.

Write your answer for “Which question it answers, which fidelity, and how many screens”. Use the task instructions below to decide what to include.

**Answer:** Which question it answers, which fidelity, and how many screens
...
Section: practice-plan. Stable action: write-failure-path.

Write your answer for “The one failure path you included, and how a person reaches it”. Use the task instructions below to decide what to include.

**Answer:** The one failure path you included, and how a person reaches it
...
Section: practice-plan. Stable action: write-prototype-where.

A folder name, or “paper, in my folder”. Nothing is uploaded.

**Answer:** Where the prototype lives
...
Check again: Every choice above paper names something paper could not have told you.

Answers to revisit: plan-1, plan-2, plan-3, improvement-made
...
Check again: Every prototype has a list and a named tempting sentence.

Answers to revisit: untestable-lists, tempting-claim, improvement-made
...
Check again: A person can reach a failure screen from inside the prototype.

Answers to revisit: prototype-scope, failure-path, prototype-where, improvement-made
...
Why you stopped where you did, and the repair the Check questions asked for.
...
**Start here:** Finish this sentence: “I stopped here because the question is already answered, and adding more would only …”.

**Enough:** The note names what you would add, and which later question would make it worth adding.
...
Section: practice. Stable action: write-stopping-note.

Write your answer for “Why you stopped where you did, and what you would add if a later question needed it”. Use the task instructions below to decide what to include.

**Answer:** Why you stopped where you did, and what you would add if a later question needed it
...
Open Your work and choose Ready for review. The next lesson builds the click-through for the flow you chose here.
...
- R12: [GOV.UK: making prototypes](https://www.gov.uk/service-manual/design/making-prototypes) — Choosing what to prototype, the fidelity levels and what each is used to learn. Purpose: Supplies the question-first framing this module runs on. Free reading, no account. Verified 2026-09-06. Written for government service teams; a paper click-through cannot validate performance, real data or implemented accessibility, and the untestable lists here make that explicit per prototype. Fallback: R05.
- R02: [Nielsen: ten usability heuristics](https://www.nngroup.com/articles/ten-usability-heuristics/) — All ten, used to generate candidate questions before testing. Purpose: Helps produce questions worth prototyping, kept separate from evidence. Free reading, no account. Verified 2026-09-06. A heuristic finding is an expert opinion; it suggests what to test rather than settling it. Fallback: R11.
...
Repair: For each prototype complete “this exists to find out whether …”. Anything you cannot complete is an artefact, not a prototype. Recheck: The question list.
...
Repair: For each prototype ask what paper could not tell you. If the answer is nothing, build it on paper. Recheck: The justifications.
...
Repair: Write the strongest sentence you would like to claim from each prototype, then decide whether it is licensed. Recheck: The untestable lists.
...
Recommended route: Draw the screen list and the click-through you build from it on paper, then record what you drew in the worksheet here so it is saved and reviewable. Photograph the sheet if you can and note the file name; the photo stays in your own folder. Alternative route: Prefer one file on your computer? Use the local text-file route below with the copyable starter table, and note the file location in Your work.
...
The screens your flow needs, including one where something goes wrong, and which actions must really work.

- List the screens your chosen flow needs, including one failure.
- Decide which actions must work and which may be dead.

**Start here:** Walk the flow in your head and write a line for each screen you would see. Then add the one where it goes wrong.

**Enough:** One screen on the list is a failure, and every other screen has a reason to exist.
...
Made-up example. Listing the screens for a collection flow, and choosing the failure that was easiest to draw.
...
**Wrong turn:** The wrong turn is choosing the failure you already know how to draw. It is quick, and the screen list ends up with a failure on it, so the plan looks complete while the going-wrong you were least worried about is the only one you can watch.

**Trade-off:** The failure that actually happens is one you have never designed, so you are inventing a screen and two ways out of it inside a step that was meant to be planning. Some of that invention will be thrown away after the first session.

**Unknown:** Still unknown: whether those two ways onward are the two people want. The prototype can show which of the two they take, and it cannot show the third one they were hoping for.


### The one flow you are building, in a few words

Section: practice-plan. Stable action: write-flow-name.

Write your answer for “The one flow you are building, in a few words”. Use the task instructions below to decide what to include.

**Answer:** The one flow you are building, in a few words
...
Example (made up): finding a class and getting to the point of paying for it.

</details>


### Every screen the flow needs, including at least one where something goes wrong

Section: practice-plan. Stable action: write-screen-list.

One line per screen. Take the failure from your Module 7 exception table.

**Answer:** Every screen the flow needs, including at least one where something goes wrong

One line per screen. Take the failure from your Module 7 exception table.


### Which actions must really work, and which may be dead

Section: practice-plan. Stable action: write-must-work.

Dead means nothing happens when it is tapped. That is allowed, and it goes on the fakes sheet later.

**Answer:** Which actions must really work, and which may be dead

Dead means nothing happens when it is tapped. That is allowed, and it goes on the fakes sheet later.


### Build the click-through
...
**Start here:** Make the screens first with nothing linked. Then join them one action at a time, following your own flow.

**Enough:** You can walk from the first screen to the ordinary ending and to the failure, without touching anything except the screens.
...
Made-up example. Building a click-through of a booking flow, polishing it, and then refusing to change it.
...
**Wrong turn:** The wrong turn is making it look finished. A finished-looking prototype collects comments about the surface, and it turns you into someone defending work instead of someone changing it.

**Trade-off:** A plain prototype means somebody will say it looks unfinished, and you will feel that. It buys you the ability to change it between one session and the next.

**Unknown:** Still unknown: whether people behave differently in front of something obviously rough. They may be gentler with it, and no test at this size can settle that.


### How you are building it

Section: practice-plan. Stable action: write-build-method.
...
Section: practice-plan. Stable action: write-links-made.

Write your answer for “Each action and the screen it should reach”. Use the task instructions below to decide what to include.

**Answer:** Each action and the screen it should reach
...
Example (made up): on the class page, “Book this class” reaches the review screen; “Back” reaches the results list; the date line does nothing.

</details>


### Make the data awkward

Section: practice-plan. Stable action: step-3-brief.

Content that includes one very long value, one missing value and one edge case, with what each did to the layout.
...
**Start here:** Take your three worst real examples. If you have none, invent the longest title you can imagine somebody typing.

**Enough:** Something moved, wrapped or fell off the screen, and you wrote down what.
...
### The very long value, the missing value and the edge case you put in, and what each one did to the layout

Section: practice-plan. Stable action: write-awkward-data.

A class title that runs to three lines, a class with no price shown, a class with one place left.

**Answer:** The very long value, the missing value and the edge case you put in, and what each one did to the layout

A class title that runs to three lines, a class with no price shown, a class with one place left.


### Write the fakes sheet

Section: practice-plan. Stable action: step-4-brief.

A fakes sheet listing every dead control, every invented value and every faked wait, and which ones a person is likely to try.
...
**Start here:** Go through screen by screen and tap every word, icon and box, not only the ones you built.

**Enough:** Somebody else could read the sheet and predict which taps will do nothing.
...
Now walk your own prototype and tap everything, including the things you already know are dead. Every non-response is a row.
...
Section: practice-plan. Stable action: write-dead-controls.

Write your answer for “Every control that does nothing when a person taps it”. Use the task instructions below to decide what to include.

**Answer:** Every control that does nothing when a person taps it
...
Section: practice-plan. Stable action: write-invented-values.

Write your answer for “Every invented value and every faked wait”. Use the task instructions below to decide what to include.

**Answer:** Every invented value and every faked wait
...
Section: practice-plan. Stable action: write-likely-attempts.

Write your answer for “Which of these a person is most likely to try”. Use the task instructions below to decide what to include.

**Answer:** Which of these a person is most likely to try
...
Answers to revisit: flow-name, screen-list, must-work, improvement-made
...
Check again: The content includes a very long value, a missing value and an edge case.

Answers to revisit: awkward-data, improvement-made
...
Check again: Each dead control has a note on whether a person is likely to try it.

Answers to revisit: dead-controls, invented-values, likely-attempts, improvement-made
...
**Start here:** Open it on a phone, or hold the paper sheets at phone size, and do the whole flow without helping yourself.

**Enough:** Nothing in the flow is unreachable or unreadable at that size, and the fakes sheet is stored with the prototype.
...
Section: practice. Stable action: write-phone-check.

Write your answer for “What was unreachable or unreadable at phone size, and what you changed”. Use the task instructions below to decide what to include.

**Answer:** What was unreachable or unreadable at phone size, and what you changed
...
Section: practice. Stable action: write-prototype-store.

Write your answer for “Where the prototype and the fakes sheet live together”. Use the task instructions below to decide what to include.

**Answer:** Where the prototype and the fakes sheet live together
...
Open Your work and choose Ready for review. The next lesson writes the tasks you will give people in front of this prototype.
...
- R36: [NN/g: preventing user errors](https://www.nngroup.com/articles/user-mistakes/) — The sections on failure, feedback and recovery. Purpose: Helps choose which failure path is worth including first. Free reading, no account. Verified 2026-09-06. Prevention techniques are options rather than a checklist. Fallback: R02.
...
Repair: Take the top failure from your exception table and add the screen plus the link that reaches it. Recheck: The failure path in the prototype.
...
Repair: Replace three items with your worst real examples and re-check the layout at phone width. Recheck: The prototype content.
...
Five rough tasks, one per question your prototype exists to answer.

- Read the assigned guidance on writing tasks for a session.
- Draft five tasks from the questions your prototype answers.

**Start here:** Take your first question and finish this sentence: “to find that out, somebody would have to try to …”.

**Enough:** There are five, and each one traces back to a question the prototype exists to answer.
...
### One rough task per question your prototype exists to answer

Section: practice-plan. Stable action: write-draft-tasks.

Write them badly and quickly. All the rewriting happens in the next step.

**Answer:** One rough task per question your prototype exists to answer

Write them badly and quickly. All the rewriting happens in the next step.


### Strip the vocabulary

Section: practice-plan. Stable action: step-2-brief.

Each task rewritten as a situation with a goal and a stopping point, naming no control.
...
**Start here:** Take your first rough task and cross out every word that also appears on your screens. Write what is left as a situation.

**Enough:** No task names a button, menu, icon or page, and none of them promises that a feature exists.
...
Made-up example. Writing one task, reading it back, and finding I had told the person where to go.
...
**Wrong turn:** The wrong turn is writing the task in the words that are on your own screens, because those are the words in your head. Every one of them hands the person a piece of the answer.

**Trade-off:** A task written as a situation is longer and vaguer, and people will ask you what you mean. Saying “whatever you would normally do” is uncomfortable, and it is the whole method.

**Unknown:** Still unknown: whether the situation you invented is one this person would ever really be in. If it is not, they are acting, and all you can do is watch for it.
...
Six task wordings from a made-up class-booking study. For each one, decide what it does to the person taking part.
...
Now read your own five aloud and mark each one the same way. Rewrite anything that is not in the third group.
...
### Task 1 · the situation, the goal, and where the person stops

Section: practice-plan. Stable action: write-task-1.

Underline every word that also appears on your screens, then write the task again without any of them.

**Answer:** Task 1 · the situation, the goal, and where the person stops
...
Example (made up): you want to do something on Saturday with your sister. Find something you would both be happy with, and stop at the point where you would hand over money.
...
Write your answer for “Task 2 · the situation, the goal, and where the person stops”. Use the task instructions below to decide what to include.

**Answer:** Task 2 · the situation, the goal, and where the person stops
...
Write your answer for “Task 3 · the situation, the goal, and where the person stops”. Use the task instructions below to decide what to include.

**Answer:** Task 3 · the situation, the goal, and where the person stops
...
Write your answer for “Task 4 · the situation, the goal, and where the person stops”. Use the task instructions below to decide what to include.

**Answer:** Task 4 · the situation, the goal, and where the person stops
...
Write your answer for “Task 5 · the situation, the goal, and where the person stops”. Use the task instructions below to decide what to include.

**Answer:** Task 5 · the situation, the goal, and where the person stops
...
A written destination for each task, the alternative routes you would accept, and what counts as giving up.
...
**Start here:** For each task ask what you would be happy to see, then what you would grudgingly accept, then what would make you stop the task.

**Enough:** Every task has a destination and at least one route you did not design.
...
Made-up example. Writing what counts as success for one task, and describing my own route instead of the person’s goal.
...
**Wrong turn:** The wrong turn is writing success as the route you designed, because that is the part you are worried about and it is easy to tick. It quietly turns every other way of getting there into a failure.

**Trade-off:** Accepting three routes means far fewer clean failures, so a route that is genuinely poor can still pass. You then have to write the workaround down beside the result, and the result reads as weaker than a tidy tick would have.

**Unknown:** Still unknown: whether “the matter is settled” is something you can see or only something you are told. In a rehearsal on yourself you do not even get that much.


### For each task: the destination that counts as success

Section: practice-plan. Stable action: write-success-definitions.

Write it before anybody sits down. Afterwards it is a description of what happened.

**Answer:** For each task: the destination that counts as success
...
Section: practice-plan. Stable action: write-alternative-routes.

Write your answer for “For each task: the other routes you would accept, including workarounds you would note”. Use the task instructions below to decide what to include.

**Answer:** For each task: the other routes you would accept, including workarounds you would note
...
Example (made up): finding the telephone number instead of the change route. Accepted, and written down as a workaround rather than a success.
...
Section: practice-plan. Stable action: write-abandonment.

Write your answer for “What counts as the person giving up”. Use the task instructions below to decide what to include.

**Answer:** What counts as the person giving up
...
The five in a deliberate order, with a note wherever an earlier task teaches a later one, and what you cut.
...
**Start here:** Read the tasks in order and mark the point at which each control first becomes visible.

**Enough:** Anything that depends on discovering something comes before the task that reveals it, and the cuts are written down.
...
### Your five in the order you will give them, with the reason for the first one

Section: practice-plan. Stable action: write-task-order.

Whatever depends on discovering something goes first, before another task reveals it.

**Answer:** Your five in the order you will give them, with the reason for the first one
...
Section: practice-plan. Stable action: write-contamination.

Write your answer for “Where an earlier task teaches the answer to a later one”. Use the task instructions below to decide what to include.

**Answer:** Where an earlier task teaches the answer to a later one
...
Section: practice-plan. Stable action: write-cut-tasks.

Write your answer for “What you cut to get down to five”. Use the task instructions below to decide what to include.

**Answer:** What you cut to get down to five
...
Check again: No task tells the person that a feature is there to be found.

Answers to revisit: task-1, task-2, task-3, task-4, task-5, improvement-made
...
Check again: Every task has a written destination and at least one accepted alternative.

Answers to revisit: success-definitions, alternative-routes, abandonment, improvement-made
...
Check again: Five tasks remain, in a stated order, with the cuts written down.

Answers to revisit: task-order, contamination, cut-tasks, improvement-made
...
The tasks read aloud, timed by you, and the repair the Check questions asked for.
...
**Start here:** Read each task out to the empty room. Anything you would not say to a person out loud is written wrong.

**Enough:** They sound like something one person would say to another, and you know how long all five take.
...
Write your answer for “What sounded wrong when you read them aloud, and how long all five took you”. Use the task instructions below to decide what to include.

**Answer:** What sounded wrong when you read them aloud, and how long all five took you
...
Open Your work and choose Ready for review. The next lesson recruits the people who will be given these tasks.
...
Repair: Underline every word that also appears on screen and rewrite that task around the person's circumstances. Recheck: The rewritten tasks.
...
Repair: Take one exception from your m07 table and write the situation that would lead a person into it. Recheck: The failure task.
...
Bring: Your m05 screener and consent introduction.
...
The one experience each person must have, who you recruited, and a dated record of who you could not reach.
...
**Start here:** Write the one experience first, in a single line, before you think about anybody you know.
...
Made-up example. Recruiting three people, getting two, and writing the third one down as a gap.
...
**Wrong turn:** The wrong turn is taking whoever is free and then saying nothing about it. The sample is not the problem; the silence about it is, because every finding then reads as though it came from anybody at all.

**Trade-off:** Screening loses you people, and two participants feels thin. Two who have actually done the thing tell you more than five who are imagining it.

**Unknown:** Still unknown: what people outside that one group would have done. Nothing in a study this size can reach them, and the recruitment sentence is what keeps that visible.


### The one experience each person must have for their hour to be worth anything

Section: practice-plan. Stable action: write-experience-required.

Write your answer for “The one experience each person must have for their hour to be worth anything”. Use the task instructions below to decide what to include.

**Answer:** The one experience each person must have for their hour to be worth anything
...
Example (made up): has booked something with a fixed time and place in the last two months.

</details>


### Each person you recruited, and the experience that qualifies them
...
A consent introduction covering recording, their own device, what is not installed, and deletion.
...
**Start here:** Take your Module 5 consent introduction and add two sentences: one about the recording, one about their device.

**Enough:** Somebody reading it aloud would know what is captured, what you will see, and that they can stop at any point.
...
Made-up example. Writing a consent introduction as one friendly sentence, then reading it aloud and finding three things I had not said.
...
**Wrong turn:** The wrong turn is bundling it all into one agreeable sentence. A long introduction feels as though it will make the person nervous, and you want to reach the tasks, so you ask for agreement to a vague whole instead of to each named thing.

**Trade-off:** Naming each thing costs you two minutes of a session you may only have an hour of, and some people will say no to the recording once they hear what it is. You are then working from notes on a session you would rather have been able to hear again.

**Unknown:** Still unknown: whether saying all of it slowly makes people more careful in front of you than a quick sentence would have. A rehearsal on yourself cannot show you that.
...
Section: practice-plan. Stable action: write-consent-device.

Write your answer for “The sentences covering their own device: that nothing is installed, and what you will and will not see”. Use the task instructions below to decide what to include.

**Answer:** The sentences covering their own device: that nothing is installed, and what you will and will not see
...
Section: practice-plan. Stable action: write-consent-deletion.

Write your answer for “How and when anything you capture is deleted”. Use the task instructions below to decide what to include.

**Answer:** How and when anything you capture is deleted




### Choose how you will capture

Section: practice-plan. Stable action: step-3-brief.

One capture method chosen, and what you missed when you tried it on yourself.
...
**Start here:** Choose by asking what you would rather lose: the second half of a sentence, or the look on somebody’s face.

**Enough:** You have tried the method once and written down what it costs you.
...
Section: practice-plan. Stable action: write-capture-choice.

Choose the option that honestly describes your work.

**Answer:** What you will do during the session (Record the audio and write sparse markers / Write full notes and record nothing / Write from memory straight afterwards, if recording is refused)
...
Section: practice-plan. Stable action: write-capture-test.

Write your answer for “What you missed when you tried your chosen method on yourself”. Use the task instructions below to decide what to include.

**Answer:** What you missed when you tried your chosen method on yourself
...
Everything loaded, printed and to hand, plus a short version covering the two most important tasks.
...
**Start here:** Lay out physically what you will need, then write the list from what is in front of you.

**Enough:** The short version names the two tasks and could be run in about twenty minutes.
...
### What is loaded, printed and to hand before the person arrives

Section: practice-plan. Stable action: write-session-pack.

The prototype on the device you will use, the tasks, the success definitions, the fakes sheet, a charged phone.

**Answer:** What is loaded, printed and to hand before the person arrives
...
Section: practice-plan. Stable action: write-short-version.

Write your answer for “The short version: the two tasks you would keep if you had twenty minutes”. Use the task instructions below to decide what to include.

**Answer:** The short version: the two tasks you would keep if you had twenty minutes
...
Check again: Either three people with their qualifying experience, or a dated record of the attempt.

Answers to revisit: experience-required, participants, could-not-reach, improvement-made
...
Check again: The consent introduction names recording, the device, non-installation and deletion.

Answers to revisit: consent-recording, consent-device, consent-deletion, improvement-made
...
Check again: A written short plan exists covering two named tasks.

Answers to revisit: session-pack, short-version, improvement-made

</details>


### Rehearse and record gaps

Section: practice. Stable action: step-5-brief.

The session run on yourself and timed, what you had to improvise, and the repair the Check questions asked for.
...
**Start here:** Sit down and run the whole thing on yourself, out loud, from the consent introduction to the last task.

**Enough:** Nothing in the session is still being decided in the moment, and the rehearsal is recorded as a rehearsal rather than as a session.
...
Section: practice. Stable action: write-rehearsal-timing.

Write your answer for “How long the whole session took when you ran it on yourself”. Use the task instructions below to decide what to include.

**Answer:** How long the whole session took when you ran it on yourself
...
Section: practice. Stable action: write-improvised.

Write your answer for “Anything you had to make up as you went, and what you have now decided instead”. Use the task instructions below to decide what to include.

**Answer:** Anything you had to make up as you went, and what you have now decided instead
...
Open Your work and choose Ready for review. The next lesson runs the sessions themselves, and asks you to log every time you helped.
...
Repair: Write the one experience each participant must have, then record which of yours has it. Recheck: The participant record.
...
Repair: Add two sentences: one about the recording, one about their device and what you will and will not see. Recheck: The extended consent introduction.
...
Repair: Run one task on yourself using your chosen method and see what you miss. Recheck: The capture setup and rehearsal note.
...
Three sentences you can say without thinking, and the moment you know you will want to step in.

- Read the assigned moderation guidance.
- Write your three standard responses to questions, and practise them aloud.

**Start here:** Write the sentence you would say if a participant asked you what a button does, then take the answer out of it.

**Enough:** None of your three responses tells the participant anything about the design.
...
Made-up example. A session where I answered a participant’s question and deleted the strongest finding of the study.
...
Six moments from three sessions, all made up for practice. For each one, decide whether the moderator should wait, ask a neutral question, or has already rescued the participant.
...
Read your three standard responses again. Rewrite any of them that supplies information rather than asking for it.
...
### The three things you will say when a participant asks you a question

Section: practice-plan. Stable action: write-standard-responses.

Write them as sentences you can say without thinking. You will need the first one within two minutes.

**Answer:** The three things you will say when a participant asks you a question
...
Example (made up): “What would you expect that to do?” “What are you looking for at the moment?” “Take your time, there is no wrong way to do this.”

</details>


### The moment you already know you will want to rescue

Section: practice-plan. Stable action: write-rescue-tell.

Most people have one. Naming it now makes it easier to sit through.

**Answer:** The moment you already know you will want to rescue
...
Sessions run, or an honest smaller route recorded with a date, plus expectations captured before each screen change.
...
**Start here:** Read the consent introduction aloud and get agreement before anything else. Then give the first task and stop speaking.

**Enough:** Every significant screen change has a predicted outcome and an actual one written beside it.
...
Section: practice-plan. Stable action: write-session-route.

Choose the option that honestly describes your work.

**Answer:** Which route you are taking (Three sessions with participants / One or two sessions, plus a rehearsal on yourself / A rehearsal only, because nobody was available)




### Dated note: who you asked, who could not take part, and what you had ready for them
...
Example (made up): before the review screen she said “it will ask me to pay”. It asked her to pay and also showed a countdown she did not mention.
...
Every time you spoke beyond the task, with the time and your words, and the point each session became assisted.
...
Section: practice-plan. Stable action: write-intervention-log.

Write your answer for “Every time you spoke beyond the task or one of your three responses, with the time and your exact words”. Use the task instructions below to decide what to include.
...
Section: practice-plan. Stable action: write-assisted-marks.
...
One record per session, written within the hour, with said, observed and inferred kept apart.
...
**Start here:** Write the words you actually heard first. Everything else is either what you watched or what you concluded.
...
Made-up example. A session record written three days late, in which my conclusions had quietly become my observations.
...
**Wrong turn:** The wrong turn is writing “she was confused”. It feels like an observation because you were sure of it at the time, and it is a conclusion with the evidence deleted, so nobody can check it and nobody can disagree with it.

**Trade-off:** Three parts make a longer, duller record, and the inferred part often comes out thin and unsatisfying. You give up the confident summary a reader would rather have, and that summary was the part with nothing underneath it.
...
Example (made up): said — “I suppose I press this?”. Observed — she waited about eight seconds with her thumb over the button. Inferred — she was unsure whether the class was already hers. Reconstructed — the eight seconds, from memory, not the recording.
...
Check again: The route is stated and the note carries a date and the names or groups you could not reach.

Answers to revisit: session-route, access-note, expectation-log, improvement-made
...
Check again: Every session with an intervention has an assisted marker showing where it began.

Answers to revisit: intervention-log, assisted-marks, improvement-made
...
Check again: Each screen change carries a prediction made before it happened.

Answers to revisit: session-route, access-note, expectation-log, standard-responses, rescue-tell, improvement-made

</details>


### Review your own moderation

Section: practice. Stable action: step-5-brief.

The interventions you now think were unnecessary, one change for next time, and the repair the Check questions asked for.
...
**Start here:** Read the log as though somebody else had moderated. Mark every entry where waiting would have worked.

**Enough:** Your one change is a specific sentence or pause, not a resolution to be better.
...
Section: practice. Stable action: write-unnecessary-ones.

Write your answer for “The interventions you now think were unnecessary”. Use the task instructions below to decide what to include.

**Answer:** The interventions you now think were unnecessary
...
Write your answer for “One thing you will do differently in the next session”. Use the task instructions below to decide what to include.

**Answer:** One thing you will do differently in the next session
...
Open Your work and choose Ready for review. The next lesson turns these records into a ranked list of problems.
...
- R05: [GOV.UK: moderated usability testing](https://www.gov.uk/service-manual/user-research/using-moderated-usability-testing) — Running the session and moderating. Purpose: Supplies the moderation discipline this lesson practises. Free reading, no account. Verified 2026-09-06. Assumes a note-taker; alone, your capture choice from the previous lesson determines what you can record. Fallback: R12.
- R56: [GOV.UK: taking notes and recording sessions](https://www.gov.uk/service-manual/user-research/taking-notes-and-recording-user-research-sessions) — Note-taking and recording, and the consent each requires. Purpose: Keeps the record usable for analysis rather than a stream of impressions. Free reading, no account. Verified 2026-09-06; last updated 19 September 2017. It does not cover analysis or moderation technique. Fallback: R53.
...
Repair: In the next session, ask “what do you think will happen?” before every screen change and write the answer down. Recheck: The expectation records.
...
Repair: Listen back to the recording, or reconstruct honestly, and list every time you spoke beyond the task. Recheck: The intervention log.
...
Repair: Rewrite the records into three columns now and mark anything you cannot place in the first column. Recheck: The layered records.
...
Bring: Your session records and pre-written success definitions.
...
Every observation on its own line with a person’s label, and an honest statement of what the records are.

- Write each observation on its own line with a participant label.
- Read the assigned analysis guidance before grouping.

**Start here:** Go through each record and copy out anything that happened, one line at a time, without deciding yet what it means.

**Enough:** Every line carries a person’s label and describes one thing.
...
### What your analysis rests on

Section: practice-plan. Stable action: write-record-route.
...
### Dated note: who you could not reach, and what you had prepared for them
...
Groups named by the cause you believe is underneath them, with the speculative ones marked as guesses.
...
**Start here:** For each group finish the sentence “these happened because …”. If you cannot finish it, mark the group a guess or split it.
...
Made-up example. Sorting nine observations by the screen they happened on, and finishing with three tidy groups and no causes.
...
**Wrong turn:** The wrong turn is grouping by screen. Every line already names a screen, so the boxes fill themselves in minutes and look orderly. None of them is a problem, because a place is not a reason.

**Trade-off:** Groups named by cause cut across screens, so no group points at one thing to change. Whoever makes the change will ask you which screen you mean, and you will have to answer with a list rather than a name.

**Unknown:** Still unknown: whether the two main groups share one cause underneath, something about words that describe a state rather than an action. Nine lines from three people cannot separate that.


### Your groups, each named by the likely cause rather than the screen it happened on

Section: practice-plan. Stable action: write-cause-groups.

Write your answer for “Your groups, each named by the likely cause rather than the screen it happened on”. Use the task instructions below to decide what to include.

**Answer:** Your groups, each named by the likely cause rather than the screen it happened on
...
Example (made up): people cannot tell whether a place is held before payment. Three lines from two people sit under it, from two different screens.
...
Section: practice-plan. Stable action: write-guess-marks.

Write your answer for “The groups where the shared cause is your guess”. Use the task instructions below to decide what to include.

**Answer:** The groups where the shared cause is your guess
...
One row per problem: how many of how many people met it, what it cost them, the evidence, and any assisted completions.
...
**Start here:** Take one group and write the count as “two of three”, then write the sentence describing what it cost that person.

**Enough:** Every problem has a count of people, a cost, and a line of evidence you could point at.
...
Made-up example. Turning eleven observations into six problems, and getting the first ranking wrong.
...
**Wrong turn:** The wrong turn is counting incidents. Eleven lines from three people is still three people, and “six hesitations” reads as six people to anyone who was not in the room.

**Trade-off:** Ranking by cost puts a quiet problem above a loud one, and the loud one is the one you remember. You will have to argue for the order, which is why the reason sits beside it.

**Unknown:** Still unknown: whether the top two problems share one cause. They might both come from the same missing message, and three sessions cannot tell me.
...
Write your answer for “Problem 1 · how many of how many people met it, what it cost them, the evidence, and whether any completion was assisted”. Use the task instructions below to decide what to include.

**Answer:** Problem 1 · how many of how many people met it, what it cost them, the evidence, and whether any completion was assisted
...
Write your answer for “Problem 2 · how many of how many people met it, what it cost them, the evidence, and whether any completion was assisted”. Use the task instructions below to decide what to include.

**Answer:** Problem 2 · how many of how many people met it, what it cost them, the evidence, and whether any completion was assisted
...
Write your answer for “Problem 3 · how many of how many people met it, what it cost them, the evidence, and whether any completion was assisted”. Use the task instructions below to decide what to include.

**Answer:** Problem 3 · how many of how many people met it, what it cost them, the evidence, and whether any completion was assisted
...
Section: practice-plan. Stable action: write-problem-4.

Write your answer for “Problem 4 · how many of how many people met it, what it cost them, the evidence, and whether any completion was assisted”. Use the task instructions below to decide what to include.
...
Section: practice-plan. Stable action: write-problem-5.
...
**Start here:** Sort by what each problem cost the person: money first, then lost work, then abandonment, then time and doubt.

**Enough:** Your reason for the top place names a cost, not a frequency and not a fix.
...
Read your own order again. Move anything ranked because it looked bad or because it would be quick to fix.
...
Section: practice-plan. Stable action: write-ranking-order.

Write your answer for “Your problems in order, worst cost to the person first”. Use the task instructions below to decide what to include.

**Answer:** Your problems in order, worst cost to the person first




### Why the top problem outranks the second

Section: practice-plan. Stable action: write-top-reason.

Say what each one cost the person. If your reason mentions how easy it is to fix, it is the wrong reason.

**Answer:** Why the top problem outranks the second
...
Check again: The grouping states your reading and the grounds for it.

Answers to revisit: cause-groups, guess-marks, improvement-made
...
Check again: Every problem row shows unassisted and assisted completions separately.

Answers to revisit: problem-1, problem-2, problem-3, problem-4, problem-5, improvement-made
...
One participant kept returning to the shortlist and you have no idea why. What do you do with it?

- Move it to open questions and write what would settle it.
- Put it under the nearest group so nothing is lost.
- Drop it, since one person doing something once means nothing.

<details>
<summary>After your attempt</summary>

Move it to open questions and write what would settle it. — An unexplained observation kept honestly is the next study’s first question. An explained one you invented is a finding nobody can trace.

Put it under the nearest group so nothing is lost. — The nearest group then carries an observation that does not belong to its cause, which weakens the count and the cause together.

Drop it, since one person doing something once means nothing. — It means you do not yet know what it means. Dropping it loses the one thing that might have shown you were looking at the wrong problem.

Improve: Move any observation you cannot explain out of your groups in step 2 and into open questions in step 5, with what would settle it, then record the change.

Check again: No group contains an observation whose cause you cannot name.
...
### Keep the unexplained

Section: practice. Stable action: step-5-brief.

The observations you cannot explain, moved to open questions with what would settle each, and the repair the Check questions asked for.
...
**Start here:** Look for the lines you skipped over while grouping. Those are usually the ones you could not explain.

**Enough:** Nothing has been forced into a group to avoid leaving it unexplained.
...
Section: practice. Stable action: write-open-questions.

Write your answer for “Observations you cannot explain, moved here rather than guessed at”. Use the task instructions below to decide what to include.

**Answer:** Observations you cannot explain, moved here rather than guessed at
...
Section: practice. Stable action: write-what-would-settle.

Write your answer for “For each: what would settle it”. Use the task instructions below to decide what to include.

**Answer:** For each: what would settle it
...
Open Your work and choose Ready for review. The next lesson decides what this list is allowed to claim.
...
- R04: [GOV.UK: analyse a research session](https://www.gov.uk/service-manual/user-research/analyse-a-research-session) — Capturing observations, grouping them and moving to findings. Purpose: Supplies the observation-to-finding procedure this lesson uses. Free reading, no account. Verified 2026-09-06. Written for a team analysing together; alone you lose the disagreement a second reader supplies, so seek one where you can. Fallback: R08.
- R02: [Nielsen: ten usability heuristics](https://www.nngroup.com/articles/ten-usability-heuristics/) — All ten, used to name causes precisely once problems are grouped. Purpose: Gives shared vocabulary for describing a cause without inventing one. Free reading, no account. Verified 2026-09-06. Naming a heuristic is not evidence of a cause; the sessions are. Fallback: R11.
...
Repair: For each group write the sentence “these happened because …”. If you cannot, mark it a guess or split it. Recheck: The grouped list.
...
Repair: Recount each problem by participant and rewrite as “two of three”. Recheck: The recounted list.
...
Repair: For each problem write what it cost the person, then sort by that. Recheck: The ranked list.
...
Bring: Your ranked problem list.
...
What each reading says it does not cover, and an honest statement of what your own claims rest on.

- Read the assigned sample-size and interval readings.
- Write what each explicitly excludes.

**Start here:** Look for the paragraph in each reading that says which kind of study it is about. Copy the sentence out.
...
### For each reading: what it says it does not cover

Section: practice-plan. Stable action: write-excluded-by-reading.

Both readings are about measuring studies. Write the sentence in each that says so.

**Answer:** For each reading: what it says it does not cover
...
Section: practice-plan. Stable action: write-study-basis.
...
Each finding written as a sentence with a count of people, and no percentage or generalising word anywhere in it.

- Write each finding as a sentence with its participant count.
- Remove any sentence containing a percentage or the word most.

**Start here:** Take each problem from your ranked list and write it as “two of three people …” with what they did.

**Enough:** No claim contains a per cent sign, the word most, or the phrase people tend to.
...
Made-up example. Writing “60 per cent of users were unsure”, then working out what that number was allowed to mean.
...
**Wrong turn:** The wrong turn is the percentage itself. It is not a rounding choice or a matter of style: it converts five people into a population you never met.

**Trade-off:** A count sounds smaller, and somebody will ask “is that all?”. It is all, and unlike the percentage it survives being checked against your records.

**Unknown:** Still unknown: how common this is among people unlike these five. Nothing in the study reaches them, and no arithmetic can fetch them back.
...
Write your answer for “Claim 1 · the finding, written with how many of how many people met it”. Use the task instructions below to decide what to include.

**Answer:** Claim 1 · the finding, written with how many of how many people met it
...
Example (made up): two of the three people I sat with could not tell whether their place was held before they paid.
...
Write your answer for “Claim 2 · the finding, written with how many of how many people met it”. Use the task instructions below to decide what to include.

**Answer:** Claim 2 · the finding, written with how many of how many people met it
...
Write your answer for “Claim 3 · the finding, written with how many of how many people met it”. Use the task instructions below to decide what to include.
...
Section: practice-plan. Stable action: write-claim-4.
...
### Write the cannot-claims

Section: practice-plan. Stable action: step-3-brief.

The sentences you wish you could write, copied out in full, each with the reason this study does not license it.
...
**Start here:** Write the strongest sentences you would like to be able to write. Then work out, one at a time, which are licensed.

**Enough:** The list names how common it is, speed, assistive technology and unlike people, and copies out at least one sentence you genuinely wanted.
...
### The sentences you would like to write, copied out in full

Section: practice-plan. Stable action: write-tempting-sentences.

Write them as you would actually write them, not as summaries. The temptation lives in the wording.

**Answer:** The sentences you would like to write, copied out in full

Write them as you would actually write them, not as summaries. The temptation lives in the wording.


### Beside each: why this study does not license it

Section: practice-plan. Stable action: write-cannot-claims.

Cover how common it is, speed, assistive technology, and people unlike your participants.

**Answer:** Beside each: why this study does not license it
...
One rate worked through to a range, with your inputs, the published method you used, and a sentence on the width.
...
**Start here:** Take the rate you most wanted to report. Follow the same arithmetic as the demonstration, with your own numbers.

**Enough:** Somebody else could repeat your sum from what you wrote down.
...
Section: practice-plan. Stable action: write-interval-result.

Write your answer for “The range you got, written out”. Use the task instructions below to decide what to include.

**Answer:** The range you got, written out
...
Section: practice-plan. Stable action: write-width-sentence.

Write your answer for “One sentence on what that width tells you”. Use the task instructions below to decide what to include.

**Answer:** One sentence on what that width tells you
...
Check again: No claim rests on a figure that came from somebody else’s study.

Answers to revisit: claim-1, claim-2, claim-3, claim-4, improvement-made
...
Check again: The claims carry counts, and the arithmetic appears once, on its own.

Answers to revisit: interval-inputs, interval-result, width-sentence, claim-1, claim-2, claim-3, claim-4, improvement-made
...
Check again: The ranked list is introduced by a sentence saying who ranked it and how.

Answers to revisit: severity-statement, what-would-measure-it, improvement-made

</details>


### Label your judgements

Section: practice. Stable action: step-5-brief.

A sentence naming the ranking as your judgement, what would make it measured, and the repair the Check questions asked for.
...
**Start here:** Write who did the ranking and on what basis, in one sentence, and put it above the ranked list.

**Enough:** Nothing in the report implies the ordering was measured.
...
Made-up example. Putting “Severity: high” beside three problems, then being unable to say where the word had come from.
...
**Wrong turn:** The wrong turn is borrowing the vocabulary of a scale. High, Medium and Low read as figures taken off an instrument, and they are the same opinion in a uniform.

**Trade-off:** Naming the order as your own judgement invites a reader to argue with the whole list, and somebody will. You keep every observation underneath it, and you give up the authority those three words were lending you.

**Unknown:** Still unknown: whether anybody else would put the problems in this order. Nobody else watched the sessions, so there is nothing to hold my order against.


### The sentence saying who ranked the problems and on what basis

Section: practice. Stable action: write-severity-statement.

Write your answer for “The sentence saying who ranked the problems and on what basis”. Use the task instructions below to decide what to include.

**Answer:** The sentence saying who ranked the problems and on what basis
...
Section: practice. Stable action: write-what-would-measure-it.

Write your answer for “What would have to happen for the ranking to be measured rather than judged”. Use the task instructions below to decide what to include.

**Answer:** What would have to happen for the ranking to be measured rather than judged
...
Open Your work and choose Ready for review. The next lesson repairs the top problem and tests whether the repair did anything.
...
- R45: [NN/g: sample sizes for quantitative studies](https://www.nngroup.com/articles/summary-quant-sample-sizes/) — The recommended participant counts and the assumptions behind them. Purpose: Shows what a measuring study would require, so a qualitative test is not dressed as one. Free reading, no account. Verified 2026-09-06. Binary success metrics only: it states it does not cover A/B tests, surveys, card sorting or tree testing, and it does not license qualitative prevalence claims. Fallback: R37.
- R37: [NN/g: confidence intervals and margins of error](https://www.nngroup.com/articles/confidence-interval/) — What an interval means and how sample size and variability widen it. Purpose: Gives the instrument for the one worked interval and the argument against reporting rates at this size. Free reading, no account. Verified 2026-09-06. It gives no formulas, so use a published one and show your inputs. Fallback: R45.
...
Repair: Search your text for the per cent sign, “most”, “users tend to” and rewrite each as a count. Recheck: The claims list.
...
Repair: Write the strongest sentences you wish you could write, then mark which are licensed. Recheck: The cannot-claim list.
...
Repair: Take your most tempting rate, compute the interval in a spreadsheet and write down the numbers you used. Recheck: The interval work.
...
Stable ID: m10-l08-v1. Core.

A test that changes nothing was theatre. A repair that is not re-tested is a hope.

Bring: Your ranked problems and a prototype you can change.
...
The top problem, the single change, what should be observable if it works, and what would count as failing.
...
**Wrong turn:** The wrong turn is writing the prediction afterwards. It always fits, because you write it around what you saw, so it can never fail and never teaches you anything.

**Trade-off:** A prediction written first can fail where somebody can see it, and you will want to soften the wording. That risk is the only thing that makes the re-test worth running.

**Unknown:** Still unknown: whether two new people can separate a real improvement from two different personalities. They cannot, and the report says so.


### The top-ranked problem you are repairing

Section: practice-plan. Stable action: write-top-problem.

Write your answer for “The top-ranked problem you are repairing”. Use the task instructions below to decide what to include.

**Answer:** The top-ranked problem you are repairing




### The one change you are making, in a sentence
...
Write your answer for “What should be observable if the repair works”. Use the task instructions below to decide what to include.

**Answer:** What should be observable if the repair works
...
Example (made up): neither new person asks whether the place is secured, and neither pauses for more than a couple of seconds before paying.

</details>


### What would count as the repair failing
...
The old version kept intact, the new version differing in one respect, and a list of what you did not change.
...
Section: practice-plan. Stable action: write-version-note.

Write your answer for “Where the old version is, where the new one is, and the single difference between them”. Use the task instructions below to decide what to include.

**Answer:** Where the old version is, where the new one is, and the single difference between them
...
Section: practice-plan. Stable action: write-tempted-list.

Write your answer for “Everything else you were tempted to change and did not”. Use the task instructions below to decide what to include.

**Answer:** Everything else you were tempted to change and did not
...
**Start here:** Use the same task wording and the same moderation discipline as before, or the two rounds are not comparable.
...
Your prediction set beside what happened, anything you had not predicted, and the outcome named.
...
**Start here:** Read the prediction before you read the records, so you meet it in the order you wrote it.

**Enough:** Anything that changed which you had not predicted is written down as well.
...
Section: practice-plan. Stable action: write-comparison.

Write your answer for “Your prediction beside what actually happened, including anything you had not predicted”. Use the task instructions below to decide what to include.

**Answer:** Your prediction beside what actually happened, including anything you had not predicted
...
Section: practice-plan. Stable action: write-outcome-label.

Choose the option that honestly describes your work.

**Answer:** What the re-test showed (Confirmed / Partial / Failed / Cannot say, because the prediction was written afterwards)
...
Check again: The two versions differ in exactly one respect.

Answers to revisit: top-problem, single-change, prediction, failure-condition, version-note, tempted-list, improvement-made
...
Check again: The route is stated and no rehearsal appears anywhere as a result.

Answers to revisit: retest-route, access-note, retest-records, improvement-made
...
Check again: The outcome sentence names the failure and the counts behind it.

Answers to revisit: outcome-sentence, new-problems, reranked-list, improvement-made
...
The outcome in one sentence with counts, any new problem, the re-ranked list, and the repair the Check questions asked for.
...
**Start here:** Write the sentence you would least like to write first. If the repair failed, that sentence is the result.

**Enough:** The outcome sentence would still be true if somebody read your records afterwards.
...
Made-up example. Re-ranking after a partial result, and quietly crossing off the problem I had just repaired.
...
**Wrong turn:** The wrong turn is crossing off the problem you have just repaired. It is the reward for the work and it makes the list shorter, which feels like progress. A partial result has not earned it.

**Trade-off:** Keeping a partly addressed problem on the list means the list never gets shorter, and it will look to anyone reading as though you finish nothing. The alternative is a list that hides its own failures, which is worth less to everybody, you included.

**Unknown:** Still unknown: whether the second person’s difficulty is the old problem in a new form or a separate one about names. Two people cannot separate those, so the list carries both readings.


### The outcome in one sentence, with the counts in it

Section: practice. Stable action: write-outcome-sentence.

Write your answer for “The outcome in one sentence, with the counts in it”. Use the task instructions below to decide what to include.

**Answer:** The outcome in one sentence, with the counts in it
...
Section: practice. Stable action: write-new-problems.

Write your answer for “Any new problem the change introduced”. Use the task instructions below to decide what to include.

**Answer:** Any new problem the change introduced
...
Section: practice. Stable action: write-reranked-list.

Write your answer for “The remaining problems, re-ranked after this result”. Use the task instructions below to decide what to include.

**Answer:** The remaining problems, re-ranked after this result
...
Repair: Compare your change against the ranking. If it is not the top item, either repair that or record why it is deferred. Recheck: The change against the ranking.
...
Repair: Revert to the tested version and apply only the one change, listing what you were tempted to do as well. Recheck: The two versions.
...
Repair: Write the prediction now for any repair not yet re-tested, and mark retrospective ones honestly. Recheck: The prediction.
...
Example (made up): does the pending message stop people paying twice? If it does not, the payment work has to be fixed before anything else on the list.

</details>


### Which comfort of the prototype you are removing

Section: practice-plan. Stable action: write-which-lie.
...
**Enough:** The wait has a number of seconds beside it, and the screen holds as much content as the real thing would.
...
Made-up example. Trying to test a payment wait with no build at all, and nearly reporting a rehearsal as research.
...
**Wrong turn:** The wrong turn is reporting the counted wait as a test of loading. Nobody waited for a real page; a person turned a card over.

**Trade-off:** The rehearsal costs you any right to speak about real timings. What you get is a problem you did not know existed, for the price of four seconds and a phone.

**Unknown:** Still unknown: whether four seconds is anything like what people would really get. That needs a page that loads and a slowed connection, which comes later in the course.


### How you will produce the wait

Section: practice-plan. Stable action: write-wait-method.
...
### The real content you loaded: the longest names, the largest numbers, and how many items are in the list

Section: practice-plan. Stable action: write-content-swap.

Take the worst real examples you can find. Inventing neat ones defeats the whole purpose.

**Answer:** The real content you loaded: the longest names, the largest numbers, and how many items are in the list
...
Example (made up): sixty classes, the longest title 74 characters, one price of 12,500 and one class showing no price at all.

</details>


### Observe first paint and behaviour

Section: practice-plan. Stable action: step-3-brief.

What appeared first, what people did during the wait, and what the real content broke.
...
**Start here:** Run it yourself once with a timer, then once each with one or two people, saying nothing while they wait.

**Enough:** You can describe the wait as a sequence with seconds in it, not as a feeling.
...
Made-up example. Watching somebody sit through a wait, filling the silence, and writing down my reading of her face instead of what appeared.
...
**Wrong turn:** The wrong turn is filling the silence. A wait is uncomfortable to watch, explaining it is the kind thing to do, and it deletes the only behaviour you came for.

**Trade-off:** Saying nothing for six seconds while somebody struggles feels rude, and one or two people will leave thinking you were cold. That silence is the measurement.

**Unknown:** Still unknown: whether she pressed again because six seconds is too long, or because nothing on the screen said anything was coming. Those are two different repairs, and this run cannot separate them.


### What appeared first, what appeared last, and how long the gap between them lasted

Section: practice-plan. Stable action: write-first-thing.

Write your answer for “What appeared first, what appeared last, and how long the gap between them lasted”. Use the task instructions below to decide what to include.

**Answer:** What appeared first, what appeared last, and how long the gap between them lasted
...
Section: practice-plan. Stable action: write-volume-damage.

Write your answer for “What the real content broke: wrapping, scrolling, things pushed out of sight, sorting that suddenly became necessary”. Use the task instructions below to decide what to include.

**Answer:** What the real content broke: wrapping, scrolling, things pushed out of sight, sorting that suddenly became necessary




### Compare with the prototype result

Section: practice-plan. Stable action: step-4-brief.

The difference between what the prototype said and what happened under real weight.
...
**Start here:** Put the two results side by side before you write anything about either.

**Enough:** Each result has its conditions beside it, and neither has been deleted to make a tidier story.
...
Section: practice-plan. Stable action: write-prototype-said.

Write your answer for “What the paper or click-through result said about this same task”. Use the task instructions below to decide what to include.

**Answer:** What the paper or click-through result said about this same task
...
Section: practice-plan. Stable action: write-changed.

Write your answer for “What changed under real conditions, and what stayed the same”. Use the task instructions below to decide what to include.

**Answer:** What changed under real conditions, and what stayed the same
...
Section: practice-plan. Stable action: write-new-problems.

Write your answer for “New problems to add to your ranked list, each with how many of how many people met it”. Use the task instructions below to decide what to include.

**Answer:** New problems to add to your ranked list, each with how many of how many people met it
...
Check again: Both results are present, each with the conditions beside it.

Answers to revisit: prototype-said, changed, new-problems, improvement-made
...
Check again: The content field names a long value, a large number and a realistic item count.

Answers to revisit: wait-method, wait-length, content-swap, improvement-made
...
Check again: The observation notes carry timings, and the conditions record names device, method, wait length and item count.

Answers to revisit: first-thing, during-wait, volume-damage, improvement-made
...
**Enough:** Someone else could set the same conditions up from your notes alone.
...
Section: practice. Stable action: write-conditions-record.

Write your answer for “Device, browser or method, wait length in seconds, and how many items were in the list”. Use the task instructions below to decide what to include.

**Answer:** Device, browser or method, wait length in seconds, and how many items were in the list
...
Write your answer for “What remains untested even now”. Use the task instructions below to decide what to include.

**Answer:** What remains untested even now
...
Open Your work and choose Ready for review. The next lesson designs a task set that could run without you, and works out what that costs.
...
### Pick a suitable question

Section: practice-plan. Stable action: step-1-brief.

One confirmation question chosen, with the discovery questions kept back for moderated sessions.
...
**Start here:** Go through your open questions and finish this sentence for each: “what a person did, on its own, would answer this” — or it would not.
...
Made-up example. Sending out the wrong question unmoderated, and getting five answers that explained nothing.
...
**Wrong turn:** The wrong turn is sending your most interesting question, because interesting usually means it asks why. An unmoderated run tells you what happened and never why.

**Trade-off:** Keeping the why questions for moderated sessions means fewer people and more of your evenings. It is the only way those questions get answered at all.

**Unknown:** Still unknown: how many of the five read the scenario the way I meant it. In an unmoderated run you cannot find that out, which is itself a limit worth writing down.


### Every question still open after your sessions, each marked discovery or confirmation

Section: practice-plan. Stable action: write-open-questions.

Discovery asks why, or what is going on. Confirmation asks whether a specific thing happens.

**Answer:** Every question still open after your sessions, each marked discovery or confirmation
...
Section: practice-plan. Stable action: write-chosen-question.

Write your answer for “The one confirmation question you will build the task set around, and why it does not need anyone to explain themselves”. Use the task instructions below to decide what to include.

**Answer:** The one confirmation question you will build the task set around, and why it does not need anyone to explain themselves
...
Example (made up): can a person find the change-or-cancel route without help? I need to know whether they get there, not why they chose the route they took.
...
**Start here:** Write it as though you are messaging someone who has never heard of the project.
...
Made-up example. Writing unmoderated instructions with the screen open beside me, so the task tested whether people could read rather than whether they could find.
...
**Wrong turn:** The wrong turn is naming the buttons, and it is very hard to avoid while the screen sits open beside you. Instructions written that way test reading, and reading was never the thing in doubt.

**Trade-off:** A situation with no names in it means one or two of your five will go somewhere else entirely, and you cannot lean over and put them right. Those runs are simply lost, and they are what the useful ones cost you.

**Unknown:** Still unknown: whether the word change in your scenario means the same thing to a reader as the word on the screen. An unmoderated run can never tell you how somebody read your sentence.


### The scenario exactly as the person will read it

Section: practice-plan. Stable action: write-scenario-text.

Write your answer for “The scenario exactly as the person will read it”. Use the task instructions below to decide what to include.

**Answer:** The scenario exactly as the person will read it
...
Section: practice-plan. Stable action: write-goal-and-report.

Write your answer for “What you are asking them to do, and how they send the outcome back to you”. Use the task instructions below to decide what to include.

**Answer:** What you are asking them to do, and how they send the outcome back to you
...
Section: practice-plan. Stable action: write-if-stuck.

Write your answer for “What you tell them to do if something does not work”. Use the task instructions below to decide what to include.

**Answer:** What you tell them to do if something does not work
...
Section: practice-plan. Stable action: write-hesitations.

Write your answer for “Where the reader paused, re-read, or described doing something you did not intend”. Use the task instructions below to decide what to include.

**Answer:** Where the reader paused, re-read, or described doing something you did not intend
...
Section: practice-plan. Stable action: write-rewrites.

Write your answer for “What you changed, with the old wording beside the new”. Use the task instructions below to decide what to include.

**Answer:** What you changed, with the old wording beside the new
...
A specific list of what this method cannot capture, tested against your own strongest finding.
...
**Start here:** Take your strongest session finding and ask whether an outcome alone would have produced it.

**Enough:** The first limit on your list names something specific that your own study would have lost.
...
Section: practice-plan. Stable action: write-limits-list.

Write your answer for “What an unmoderated run cannot capture: the why, hesitation, interruptions, the setting, a misread instruction you never hear about”. Use the task instructions below to decide what to include.

**Answer:** What an unmoderated run cannot capture: the why, hesitation, interruptions, the setting, a misread instruction you never hear about
...
Section: practice-plan. Stable action: write-strongest-finding-test.

Write your answer for “Take your strongest finding from the moderated sessions. Would an unmoderated run have produced it? Write the answer and what that tells you.”. Use the task instructions below to decide what to include.

**Answer:** Take your strongest finding from the moderated sessions. Would an unmoderated run have produced it? Write the answer and what that tells you.
...
Write your answer for “How you would follow up a surprising result”. Use the task instructions below to decide what to include.

**Answer:** How you would follow up a surprising result
...
Check again: The missing why is the first limit on the list.

Answers to revisit: limits-list, strongest-finding-test, follow-up, improvement-made
...
Check again: The limits describe reach gained and explanation lost.
...
Check again: The decision is written either way, and an unrun study carries its date.

Answers to revisit: decision, decision-reason, data-plan, improvement-made
...
A decision either way, with the reason, and the repair the Check questions asked for.
...
**Start here:** Write the reason before you write the decision. The reason usually settles it.

**Enough:** Someone reading the reason could reach the same decision, and the not-run case is written just as fully as the run case.
...
**Answer:** Your decision (Run it / Do not run it / Run it only after something changes)
...
Section: practice. Stable action: write-decision-reason.

Write your answer for “The reason either way: what you would learn, what it costs, and whether that is worth it for this question”. Use the task instructions below to decide what to include.

**Answer:** The reason either way: what you would learn, what it costs, and whether that is worth it for this question
...
Open Your work and choose Ready for review. The next lesson turns everything from this module into a report of at most two pages.
...
Repair: Mark each open question discovery or confirmation, then choose only from the second group. Recheck: The marked question list.
...
Repair: Look at your strongest session finding and ask whether an unmoderated run would have produced it. Usually it would not; that is the first limit. Recheck: The limits list.
...
One paragraph naming the change and its reason, before any method.
...
**Start here:** Write the sentence “the first thing to change is …, because …” and let the rest of the report grow behind it.

**Enough:** The paragraph names a change and a reason, and mentions no method at all.
...
Made-up example. Writing the report in the order it happened, and watching nobody reach the point.
...
**Trade-off:** Two pages means most of what you did is invisible. What you get is that the one thing you want changed is read by everyone who opens it.

**Unknown:** Still unknown: whether the change you name is the right one. The report says what the evidence supports, not that you are right.


### The single change you would make and why, in one paragraph, before any method

Section: practice-plan. Stable action: write-decision-para.

Write your answer for “The single change you would make and why, in one paragraph, before any method”. Use the task instructions below to decide what to include.

**Answer:** The single change you would make and why, in one paragraph, before any method
...
Example (made up): hold the payment work and fix the held-place uncertainty first, because two of three people could not tell whether their place was secured and one said she would have paid again.
...
Section: practice-plan. Stable action: write-held-work.

Write your answer for “What you are asking to stop or wait while this is fixed”. Use the task instructions below to decide what to include.

**Answer:** What you are asking to stop or wait while this is fixed
...
Each finding with its headline, participant count, evidence and what it changes.
...
**Start here:** Take the top of your ranked problem list and write it as four short parts.

**Enough:** Every finding says how many of how many people met it, and the repair result is there however it turned out.
...
Made-up example. Merging two different problems into one finding so that the count would look stronger.
...
**Wrong turn:** The wrong turn is rolling near-neighbour problems into one headline, because a bigger count feels safer and a soft word like confusing seems to cover everything you saw.

**Trade-off:** Split findings are each smaller, and the one-of-three finding will sit at the bottom looking ignorable beside the other. What you get is that each one names a repair somebody could actually make.

**Unknown:** Still unknown: how common the week problem is. One person met it, and nothing in this study says whether the next ten would.
...
Example (made up): people cannot tell whether a place is held before paying — two of three — “I don’t know if the class is definitely mine yet” — the review screen has to say what is already secured.
...
Section: practice-plan. Stable action: write-finding-2.

Write your answer for “Finding 2 · headline, how many of how many people met it, the evidence, and what it changes”. Use the task instructions below to decide what to include.

**Answer:** Finding 2 · headline, how many of how many people met it, the evidence, and what it changes
...
Write your answer for “Finding 3 · headline, how many of how many people met it, the evidence, and what it changes”. Use the task instructions below to decide what to include.

**Answer:** Finding 3 · headline, how many of how many people met it, the evidence, and what it changes
...
Section: practice-plan. Stable action: write-finding-4.

Write your answer for “Finding 4 · headline, how many of how many people met it, the evidence, and what it changes”. Use the task instructions below to decide what to include.

**Answer:** Finding 4 · headline, how many of how many people met it, the evidence, and what it changes




### The repair you tested, the prediction you wrote first, and how it actually turned out

Section: practice-plan. Stable action: write-repair-result.

A partial or failed repair is a result. Write it exactly as it happened.

**Answer:** The repair you tested, the prediction you wrote first, and how it actually turned out
...
A limits section assembled from lists you have already written.
...
**Start here:** Open your recruitment notes, your untestable lists and your fakes sheet, and paste them in unchanged.

**Enough:** A reader could tell who was never asked and what did not really work, without asking you.
...
### How many people took part, how they were reached, and who was left out

Section: practice-plan. Stable action: write-who-took-part.

If part of this came from a rehearsal or from supplied practice material, say so here, in the same sentence as the numbers.

**Answer:** How many people took part, how they were reached, and who was left out
...
Section: practice-plan. Stable action: write-what-was-faked.

Write your answer for “From your fakes sheet: the controls that did nothing and the values you invented”. Use the task instructions below to decide what to include.

**Answer:** From your fakes sheet: the controls that did nothing and the values you invented
...
Write your answer for “What was never tested at all: the connection, assistive technology, other groups of people”. Use the task instructions below to decide what to include.

**Answer:** What was never tested at all: the connection, assistive technology, other groups of people
...
One thing the evidence argues against, with what would reverse it.
...
**Start here:** Ask what the evidence argues against. If the answer is nothing, the study probably confirmed what you already believed.

**Enough:** The non-recommendation names something you were tempted to build.
...
Section: practice-plan. Stable action: write-not-build.

Write your answer for “The one thing the evidence argues against building, and why”. Use the task instructions below to decide what to include.

**Answer:** The one thing the evidence argues against building, and why
...
Section: practice-plan. Stable action: write-would-change-mind.

Write your answer for “The evidence that would reverse it”. Use the task instructions below to decide what to include.

**Answer:** The evidence that would reverse it
...
Section: practice-plan. Stable action: write-expert-opinion.

Write your answer for “The short list of things you believe from experience rather than from anything you tested”. Use the task instructions below to decide what to include.

**Answer:** The short list of things you believe from experience rather than from anything you tested
...
Check again: The findings and limits fit two pages, with the decision paragraph at the top.

Answers to revisit: finding-1, finding-2, finding-3, finding-4, repair-result, improvement-made
...
Check again: Every finding carries a count of how many of how many people.
...
Check again: One named thing not to build, with its reason and its reversal.

Answers to revisit: not-build, would-change-mind, expert-opinion, improvement-made
...
A report readable by someone who was not there, and the repair the Check questions asked for.
...
**Enough:** Nothing in it needs you standing beside it, and no quotation points at a person.
...
Section: practice. Stable action: write-outsider-read.

Write your answer for “What you removed because a reader who was not there could not follow it”. Use the task instructions below to decide what to include.

**Answer:** What you removed because a reader who was not there could not follow it




### Quotations checked for anything that points at a person

Section: practice. Stable action: write-anonymised.

Choose the option that honestly describes your work.

**Answer:** Quotations checked for anything that points at a person (Checked: no name, workplace or detail that points at anyone / Not checked yet / No quotations are used)
...
Open Your work and choose Ready for review. The next lesson gathers the whole first project into one trail and says honestly what it does and does not show.
...
- R59: [GOV.UK: sharing user research findings](https://www.gov.uk/service-manual/user-research/sharing-user-research-findings) — Structuring findings: headline, essential facts, why it matters, evidence. Purpose: Supplies the report structure this lesson applies. Free reading, no account. Verified 2026-09-06; published 24 May 2016. It does not cover anonymisation, which your data-handling reading supplies. Fallback: R04.
- R04: [GOV.UK: analyse a research session](https://www.gov.uk/service-manual/user-research/analyse-a-research-session) — Moving from findings to decisions. Purpose: Keeps the recommendation traceable to the observations behind it. Free reading, no account. Verified 2026-09-06. It does not discuss non-recommendations, which are this course's addition. Fallback: R08.
...
Repair: Move your recommendation to the top and cut everything before it. Recheck: The opening paragraph.
...
Repair: Add the count and one piece of evidence to each finding; drop any finding you cannot support. Recheck: The findings section.
...
Repair: Collect your m05 exclusions, untestable list and fakes sheet and paste them in unchanged. Recheck: The limits section.
...
Bring: All artefacts from m05 through m10.
...
Each major decision beside the evidence it came from and the place that evidence lives.

- List each major design decision in the project.
- Beside each, name the evidence it came from and where that evidence lives.

**Start here:** Work backwards from the prototype. For each thing on the screen, ask what put it there.

**Enough:** Every decision has either a source and a location, or a blank you have not filled in with a guess.
...
Made-up example. Building the trail and finding that my favourite decision had nothing at all behind it.
...
**Wrong turn:** The wrong turn is writing a research-sounding sentence for a decision you simply liked. It reads well, and it is the one thing a reader can catch you on.

**Trade-off:** Marking three decisions as judgement makes the project look less researched than it felt. It is exactly what makes the evidence-led parts believable.

**Unknown:** Still unknown: whether the shortlist helps anyone at all. Nothing in the project touched it, and the trail now says so.


### Each major design decision in the project, and beside it the evidence it came from and where that evidence lives

Section: practice-plan. Stable action: write-decisions-list.

Write your answer for “Each major design decision in the project, and beside it the evidence it came from and where that evidence lives”. Use the task instructions below to decide what to include.

**Answer:** Each major design decision in the project, and beside it the evidence it came from and where that evidence lives
...
Example (made up): made the flow resumable — three interviews where people stopped to check with someone else — session notes in the m05 folder.
...
Section: practice-plan. Stable action: write-weakest-link.

Write your answer for “The link in the trail you would least like to be asked about”. Use the task instructions below to decide what to include.

**Answer:** The link in the trail you would least like to be asked about
...
Each line of the trail marked by what actually backs it.
...
**Start here:** Take the decisions with no source first. Those are the ones the labels are for.

**Enough:** No line in the trail is unlabelled, and no judgement has been given a research-sounding reason.
...
Section: practice-plan. Stable action: write-judgement-calls.

Write your answer for “Every decision with nothing behind it, marked judgement, with what would test each one”. Use the task instructions below to decide what to include.

**Answer:** Every decision with nothing behind it, marked judgement, with what would test each one
...
Section: practice-plan. Stable action: write-rehearsal-marks.

Write your answer for “Anything in the trail that came from a rehearsal or from supplied practice material, labelled as what it was”. Use the task instructions below to decide what to include.

**Answer:** Anything in the trail that came from a rehearsal or from supplied practice material, labelled as what it was
...
Section: practice-plan. Stable action: write-tempting-reason.

Write your answer for “The research-sounding reason you were tempted to write for one judgement call”. Use the task instructions below to decide what to include.

**Answer:** The research-sounding reason you were tempted to write for one judgement call
...
A scope statement naming what was built, what was faked and who took part.
...
**Start here:** Reuse your fakes sheet, your untestable lists and your recruitment notes; they already contain most of the statement.

**Enough:** A reader could tell what you never touched without asking you a single question.
...
Section: practice-plan. Stable action: write-built-and-fidelity.

Write your answer for “What you built, and at what fidelity”. Use the task instructions below to decide what to include.

**Answer:** What you built, and at what fidelity
...
Section: practice-plan. Stable action: write-faked.

Write your answer for “What was faked, taken from your fakes sheet”. Use the task instructions below to decide what to include.

**Answer:** What was faked, taken from your fakes sheet
...
Section: practice-plan. Stable action: write-never-touched.

Write your answer for “What you never tested at all”. Use the task instructions below to decide what to include.

**Answer:** What you never tested at all
...
Write your answer for “Who took part and how they were reached, or the dated gap where nobody did”. Use the task instructions below to decide what to include.

**Answer:** Who took part and how they were reached, or the dated gap where nobody did
...
One paragraph with no outcome claims, and the two things you would do next.
...
**Start here:** Write what you did and what you observed. Stop before any sentence about how well it worked.
...
Made-up example. Writing the summary in a portfolio voice, and finding almost nothing left once the claims came out.
...
**Wrong turn:** The wrong turn is writing the summary in the voice of a finished case study, because that is the voice of every portfolio you have read and it arrives before you have decided anything.

**Trade-off:** A summary with no outcome claims cannot compete with one saying a number went up by thirty per cent. You give up the sentence that gets skimmed and remembered, and you get a paragraph where every line can be produced on request.

**Unknown:** Still unknown: whether the review screen change helps anybody beyond the two people who saw it. The paragraph now says so, rather than implying otherwise.


### The project in one paragraph, with no outcome claims

Section: practice-plan. Stable action: write-summary-para.

Write your answer for “The project in one paragraph, with no outcome claims”. Use the task instructions below to decide what to include.

**Answer:** The project in one paragraph, with no outcome claims




### The words you searched for and removed

Section: practice-plan. Stable action: write-banned-words.

shipped, validated, proven, improved, and every percentage.

**Answer:** The words you searched for and removed
...
Section: practice-plan. Stable action: write-next-two.

Write your answer for “The two things you would do next, and why those two”. Use the task instructions below to decide what to include.

**Answer:** The two things you would do next, and why those two
...
Improve: Move any decision without a source out of the decisions-list field in step 1 and into the judgement-calls field in step 2, then record the change in step 5.

Check again: No line in the trail has an empty source.

Answers to revisit: decisions-list, weakest-link, judgement-calls, rehearsal-marks, tempting-reason, improvement-made
...
You practised analysis on the made up transcript the course supplied. How does it appear in the trail?

- Labelled as supplied practice material, never as a session you ran.
- As a research session, since the analysis method was exactly the same.
- Leave it out; only real work belongs in a trail.

<details>
<summary>After your attempt</summary>

Labelled as supplied practice material, never as a session you ran. — Showing the practice is fine and useful. The label is what separates it from work with real people in it.

As a research session, since the analysis method was exactly the same. — The method being the same does not make the material real. Nobody ever said those words.

Leave it out; only real work belongs in a trail. — It can stay, as long as it says what it is. Practice you can show is better than a gap you cannot explain.

Improve: Add every supplied or rehearsed item to the rehearsal-marks field in step 2 with its label, then record the change in step 5.

Check again: Nothing rehearsed or supplied sits in the trail unlabelled.

Answers to revisit: judgement-calls, rehearsal-marks, tempting-reason, improvement-made
...
Check again: The summary carries no outcome or measurement claims.

Answers to revisit: summary-para, banned-words, next-two, improvement-made
...
Section: practice. Stable action: write-file-map.

Write your answer for “Where each artefact in the trail lives, so any link in it can be produced”. Use the task instructions below to decide what to include.

**Answer:** Where each artefact in the trail lives, so any link in it can be produced




### Raw participant material

Section: practice. Stable action: write-private-material.

Choose the option that honestly describes your work.

**Answer:** Raw participant material (Stored separately from the trail, and private / Not separated yet / There is no raw participant material)
...
Open Your work and choose Ready for review. That closes the first project. What you do with it next is yours to decide, and nothing here commits you to a particular direction.
...
Repair: Take each decision and try to name the artefact behind it. If you cannot, mark it judgement rather than searching for a justification. Recheck: The completed trail.
...
Repair: Reuse your fakes sheet, untestable lists and recruitment exclusions; they already contain the statement. Recheck: The scope statement.
...
Repair: Search for those words and rewrite each sentence as what you did and what you observed. Recheck: The summary.

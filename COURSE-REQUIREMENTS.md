...
|---|---|---|
| Complete self-paced module roadmap | High-level 620-hour blueprint; m00 baseline plus m01–m07 published, 68 authored lessons covering Levels 1 and 2 | The full module map covers all 17 areas; publish the remaining 13 modules in prerequisite order, starting at m08 |
...
1. Follow the mapped prerequisite sequence in COURSE-BLUEPRINT.md. m03 through m07 are authored and published, completing Levels 1 and 2; m08 is next and takes the tested wireframes into interface craft, where the unresolved question is whether any tool-specific exercise can be required before an authenticated free workflow has actually been executed.

...
Bring: Your m05 findings, your marked experience map and your raw interview notes. The notes matter most here, because they contain the words people used for things — which is rarely what the product calls them.

Starting route: Recommended route: Draw the inventory as a table or a deck of cards on paper, then record what you drew in the worksheet here so it is saved and reviewable. Photograph the sheet if you can and note the file name; the photo stays in your own folder. Alternative route: Prefer one file on your computer? Use the local text-file route below with the copyable starter table, and note the file location in Your work.
...
Recommended route: Draw the inventory as a table or a deck of cards on paper, then record what you drew in the worksheet here so it is saved and reviewable. Photograph the sheet if you can and note the file name; the photo stays in your own folder. Alternative route: Prefer one file on your computer? Use the local text-file route below with the copyable starter table, and note the file location in Your work.
...
The product area you are inventorying, where its edges are, and the three tasks from your research that it has to support.
...
**Start here:** Name the area in one sentence, then write the first thing that is just outside it. If m05 gave you no participants, take the three tasks from real messages people have already sent you and label them as your own reading rather than research.

**Enough:** Someone else could read your boundary and tell whether a given item belongs inside it.
...
Made-up example. Setting the boundary for a bicycle repair shop by drawing it round a menu section, and watching two of the three tasks walk straight out of it.
...
**Wrong turn:** The wrong turn is taking the boundary from the navigation, because the edge is already drawn there and somebody else drew it. It is the quickest boundary to write, and it quietly limits your inventory to what has already been published.

**Trade-off:** A boundary drawn round tasks cuts across the product, so you cannot point at it on a screen and have to describe it in a sentence every time. Somebody will also ask why pages sitting inside the section are missing from your list.

**Unknown:** Still unknown: whether these are the right three tasks. They came from a few conversations, and a fourth task nobody happened to mention would put its own answers outside the line you have just drawn.


### The product area you are inventorying, and where its edges are

Section: practice-plan. Stable action: write-area-boundary.

Name what is inside, then name the first thing that is just outside it.

**Answer:** The product area you are inventorying, and where its edges are
...
Write your answer for “The three tasks from your research that this area has to support”. Use the task instructions below to decide what to include.

**Answer:** The three tasks from your research that this area has to support
...
Example (made up): choose a class, get ready for a class you have booked, change or cancel a booking.
...
Five rows worked out here, each with its current label, one plain sentence saying what it actually is, and who needs it and when.
...
**Start here:** Start with something that is not a page: an answer you know lives in a message or in somebody’s head.
...
Made-up example. Writing the first rows of an inventory for a class provider, and finding that the label and the thing were not the same.
...
**Wrong turn:** The wrong turn is copying the label into the description column. It fills the row, it takes no time, and it hides every place where the name and the contents have come apart.

**Trade-off:** A plain sentence per row is slow, and forty rows is a long evening. It is what makes the collisions visible before you draw anything at all.

**Unknown:** Still unknown: whether the items nobody mentioned are unused or merely unmentioned. A handful of conversations cannot settle that, and those rows stay on the list marked as such.


### Item 1 · its current label, then what it actually is in one plain sentence, then who needs it and when

Section: practice-plan. Stable action: write-item-1.

Finish the sentence “this tells someone …”. If you cannot finish it, open the thing and read it.

**Answer:** Item 1 · its current label, then what it actually is in one plain sentence, then who needs it and when
...
Example (made up): “What to bring” · this tells someone which materials to carry to a first pottery class · a first-timer, the evening before.
...
Section: practice-plan. Stable action: write-item-2.

Write your answer for “Item 2 · label, what it actually is, who needs it and when”. Use the task instructions below to decide what to include.

**Answer:** Item 2 · label, what it actually is, who needs it and when
...
Section: practice-plan. Stable action: write-item-3.

Write your answer for “Item 3 · label, what it actually is, who needs it and when”. Use the task instructions below to decide what to include.

**Answer:** Item 3 · label, what it actually is, who needs it and when
...
Section: practice-plan. Stable action: write-item-4.

Write your answer for “Item 4 · label, what it actually is, who needs it and when”. Use the task instructions below to decide what to include.

**Answer:** Item 4 · label, what it actually is, who needs it and when
...
Section: practice-plan. Stable action: write-item-5.

Write your answer for “Item 5 · label, what it actually is, who needs it and when”. Use the task instructions below to decide what to include.

**Answer:** Item 5 · label, what it actually is, who needs it and when




### Add the reachability column
...
Section: practice-plan. Stable action: write-reach-counts.

Write your answer for “How many items sit in each route: main navigation, one page deep, search only, email only, or by asking a person”. Use the task instructions below to decide what to include.

**Answer:** How many items sit in each route: main navigation, one page deep, search only, email only, or by asking a person




### The items reachable only by asking a person or only from an email, and which of them your research showed people needed

Section: practice-plan. Stable action: write-reach-worst.

This is where the real problems announce themselves. Renaming a menu cannot fix any of them.

**Answer:** The items reachable only by asking a person or only from an email, and which of them your research showed people needed
...
**Start here:** Sort your table by label and read for repeats, then sort by description and read for the same thing under two names. The two passes find different collisions.

**Enough:** Each collision names which rows and what kind, not only that something is wrong.
...
Example (made up): rows 7 and 22 · both called “Details”, one is the venue address and one is the refund terms · shared label, a structure problem.
...
Section: practice-plan. Stable action: write-collision-3.
...
Section: practice-plan. Stable action: write-collision-4.
...
Check again: The inventory holds rows that live in emails, messages, documents or somebody’s head, and they are marked as such.

Answers to revisit: area-boundary, three-tasks, improvement-made
...
Check again: Every row carries a plain sentence in your own words, different from its label.

Answers to revisit: item-1, item-2, item-3, item-4, item-5, improvement-made
...
Check again: The routes describe what a stranger would have to do, and the ask-a-person and email-only items are named.

Answers to revisit: reach-counts, reach-worst, improvement-made
...
Your three counts, where the full inventory lives, and the repair the Check questions asked for.
...
**Start here:** Count the rows first. The other two counts come from marks you have already made.

**Enough:** The counts are numbers you arrived at by counting, and the location is specific enough to find next week.
...
Example (made up): 53 items, 6 collisions, 4 items nobody in the research ever needed.
...
Section: practice. Stable action: write-inventory-location.

A file name, or “index cards, in the blue box”. Nothing is uploaded.

**Answer:** Where the full inventory lives
...
Open Your work and choose Ready for review. The next lesson sets your participants’ words against these labels, so keep the inventory to hand.
...
Repair: Take the three tasks from your research and walk each one, writing down every question a person has to answer to finish it. Add every answer that is not already a row. Recheck: The extended inventory with its new rows marked.
...
Repair: For each row, complete “this tells someone …”. Any row you cannot complete either needs opening and reading, or does not contain what its label promises. Recheck: The described inventory.
...
Repair: Go through the inventory pretending you have never used the product and try to reach each item. Record what you actually had to do, not what you know. Recheck: The inventory with routes and the needed cross-marks.
...
Bring: Your inventory and your m05 interview notes. The notes are the source of vocabulary; a label you invented at your desk is a hypothesis and must be marked as one.
...
### Read the heuristic and the sorting guidance

Section: practice-plan. Stable action: step-1-brief.

The three worst labels in your inventory, each with the reason it fails.
...
**Start here:** Read down your inventory labels and mark every one you could not explain to a stranger in five words.
...
### The three worst labels in your inventory, and the reason each one fails

Section: practice-plan. Stable action: write-worst-labels.

Three kinds recur: the internal word that names a department, the clever word invented for character, and the abstract word that is accurate and empty.

**Answer:** The three worst labels in your inventory, and the reason each one fails
...
Example (made up): “Resources” · an internal word · it names a shelf in the office, not a thing anyone is looking for.
...
Made-up example. Reading five sets of interview notes for vocabulary, and throwing away the first pass.
...
**Wrong turn:** The wrong turn is paraphrasing as you read. It feels like note-taking, and it quietly replaces the participant’s vocabulary with yours, which is the exact vocabulary this lesson exists to get away from.

**Trade-off:** Copying verbatim is slower and leaves you holding awkward phrases you would never have chosen. Those are the ones carrying the information.
...
Example (made up): what to bring · “the list of things I need” · P2.
...
### Build the labelling table

Section: practice-plan. Stable action: step-3-brief.

Three worked rows of the labelling table, and a count of how many of your fifteen are guesses.
...
**Start here:** Do a row you have a quotation for first, so you can see what a filled evidence cell looks like.

**Enough:** Every row is either quoted or marked, with nothing in between.
...
Example (made up): “Resources” · “the list of things I need”, P2 and P4 · “What to bring” · two participants, quoted.
...
Write your answer for “Row 2 · current label, participant words, proposed label, evidence or guess”. Use the task instructions below to decide what to include.

**Answer:** Row 2 · current label, participant words, proposed label, evidence or guess
...
Write your answer for “Row 3 · current label, participant words, proposed label, evidence or guess”. Use the task instructions below to decide what to include.

**Answer:** Row 3 · current label, participant words, proposed label, evidence or guess




### How many of your fifteen rows are guesses

Section: practice-plan. Stable action: write-guess-count.

A high number is not a failure. An unmarked guess is.

**Answer:** How many of your fifteen rows are guesses

A high number is not a failure. An unmarked guess is.


### Resolve or record the conflicts

Section: practice-plan. Stable action: step-4-brief.

Your vocabulary conflicts, each with an interpretation and a sentence naming what would settle it.
...
**Start here:** For each conflict write who used which word, and what else you know about those people, before you write what it means.

**Enough:** No conflict has been settled by which word you happen to prefer.

**Conflict:** Two participants using different words for one thing. It is information about them, not a tie for you to break.


### Conflict 1 · the two words, who used each, what you think the disagreement means, and what would settle it
...
Section: practice-plan. Stable action: write-unsettled.

Write your answer for “Any conflict you are leaving unsettled, and why nothing you have distinguishes the two groups”. Use the task instructions below to decide what to include.

**Answer:** Any conflict you are leaving unsettled, and why nothing you have distinguishes the two groups
...
Check again: Every row without a participant word is visibly marked as a guess, and the guess count is written down.

Answers to revisit: row-1, row-2, row-3, guess-count, improvement-made
...
Check again: Each conflict carries an interpretation and a sentence naming what would settle it.

Answers to revisit: conflict-1, conflict-2, unsettled, improvement-made
...
Check again: No surviving label is an internal, clever or abstract word, and each one names the task or the thing.

Answers to revisit: cold-read, notes-read, table-location, improvement-made

</details>


### Read it cold and pause

Section: practice. Stable action: step-5-brief.

The labels that failed the cold read, your sample line, where the table lives, and the repair the Check questions asked for.
...
**Start here:** Cover every column but the proposed labels and read down the list once, quickly, as a stranger scanning a menu.

**Enough:** You can say what is inside each surviving label without looking at the other columns.
...
Made-up example. Reading my own proposed labels cold for a swimming pool, finding nothing wrong with any of them, and realising I had been remembering rather than reading.
...
**Wrong turn:** The wrong turn is doing the cold read straight after writing the labels. Nothing feels wrong, because you are recognising your own rows rather than reading the words, and a clean read is quietly what you were hoping for.

**Trade-off:** Leaving the labels overnight and reading them backwards costs you a day, and you still are not a stranger: the read is colder, not cold. It also turns up failures in labels you were pleased with.

**Unknown:** Still unknown: whether the labels that survived are readable by anybody else. Your own second reading catches the vague ones, and only somebody arriving without the table can catch the rest.


### Reading only your proposed labels: the ones that leave you unable to say what is inside

Section: practice. Stable action: write-cold-read.

Write your answer for “Reading only your proposed labels: the ones that leave you unable to say what is inside”. Use the task instructions below to decide what to include.

**Answer:** Reading only your proposed labels: the ones that leave you unable to say what is inside




### How many participants your notes cover, how they were recruited, and who is missing
...
Section: practice. Stable action: write-table-location.

Write your answer for “Where the full labelling table lives”. Use the task instructions below to decide what to include.

**Answer:** Where the full labelling table lives
...
Open Your work and choose Ready for review. The next lesson groups the items rather than the labels, so keep the card faces showing the items.
...
Repair: Go back through the notes with the inventory beside you and mark every noun a participant used for a thing on your list. Copy them exactly, including the awkward ones. Recheck: The vocabulary column with attributions.
...
Repair: For each label, write what a person would expect to find under it. Where your answer and the actual contents differ, the label is wrong, not the contents. Recheck: The label table with the expectation column.
...
Repair: Work down the evidence column. Any cell you cannot fill with a participant's word or a quotation makes that row a guess. Recheck: The marked table with the guess list.
...
[Nielsen: ten usability heuristics](https://www.nngroup.com/articles/ten-usability-heuristics/). [Web Accessibility Perspectives: Understandable Content](https://www.w3.org/WAI/perspective-videos/understandable/). No video needed: read your own labels aloud to somebody outside the project and note every word you have to explain. Same list, no connection required.

</details>

## Lesson 3: Organisation schemes and where they break

Stable ID: m06-l03-v1. Core.
...
Bring: The inventory and the labelling table. You are grouping the items, not the labels: a group is a claim about what belongs together, and it can be right while the label on it is wrong.

Starting route: Recommended route: Draw both groupings of your cards on paper, then record what you drew in the worksheet here so it is saved and reviewable. Photograph the sheet if you can and note the file name; the photo stays in your own folder. Alternative route: Prefer one file on your computer? Use the local text-file route below with the copyable starter table, and note the file location in Your work.
...
Recommended route: Draw both groupings of your cards on paper, then record what you drew in the worksheet here so it is saved and reviewable. Photograph the sheet if you can and note the file name; the photo stays in your own folder. Alternative route: Prefer one file on your computer? Use the local text-file route below with the copyable starter table, and note the file location in Your work.

- Write answers in this course. Keep drawings in your own paper folder or file and record their location. You can stop and resume after any action.


### Read on grouping and load
...
A task-based grouping of every card, each group named from what fell into it, with every hesitation recorded.
...
**Start here:** Deal the cards face up and make piles without naming them. Name each pile only when nothing is left in your hand.

**Enough:** Every group name came from its contents rather than from a name you had in mind before you started.
...
Section: practice-plan. Stable action: write-scheme-one-groups.

Write your answer for “Your task-based groups, each named from what fell into it”. Use the task instructions below to decide what to include.

**Answer:** Your task-based groups, each named from what fell into it
...
Example (made up): Choose a class · Get ready for a class · Change or cancel · Get help.
...
Section: practice-plan. Stable action: write-scheme-one-hesitations.

Write your answer for “Every card you held for more than a few seconds, and the two places it nearly went”. Use the task instructions below to decide what to include.

**Answer:** Every card you held for more than a few seconds, and the two places it nearly went
...
A second grouping of the same cards under a different rule, named, with its own hesitations recorded.
...
**Start here:** Sweep the cards together and deal again from nothing. Editing the first grouping is not a second scheme.

**Enough:** Somebody reading only the group names could tell which rule you were following.
...
Made-up example. Sorting the same thirty-eight cards a second time for a community centre, and producing the first grouping wearing new names.
...
**Wrong turn:** The wrong turn is editing the first grouping instead of starting again. The cards are already in piles, moving a few of them takes minutes, and from the outside the result is hard to tell apart from a second scheme.

**Trade-off:** Dealing from nothing throws away an hour of sorting you have already done, and the second set of groups will usually please you less than the first. That is the cost of the second grouping being independent rather than a rewording of the first.

**Unknown:** Still unknown: whether a third rule would suit this material better than either. You are choosing between two shapes you made yourself, and the card sort is where somebody who is not you gets a say.


### Which scheme you used for the second sort, and why it suits this material

Section: practice-plan. Stable action: write-scheme-two-name.

By topic, by audience, or an exact scheme such as alphabetical or chronological.

**Answer:** Which scheme you used for the second sort, and why it suits this material
...
Section: practice-plan. Stable action: write-scheme-two-groups.

Write your answer for “Your second set of groups, each named from what fell into it”. Use the task instructions below to decide what to include.

**Answer:** Your second set of groups, each named from what fell into it
...
Section: practice-plan. Stable action: write-scheme-two-hesitations.

Write your answer for “The cards you hesitated over this time, and where they nearly went”. Use the task instructions below to decide what to include.

**Answer:** The cards you hesitated over this time, and where they nearly went




### Break both on purpose

Section: practice-plan. Stable action: step-4-brief.

A breakage case per scheme naming an item and a person, and a written decision for each item that belongs in two places.
...
**Start here:** Walk one research task through one scheme while holding a specific person in mind, and stop at the first place you hesitate. If m05 gave you nobody, use a person described in a real message you already have, and mark the case as your own reasoning rather than research.

**Enough:** Each breakage names a thing, a person and a moment, and no decision box says only that the item is difficult.
...
Made-up example. Breaking two groupings of the same fifty-three cards on purpose, after first writing something useless.
...
**Wrong turn:** The wrong turn is conceding in general that every scheme overlaps. It sounds mature, it costs nothing, and it leaves you with no case anyone could test later.

**Trade-off:** Naming a specific breakage commits you to a claim somebody can prove wrong. That is the point of it; a vague concession can never be checked at all.

**Unknown:** Still unknown: whether the person you imagined resembles anyone real. The card sort and the tree test are where that gets checked.
...
Example (made up): “what to bring” · a first-timer still deciding whether to book · she is reading the class page and it lives under Get ready.
...
Section: practice-plan. Stable action: write-break-two.

Write your answer for “Scheme two breaks: the specific item, the specific kind of person, and the situation”. Use the task instructions below to decide what to include.

**Answer:** Scheme two breaks: the specific item, the specific kind of person, and the situation
...
Write your answer for “Collision 1 · the item, its two candidate homes, and your choice of duplicate, cross-link or restructure, with the reason”. Use the task instructions below to decide what to include.

**Answer:** Collision 1 · the item, its two candidate homes, and your choice of duplicate, cross-link or restructure, with the reason
...
Write your answer for “Collision 2 · the item, both homes, your choice and the reason”. Use the task instructions below to decide what to include.

**Answer:** Collision 2 · the item, both homes, your choice and the reason
...
Write your answer for “Collision 3 · the item, both homes, your choice and the reason”. Use the task instructions below to decide what to include.

**Answer:** Collision 3 · the item, both homes, your choice and the reason
...
Check again: Each scheme has a breakage naming one item, one kind of person and one moment.

Answers to revisit: break-one, break-two, decision-1, decision-2, decision-3, improvement-made
...
Check again: Every hesitated item carries one of the three decisions and a reason.
...
Check again: Any audience scheme carries a named person who cannot classify herself.

Answers to revisit: scheme-one-groups, scheme-one-hesitations, scheme-two-name, scheme-two-groups, scheme-two-hesitations, improvement-made

</details>


### Choose and record, then pause

Section: practice. Stable action: step-5-brief.

The scheme you are carrying forward, what you gave up, where the groupings live, and the repair the Check questions asked for.
...
**Start here:** Choose the scheme whose breakage you would rather live with, and say why in one sentence.

**Enough:** The trade-off names who pays and what a later test would show.
...
Section: practice. Stable action: write-chosen-scheme.

Write your answer for “The scheme you are carrying forward”. Use the task instructions below to decide what to include.

**Answer:** The scheme you are carrying forward




### What you gave up, which tasks the loss affects, and how a tree test would show it

Section: practice. Stable action: write-given-up.

Finish the sentence “people doing … will now have to …, and I will see it in the tree test as …”.

**Answer:** What you gave up, which tasks the loss affects, and how a tree test would show it
...
**Answer:** Where the two groupings and their photographs live
...
Open Your work and choose Ready for review. The next lesson draws your chosen scheme as a sitemap and then a shallower version of it, so keep both groupings.
...
Repair: Take the scheme you built and ask what the material would look like organised by what people are doing rather than what things are about. Re-sort completely rather than editing. Recheck: The two groupings.
...
Repair: List every item you hesitated over. For each, write the two candidate homes and choose one of the three options in writing. Recheck: The collision decisions.
...
Bring: The scheme you chose and its recorded trade-off. A sitemap is that scheme drawn with its levels made explicit, which is when the depth problems become visible.

Starting route: Recommended route: Draw the sitemap and its shallower alternative on paper, then record what you drew in the worksheet here so it is saved and reviewable. Photograph the sheet if you can and note the file name; the photo stays in your own folder. Alternative route: Prefer one file on your computer? Use the local text-file route below with the copyable starter table, and note the file location in Your work.
...
**Enough:** You have said what each shape costs without repeating a number that nobody published.
...
### What the reading says about the effort of choosing and of scanning, and what it does not claim about a maximum number of options
...
Your map drawn with every level, how deep each of your three tasks reaches, and what level two looks like on a phone.
...
**Start here:** Draw level one across the top of a wide sheet, then hang each group’s contents beneath it.

**Enough:** Every item from your chosen scheme has a position, and the three task counts are real numbers you arrived at by tracing.
...
Made-up example. Counting how deep each of three tasks reaches on my own sitemap of a small theatre, and getting every count too low.
...
**Wrong turn:** The wrong turn is counting depth by walking your own route, because you drew the map and already know where everything sits. Every task comes out shallow, and the shape looks better than it is.

**Trade-off:** Marking every uncertain point rather than every level gives you larger numbers that are harder to defend, and somebody will say you are being hard on your own work. You cannot show that the guesses are guesses until a tree test, so the honest count is the uncomfortable one.

**Unknown:** Still unknown: which of the points you marked really are guesses for somebody else. You marked them by imagining that you did not know, and that is the one thing you cannot actually do.


### How many levels your map has, and how many groups sit at level one

Section: practice-plan. Stable action: write-map-one-shape.

Write your answer for “How many levels your map has, and how many groups sit at level one”. Use the task instructions below to decide what to include.

**Answer:** How many levels your map has, and how many groups sit at level one
...
Example (made up): three levels, four groups at level one.

</details>


### Each of your three research tasks, and how many levels it has to pass through

Section: practice-plan. Stable action: write-task-depths.

Walk each task across the drawing with your finger and count the places where you had to choose.

**Answer:** Each of your three research tasks, and how many levels it has to pass through

Walk each task across the drawing with your finger and count the places where you had to choose.


### What level two looks like on a phone, once level one has scrolled off the screen

Section: practice-plan. Stable action: write-small-screen-note.

Cover everything but one level with a sheet of paper and read what is left. If you cannot tell where you are, neither can a reader.

**Answer:** What level two looks like on a phone, once level one has scrolled off the screen

Cover everything but one level with a sheet of paper and read what is left. If you cannot tell where you are, neither can a reader.


### Interrogate level two

Section: practice-plan. Stable action: step-3-brief.

A one-sentence summary for each level-two group, with any group you cannot summarise marked vague.
...
**Start here:** For each group write “this contains …” and list the actual items before you attempt the summary.

**Enough:** Each box either says plainly what is inside or says vague. A summary that could describe three different groups is a vague one.
...
Section: practice-plan. Stable action: write-level-two-1.

Write your answer for “Level-two group 1 · its name, one sentence saying what is inside, and the word vague if you cannot write that sentence”. Use the task instructions below to decide what to include.

**Answer:** Level-two group 1 · its name, one sentence saying what is inside, and the word vague if you cannot write that sentence
...
Example (made up): Practical information · holds what to bring, directions and parking. Vague, because those three share nothing except having nowhere else to go.
...
Section: practice-plan. Stable action: write-level-two-2.

Write your answer for “Level-two group 2 · its name, one sentence saying what is inside, and the word vague if you cannot write that sentence”. Use the task instructions below to decide what to include.

**Answer:** Level-two group 2 · its name, one sentence saying what is inside, and the word vague if you cannot write that sentence
...
Section: practice-plan. Stable action: write-level-two-3.

Write your answer for “Level-two group 3 · its name, one sentence saying what is inside, and the word vague if you cannot write that sentence”. Use the task instructions below to decide what to include.

**Answer:** Level-two group 3 · its name, one sentence saying what is inside, and the word vague if you cannot write that sentence
...
Section: practice-plan. Stable action: write-level-two-4.

Write your answer for “Level-two group 4 · its name, one sentence saying what is inside, and the word vague if you cannot write that sentence”. Use the task instructions below to decide what to include.

**Answer:** Level-two group 4 · its name, one sentence saying what is inside, and the word vague if you cannot write that sentence




### Build the shallower alternative
...
**Enough:** Every item exists in both maps, and you can name something the shallower one made worse.
...
Made-up example. Flattening a three-level map, and finding out the flat version was worse for one of the three tasks.
...
**Wrong turn:** The wrong turn is treating shallow as a goal in itself. Flat helps only while the reader can still scan the row, and nineteen options stop being a row.

**Trade-off:** The shallower map gives up the parent that held related things together. Someone who wanted to read around a subject now has to find the pieces separately.

**Unknown:** Still unknown: whether four is the right number to lift. Only a tree test can show where people actually stop, and that is a later lesson.


### Which items you lifted to level one, and why those ones
...
Section: practice-plan. Stable action: write-crowding.

Something always gets worse. If nothing did, the second map is probably the first map redrawn.

**Answer:** What became crowded, and what became harder to find
...
Check again: Each task is described by its uncertain choices rather than by a click count.

Answers to revisit: map-one-shape, task-depths, small-screen-note, improvement-made
...
Check again: Every level-two group has a one-sentence summary naming its actual contents.

Answers to revisit: level-two-1, level-two-2, level-two-3, level-two-4, improvement-made
...
Check again: The recorded choice names a task it disadvantages and what would reveal the cost.

Answers to revisit: task-comparison, chosen-shape, cost-of-choice, map-reference, improvement-made

</details>


### Compare on tasks and pause

Section: practice. Stable action: step-5-brief.

Which shape favours each task, your chosen shape with what it costs, where the drawings live, and the repair the Check questions asked for.
...
**Start here:** Walk each task through both maps with your finger, marking every point where you would be unsure.
...
### For each of your three tasks: which shape favours it, and why

Section: practice. Stable action: write-task-comparison.

Count uncertain decisions rather than clicks. Expect the answer to differ between tasks.

**Answer:** For each of your three tasks: which shape favours it, and why

Count uncertain decisions rather than clicks. Expect the answer to differ between tasks.


### Which shape you will take into the tree test

Section: practice. Stable action: write-chosen-shape.

Choose the option that honestly describes your work.

**Answer:** Which shape you will take into the tree test (The deeper map / The shallower map)




### What you gave up, which task it affects, and what a tree test would show if it matters

Section: practice. Stable action: write-cost-of-choice.

Finish the sentence “people doing … will now have to …, and I would see it as …”.

**Answer:** What you gave up, which task it affects, and what a tree test would show if it matters

Finish the sentence “people doing … will now have to …, and I would see it as …”.


### Where both drawings live

Section: practice. Stable action: write-map-reference.

File names or “paper, in my folder”. Naming a file does not upload it.

**Answer:** Where both drawings live
...
Open Your work and choose Ready for review. The next lesson puts your inventory cards in front of people and asks them to group them.
...
Repair: Take your map and lift the four items your research showed people need most to level one, then re-place whatever is left. Check that no item disappeared in the process. Recheck: The two complete maps.
...
Repair: For each level-two group, write “this contains …” listing the actual items. If the list has no coherent theme, mark the group. Recheck: The summaries and marks.
...
Repair: Cover everything but one level of your map with paper and read what remains. If you cannot tell where you are or what is inside, neither can a person on a phone. Recheck: The small-screen note and any change it caused.
...
Bring: The cards from your inventory, your consent introduction from m05 and your recruitment route. The cards must show the item, not your proposed label, or you will be testing your own wording back at yourself.
...
### Prepare the cards and the script

Section: practice-plan. Stable action: step-1-brief.

Your card set counted and checked, and the sentences you will say before anyone starts.
...
**Start here:** Deal the cards out and read only the faces. Any card whose wording points at a group has to be rewritten.

**Enough:** No card face carries a group name or one of your proposed labels, and you could say the consent sentences aloud without reading them.
...
### How many cards you made, and where the card set lives

Section: practice-plan. Stable action: write-card-count.

Thirty to fifty is workable. Past about sixty people tire and the last piles get made carelessly.

**Answer:** How many cards you made, and where the card set lives
...
Section: practice-plan. Stable action: write-card-check.

Write your answer for “Two cards you rewrote because the face hinted where the card belonged, before and after”. Use the task instructions below to decide what to include.

**Answer:** Two cards you rewrote because the face hinted where the card belonged, before and after
...
Example (made up): before, “Booking admin: change a class”. After, “Move my booking to a different day”.

</details>


### The sentences you will say before starting: what the session is, that nothing about it is a test of them, that you will photograph the cards, and that they can stop at any point

Section: practice-plan. Stable action: write-consent-script.

Extend the introduction you wrote in m05 rather than starting again.

**Answer:** The sentences you will say before starting: what the session is, that nothing about it is a test of them, that you will photograph the cards, and that they can stop at any point
...
The open sort recorded: how it actually happened, the groups and names in their words, and every hesitation.
...
**Start here:** Say “there are no wrong groups, and I am interested in how you think about these”, then stop talking and write.

**Enough:** Someone reading your notes could describe the session without asking you a single question.
...
Made-up example. Running an open sort and writing down a conclusion instead of what happened.
...
**Wrong turn:** The wrong turn is writing the interpretation while the person is still in the room. It is the sentence you want to act on, it takes ten seconds, and it destroys the evidence underneath it.

**Trade-off:** Writing what happened is slower and your notes read duller. It is what lets a change be traced to a person rather than to your memory of an afternoon.

**Unknown:** Still unknown: why she thought about fault at all. One sort with one person cannot tell you, and it is worth asking the next person.


### How the open sort actually happened

Section: practice-plan. Stable action: write-open-status.

Choose the option that honestly describes your work.

**Answer:** How the open sort actually happened (A person consented and sorted the cards / Nobody has consented yet, so I sorted them myself as a rehearsal)

Answer this before you write anything else about the session. It decides what the rest of the record is allowed to claim.


### The groups they made and the name they gave each, in their words
...
Example (made up): picked up the cancellation policy card three times, moved it from the money pile to the cancelling pile and back, said “this depends on whose fault it is”.
...
The closed sort recorded: how it actually happened, and every card placed slowly, questioned or refused.
...
**Start here:** Lay your chosen groups out first, then hand the cards over one small pile at a time.

**Enough:** The slow placements are written down separately from the fast ones.
...
Made-up example. Running a closed sort where every card found a home, and only afterwards noticing that I had left nobody any way to refuse.
...
**Wrong turn:** The wrong turn is telling the person that every card has to go somewhere. It fills the sheet, it feels like a finished piece of work, and it quietly turns doubt into a placement you can no longer see.

**Trade-off:** A refusal space costs you completeness. You end up holding items with no home and no instruction about where they should live, and that is an unfinished structure you have to come back to with a different method.

**Unknown:** Still unknown: whether a card was refused because your group names are wrong or because the item does not belong in the product at all. A closed sort cannot separate those two.


### How the closed sort actually happened

Section: practice-plan. Stable action: write-closed-status.

Choose the option that honestly describes your work.

**Answer:** How the closed sort actually happened (A person consented and placed the cards / Nobody has consented yet, so I placed them myself as a rehearsal)




### Every card placed slowly, questioned or refused, and what was said about each

Section: practice-plan. Stable action: write-closed-placements.

A card placed instantly and a card placed after twenty seconds are different results, even when they land in the same group.

**Answer:** Every card placed slowly, questioned or refused, and what was said about each
...
A written record of each session, three of your own lines split into did, said and concluded, and where the photographs live.
...
**Start here:** Write the record from the photographs and the rough notes together, in that order, before you interpret anything.

**Enough:** Each session has a participant label, named groups, hesitations and at least one exact phrase.
...
Section: practice-plan. Stable action: write-did-said-concluded.

Any line that will not split is already a conclusion wearing the clothes of an observation.

**Answer:** Three lines from your notes, each split into what they did, what they said, and what you concluded
...
Section: practice-plan. Stable action: write-photo-reference.

Write a file location, or describe where you keep the paper version. A photo is optional; nothing is uploaded here.

**Answer:** Where the photographs live
...
Check again: No artefact from a rehearsal can be read as research, and the recruitment gap carries dates.

Answers to revisit: open-status, open-groups, open-hesitations, improvement-made
...
Check again: Every hesitation note names a card, a movement or a phrase.
...
Check again: No card face carries a group name or a proposed label.

Answers to revisit: card-count, card-check, consent-script, improvement-made

</details>


### Note the sample and pause

Section: practice. Stable action: step-5-brief.

How many people sorted and who is missing, the recruitment gap if there is one, your rehearsal label, and the repair the Check questions asked for.
...
**Start here:** Write the count first, then the route you used to find people, then the kind of person you never reached.

**Enough:** A stranger reading only this box could tell whether any participant was involved.
...
### How many people sorted, how you found them, and who is missing
...
Example (made up): “Rehearsal, sorted by me, no participants” written across the photograph and at the top of the write-up.
...
Open Your work and choose Ready for review. The next lesson turns these records into counts, without turning four people into a percentage.
...
Repair: Read each card and ask whether it hints where it belongs. Rewrite any card that does, using the words your m05 participants used for that thing. Recheck: The corrected card set.
...
Repair: If recruitment failed, write what you tried, when, and what you will try next, then run both sorts on yourself and label every artefact rehearsal, permanently. Recheck: Both records, or the gap and the labelled rehearsal.
...
Repair: In your next session, keep a separate sheet for doubt: every pause, every card picked up twice, every question asked. Add it to the record. Recheck: The session notes with hesitations.
...
Section: practice-plan. Stable action: write-table-shape.

Write your answer for “How many items are in your table, and how many participants have a column”. Use the task instructions below to decide what to include.

**Answer:** How many items are in your table, and how many participants have a column
...
Example (made up): refund rule — P1 money cards, hesitated; P2 money cards, hesitated; P3 money cards; P4 cancelling pile.

</details>


### Any placement you could not recover from the photographs or the notes

Section: practice-plan. Stable action: write-missing-cells.

Leave the cell blank and say so here. A reconstructed placement is an invented one.

**Answer:** Any placement you could not recover from the photographs or the notes
...
Each item labelled agreement, disagreement or ambiguous, with counts and an interpretation written for every disagreement.
...
**Start here:** Read down each row and ask two questions: did they all place it the same way, and did any of them take their time.

**Enough:** Every item carries one of the three labels, and every disagreement carries a sentence saying what you think it means.
...
Made-up example. Classifying four sorts, and turning three people into a percentage before catching it.
...
**Trade-off:** Counts read as small and unimpressive, and somebody will ask whether that is really all you have. It is, and saying so plainly is what keeps the rest of your findings believable.

**Unknown:** Still unknown: whether the money grouping holds for anyone who has never cancelled anything. None of the four had, and a count cannot cover a person you did not meet.


### How many of your items fell into each of the three patterns

Section: practice-plan. Stable action: write-pattern-counts.

Write your answer for “How many of your items fell into each of the three patterns”. Use the task instructions below to decide what to include.

**Answer:** How many of your items fell into each of the three patterns
...
Example (made up): eleven agreements, six disagreements, four ambiguous.

</details>


### Each disagreement, with what you think it means: two audiences, two items, or too little evidence

Section: practice-plan. Stable action: write-disagreements.

Look at who placed it which way and what else you know about them. If nothing distinguishes them, say so rather than deciding.

**Answer:** Each disagreement, with what you think it means: two audiences, two items, or too little evidence

Look at who placed it which way and what else you know about them. If nothing distinguishes them, say so rather than deciding.


### The items placed consistently but slowly, and what the hesitation looked or sounded like
...
Made-up example. Writing one traced change that turned out to be three changes hiding behind a single true sentence.
...
**Wrong turn:** The wrong turn is letting one true trace sentence stand for everything you altered at the same sitting. The sentence is honest, the change around it is not, and you will not notice because you wrote both in the same minute.

**Trade-off:** One change per box makes your revision look thin: three small moves instead of the nine you can see are needed. The thin list is the one you can defend line by line when somebody asks where each move came from.

**Unknown:** Still unknown: whether the split is the right split. Four people separating two cards tells you they are not the same thing, and tells you nothing about what the two new groups should be called.
...
Example (made up): split “change my booking” from “cancel my booking”, because four of four participants put them in different piles.
...
Write your answer for “Change 2 · what moved, and the sentence naming the item, the participants and what they did”. Use the task instructions below to decide what to include.

**Answer:** Change 2 · what moved, and the sentence naming the item, the participants and what they did
...
Write your answer for “Change 3 · what moved, and the sentence naming the item, the participants and what they did”. Use the task instructions below to decide what to include.

**Answer:** Change 3 · what moved, and the sentence naming the item, the participants and what they did
...
Section: practice-plan. Stable action: write-change-4.

Write your answer for “Change 4 · what moved, and the sentence naming the item, the participants and what they did”. Use the task instructions below to decide what to include.

**Answer:** Change 4 · what moved, and the sentence naming the item, the participants and what they did
...
Every change you wanted that no participant’s behaviour supports, kept on its own list.
...
**Start here:** Go through the changes you did not write in the last step and ask which participant did what to prompt each one.

**Enough:** The preferences list is not empty. If it is, you have probably filed a preference as a finding.
...
### Every change you want to make that no participant’s behaviour supports

Section: practice-plan. Stable action: write-preferences-list.

These are allowed and often sensible. They are simply not findings, and this list is where they say so.

**Answer:** Every change you want to make that no participant’s behaviour supports
...
Write your answer for “The one you most wanted to move onto the evidence list, and why it stays here”. Use the task instructions below to decide what to include.

**Answer:** The one you most wanted to move onto the evidence list, and why it stays here
...
Check again: Ambiguous items are listed separately from agreements, each with the hesitation described.

Answers to revisit: pattern-counts, disagreements, ambiguous-items, improvement-made
...
Improve: Check each change in step 3 for a sentence naming the item, the participants and what they did. Move any change without one to the preferences list, then record it in step 5.

Check again: Every change on the evidence list carries a trace sentence, and the rest sit on the preferences list.

Answers to revisit: change-1, change-2, change-3, change-4, improvement-made
...
### Write the sample line and pause

Section: practice. Stable action: step-5-brief.

The sentence that goes with these results everywhere, what your search for rates turned up, and the repair the Check questions asked for.
...
**Start here:** Write the count, then the recruitment route, then the word exploratory, in one sentence.

**Enough:** The sample line could be pasted beside any result in this lesson and still be accurate.
...
### How many people sorted, how you found them, and that a sort this size is exploratory
...
Section: practice. Stable action: write-percentage-sweep.

Write your answer for “What you found when you searched your write-up for the per cent sign and for anything drawn as a distance”. Use the task instructions below to decide what to include.

**Answer:** What you found when you searched your write-up for the per cent sign and for anything drawn as a distance
...
Open Your work and choose Ready for review. The next lesson puts the revised structure in front of people as a paper tree and gives them tasks to find things in it.
...
- R09: [NN/g: card sorting](https://www.nngroup.com/articles/card-sorting-definition/) — The analysis section and the article's statements about what small samples support. Purpose: Supplies the analysis approach and the explicit limits this lesson enforces. Free reading, no account. Verified 2026-09-06. It describes analysis techniques intended for larger sorts; at four or five participants use counts only, which is this lesson's rule rather than the article's. Fallback: R10.
- R37: [NN/g: confidence intervals and margins of error](https://www.nngroup.com/articles/confidence-interval/) — What an interval means and how sample size widens it, read as the reason a rate is not reportable here. Purpose: Shows concretely why a proportion from four participants carries no information worth stating. Free reading, no account. Verified 2026-09-06. It gives no formulas and is about quantitative studies; here it is the argument against computing a rate at all, not a technique to apply. Fallback: R45.
...
Repair: Rebuild the table from the photographs and session notes. If a placement is unrecoverable, leave the cell blank rather than reconstructing it from memory. Recheck: The completed item table.
...
Repair: Re-read your hesitation notes and mark every item that was placed slowly. Those are your ambiguous items, however consistent the placements look. Recheck: The classified table.
...
Repair: For each change, write “this moved because participants … did …”. Any change you cannot complete belongs on the preferences list. Recheck: The revised map with trace sentences.
...
Bring: Your revised sitemap and the ambiguous items from the sort analysis. The tasks should aim at the places you are least sure of, not at the places you are proud of.

Starting route: Recommended route: Draw the tree one level per sheet and the six task cards on paper, then record what you drew in the worksheet here so it is saved and reviewable. Photograph the sheet if you can and note the file name; the photo stays in your own folder. Alternative route: Prefer one file on your computer? Use the local text-file route below with the copyable starter table, and note the file location in Your work.
...
Recommended route: Draw the tree one level per sheet and the six task cards on paper, then record what you drew in the worksheet here so it is saved and reviewable. Photograph the sheet if you can and note the file name; the photo stays in your own folder. Alternative route: Prefer one file on your computer? Use the local text-file route below with the copyable starter table, and note the file location in Your work.

- Write answers in this course. Keep drawings in your own paper folder or file and record their location. You can stop and resume after any action.


### Read and build the paper tree

Section: practice-plan. Stable action: step-1-brief.

A paper tree with one sheet per level, copied from your revised structure without improving anything on the way.
...
**Start here:** Write the top level on one sheet. Then give every group on it a sheet of its own.

**Enough:** You can reveal one level at a time without the next one showing.
...
### What is written on each sheet, level by level

Section: practice-plan. Stable action: write-tree-shape.

Copy the labels exactly as they stand in your revised structure. Do not improve them while you copy.

**Answer:** What is written on each sheet, level by level
...
Example (made up): sheet one carries Choose a class, Get ready, Change or cancel, Get help. The sheet for Change or cancel carries Booking admin and Payments.

</details>


### How you will keep the lower sheets out of sight

Section: practice-plan. Stable action: write-hidden-check.

Face down in a pile, or in an envelope. A person who glimpses the second level has already been given the answer.

**Answer:** How you will keep the lower sheets out of sight

Face down in a pile, or in an envelope. A person who glimpses the second level has already been given the answer.


### Write six tasks and their answers

Section: practice-plan. Stable action: step-2-brief.

Six tasks, each a situation with a goal, and the answer you accept written down before anyone sits with you.
...
Made-up example. Writing six tree-test tasks, and finding that the first three handed people the answer.
...
**Wrong turn:** The wrong turn is writing tasks from the sitemap, because the labels are sitting in front of you. A task carrying the label of its target tests matching, not finding.

**Trade-off:** A situation-shaped task takes longer to write and often has two reasonable answers. You have to settle both in advance, which is slower and is the only thing that makes the result readable.

**Unknown:** Still unknown: whether these situations are ones your people actually meet. They came from your m05 notes, and those were a few people.


### Task 1 · the situation, the goal, and the answer you will accept
...
Example (made up): you booked a class for Saturday and something has come up. Goal: reach the place that lets you move it. Accepted: Change or cancel, and also Get help.
...
Write your answer for “Task 2 · the situation, the goal, and the answer you will accept”. Use the task instructions below to decide what to include.

**Answer:** Task 2 · the situation, the goal, and the answer you will accept
...
Section: practice-plan. Stable action: write-task-3.

Write your answer for “Task 3 · the situation, the goal, and the answer you will accept”. Use the task instructions below to decide what to include.

**Answer:** Task 3 · the situation, the goal, and the answer you will accept
...
Section: practice-plan. Stable action: write-task-4.

Write your answer for “Task 4 · the situation, the goal, and the answer you will accept”. Use the task instructions below to decide what to include.

**Answer:** Task 4 · the situation, the goal, and the answer you will accept
...
Section: practice-plan. Stable action: write-task-5.

Write your answer for “Task 5 · the situation, the goal, and the answer you will accept”. Use the task instructions below to decide what to include.

**Answer:** Task 5 · the situation, the goal, and the answer you will accept
...
Section: practice-plan. Stable action: write-task-6.

Write your answer for “Task 6 · the situation, the goal, and the answer you will accept”. Use the task instructions below to decide what to include.

**Answer:** Task 6 · the situation, the goal, and the answer you will accept
...
Every task run with each person, recording the first choice and the whole path, not only whether they arrived.
...
**Start here:** Ask for consent, explain that you are testing the words and not the person, and answer every question with “where would you look?”.

**Enough:** Every task and every person has a first choice and a path recorded. If nobody consented, choose the rehearsal option, run it on yourself, and label every sheet and every line rehearsal so it can never be read as research.
...
### How this run actually happened

Section: practice-plan. Stable action: write-participant-route.

Choose the option that honestly describes your work.

**Answer:** How this run actually happened (Three or more people took part, with consent / One or two people took part, with consent, and the gap is recorded / Nobody was available: I ran it on myself as a rehearsal, labelled as a rehearsal and never counted as a result)




### For every task and every person: the first choice, the whole path, whether they went back up, and where they said they would stop
...
How sure each person was that they had arrived, written in their own words.
...
**Start here:** Ask the confidence question straight after each task, before you move the sheets.

**Enough:** A confident wrong answer and an unsure right one are marked as different results, because they lead to different changes.
...
Made-up example. Asking people how sure they were, and collecting six yeses that meant nothing at all.
...
**Wrong turn:** The wrong turn is the yes-or-no confidence question. It is quick to ask, quick to write down, and it carries your own opinion inside it, so people answer the opinion rather than the question.

**Trade-off:** Answers in their own words will not line up in a column and cannot be added up. You are left with sentences you have to sit and read, and no tidy figure to put anywhere.

**Unknown:** Still unknown: what somebody who says fairly sure would do in a real product with a price on the page. Sitting at a table with paper costs her nothing, so this is a guess about her behaviour rather than a measure of it.


### After each task, how sure they were that they had arrived, in their own words
...
Section: practice-plan. Stable action: write-confident-wrong.

Write your answer for “Any task where somebody was sure and wrong, or unsure and right”. Use the task instructions below to decide what to include.

**Answer:** Any task where somebody was sure and wrong, or unsure and right
...
Check again: Every task has a first choice and a full path beside its outcome.

Answers to revisit: participant-route, results-table, improvement-made
...
Check again: The record says how many people took part, and any rehearsal is labelled a rehearsal everywhere the results appear.
...
The sample line, where the sheets and the table live, and the repair the Check questions asked for.
...
**Start here:** Write the raw table out fully before you interpret anything. The next lesson does the interpreting.

**Enough:** The count of people appears at the top of the results, not at the bottom.
...
### How many people took part, how you found them, who is missing, and whether any of this was a rehearsal
...
Section: practice. Stable action: write-artefact-location.

File names or “paper, in my folder”. Nothing is uploaded.

**Answer:** Where the sheets, the task cards and the table live
...
Open Your work and choose Ready for review. The next lesson reads these results and changes exactly one thing.
...
Repair: Write the answer key now and mark honestly which answers you decided after the fact; those tasks are unreliable and should be re-run. Recheck: The answer key with any re-run tasks.
...
Repair: Re-run the missing column with a fresh participant rather than reconstructing it; first choice and confidence cannot be recovered afterwards. Recheck: The complete results table.
...
Bring: The tree-test results table and the structure you tested. Do not change anything before this lesson: a diagnosis written after several simultaneous edits explains nothing.
...
Section: practice-plan. Stable action: write-reportable-measures.

Write the ones you can report as counts of people, and the ones you would have to invent a rate for.

**Answer:** The measures the article discusses, and which of them your own numbers can carry
...
Example (made up): first choice, yes, three of three. Path, yes. Directness, yes. Success rate as a percentage, no, because three people cannot make one.

</details>


### Split by first click

Section: practice-plan. Stable action: step-2-brief.

Your failed tasks sorted into the ones where the top level was chosen correctly and the ones where the first choices scattered.
...
**Start here:** Sort the results table by the first-choice column and read the failed rows in two piles.

**Enough:** Each pile has a written sentence saying where the fault cannot be.
...
Made-up example. Reading a bad-looking tree test as a broken structure, and finding that the top of it was fine.
...
**Wrong turn:** The wrong turn is reading a count of failures as a verdict on the whole structure. Failures concentrate, and a redesign discards the parts that were working.

**Trade-off:** Keeping a structure you have just watched fail feels like defending it. It costs you the satisfaction of a fresh start, and it keeps the risks you had already tested away.

**Unknown:** Still unknown: whether the top level survives tasks you did not write. Six tasks with three people cannot cover a structure.


### Which failed tasks had a correct first choice, and which scattered across branches

Section: practice-plan. Stable action: write-first-click-split.

Write your answer for “Which failed tasks had a correct first choice, and which scattered across branches”. Use the task instructions below to decide what to include.

**Answer:** Which failed tasks had a correct first choice, and which scattered across branches




### What each of those two groups tells you about where the fault cannot be

Section: practice-plan. Stable action: write-split-implication.

Finish the sentence “because they chose correctly at the top, the fault is not …”.

**Answer:** What each of those two groups tells you about where the fault cannot be
...
A named cause for each failure — a wrong label, a wrong grouping or a missing item — with the path or the quotation that supports it.
...
**Start here:** Take the failure you are surest about and write the path first, then the cause it points to.

**Enough:** Any cause you cannot support with a path or a quotation is written down as a guess.
...
Six failed-task lines from somebody else’s tree test, all made up for practice. For each one, name the cause you would write in your own table.
...
### Failure 1 · the task, the cause you name, and the evidence for it
...
Example (made up): the move-my-booking task. Cause: wrong label. All three reached Change or cancel and stopped at Booking admin, and one said “that sounds like something for staff”.
...
Write your answer for “Failure 2 · the task, the cause you name, and the evidence for it”. Use the task instructions below to decide what to include.

**Answer:** Failure 2 · the task, the cause you name, and the evidence for it
...
Write your answer for “Failure 3 · the task, the cause you name, and the evidence for it”. Use the task instructions below to decide what to include.

**Answer:** Failure 3 · the task, the cause you name, and the evidence for it
...
Write your answer for “Failure 4 · the task, the cause you name, and the evidence for it”. Use the task instructions below to decide what to include.

**Answer:** Failure 4 · the task, the cause you name, and the evidence for it
...
Exactly one change, and a re-test of only the tasks it was aimed at.
...
**Start here:** Choose the diagnosis you are surest about and change that one thing on one sheet.

**Enough:** The before and after structures differ in one respect. If nobody was available to re-test, choose the untested option and say so wherever the change appears; running it on yourself is not a re-test, because you wrote the new label.
...
Made-up example. Re-testing one renamed label with the same two people, and learning nothing whatever about the label.
...
**Wrong turn:** The wrong turn is re-testing with the people you already have. They are willing, they are quick, and they are the only people in the world who cannot tell you whether a new label reads clearly.

**Trade-off:** Fresh people are the thing you have least of, and holding to this often means the change goes into the record as untested. An untested change you have labelled honestly is worth more than a tested-looking one you cannot trust.

**Unknown:** Still unknown, even with two fresh people: whether the new label works for somebody who has never thought about booking a class at all. Two is two.


### The single change you made, and the diagnosis it is aimed at

Section: practice-plan. Stable action: write-one-change.

One sheet, one label, one move. If you cannot describe it in a sentence it is more than one change.

**Answer:** The single change you made, and the diagnosis it is aimed at

One sheet, one label, one move. If you cannot describe it in a sentence it is more than one change.


### How the re-test actually happened

Section: practice-plan. Stable action: write-retest-route.

Choose the option that honestly describes your work.

**Answer:** How the re-test actually happened (Two or more people who had not seen the structure, with consent / One person only, with consent, and the gap recorded / Nobody was available: the change is recorded as untested and never described as an improvement)
...
Check again: The split names which failures had a correct first choice and which scattered.

Answers to revisit: first-click-split, split-implication, improvement-made
...
Check again: The before and after structures differ in one respect only.

Answers to revisit: one-change, retest-route, retest-results, improvement-made
...
Check again: The outcome says what happened, and every unfixed failure still carries its diagnosis.
...
### Report honestly and pause

Section: practice. Stable action: step-5-brief.

What the change did, what is still failing, and the repair the Check questions asked for.
...
**Start here:** Write the outcome sentence with the counts inside it before you write anything else.

**Enough:** Every failure you did not address is still on the list with its diagnosis attached.
...
### What the change did, including if it did not help or made things worse

Section: practice. Stable action: write-outcome.

Write the counts into the sentence. Two of two, or one of two, says more than better or worse.

**Answer:** What the change did, including if it did not help or made things worse
...
Section: practice. Stable action: write-remaining-failures.

Write your answer for “Every failure you have not addressed, with the diagnosis it still carries”. Use the task instructions below to decide what to include.

**Answer:** Every failure you have not addressed, with the diagnosis it still carries
...
Open Your work and choose Ready for review. The next lesson matches the failures you still cannot explain to the test that would explain them.
...
- R61: [NN/g: interpreting tree test results](https://www.nngroup.com/articles/interpreting-tree-test-results/) — Success rate, directness, time and pathway analysis, and translating findings into relabelling, cross-listing or restructuring. Purpose: Supplies the diagnostic vocabulary and the mapping from a symptom to a specific structural move. Free reading, no account. Verified 2026-09-06; published 19 January 2024. Its success-rate benchmarks come from studies far larger than yours: at three to five participants report counts and first clicks, not rates against a band. It does not explain significance testing and does not cover running the test. Fallback: R37.
- R37: [NN/g: confidence intervals and margins of error](https://www.nngroup.com/articles/confidence-interval/) — How sample size affects the width of an interval, read as the reason a benchmark comparison is unavailable to you. Purpose: Makes concrete why a five-participant success rate cannot be compared with a published benchmark. Free reading, no account. Verified 2026-09-06. No formulas; used here as an argument about what not to report. Fallback: R45.
...
Repair: Return to the results table and sort by first choice. Write one sentence per group on where the fault cannot be. Recheck: The split with its implications.
...
Repair: For each failure, quote the path and anything the participant said. If neither supports your cause, the diagnosis is a guess and should be marked as one. Recheck: The diagnoses with evidence.
...
Repair: Revert to the tested structure, apply the single change you consider clearest, and re-run only the affected tasks with someone new. Recheck: The two structures and the re-test results.
...
Bring: Everything you have run so far and the failures you have not yet explained. This lesson is about the failures your card sort and tree test could not diagnose.
...
### Read the four methods

Section: practice-plan. Stable action: step-1-brief.

One sentence per test on what it identifies, and one on what it is blind to, in your own words.

- Read the assigned article. For each of the four tests, write in one sentence what it diagnoses and what it cannot see.

**Start here:** For each test, finish the sentence “this cannot tell me …”.

**Enough:** No two blind-spot sentences are the same.
...
### For each of the four tests: one sentence on what it identifies, and one on what it cannot see

Section: practice-plan. Stable action: write-test-blind-spots.

If two of your blind-spot sentences say the same thing, the tests are not yet separate in your head.

**Answer:** For each of the four tests: one sentence on what it identifies, and one on what it cannot see
...
Example (made up): a tree test tells me whether the branches send people the right way. It cannot tell me whether anyone would use the menu at all, because it has taken the screen away.
...
Section: practice-plan. Stable action: write-cheapest-check.

Write your answer for “The cheaper move before any test: which of your failures might just be a missing or badly written answer”. Use the task instructions below to decide what to include.

**Answer:** The cheaper move before any test: which of your failures might just be a missing or badly written answer




### List your unexplained failures

Section: practice-plan. Stable action: step-2-brief.

Every finding from your sort, your tree test and your research that you could not explain, with where each one came from.
...
**Start here:** Read your session notes for every moment somebody could not find something, including the ones you assumed you understood.

**Enough:** Every symptom has a source beside it. If your only source is a walkthrough you did alone, keep the symptoms and mark each one as your own suspicion; the plan is still worth writing, and a suspicion is never written up as a finding.
...
Made-up example. Writing the list of unexplained failures for a class-booking site, and quietly leaving off the three I thought I had already explained.
...
**Wrong turn:** The wrong turn is treating a reason you invented for a failure as an explanation of it. It is tempting because a reason closes that line, and a list of three feels finished a great deal sooner than a list of six.

**Trade-off:** Keeping the ones you thought you had explained gives you more symptoms than your plan can possibly cover, so you will have to leave some untested and say plainly which. You buy a shorter list of tests with a longer list of symptoms.

**Unknown:** Still unknown: whether the reasons you kept hold up either. A source line tells you where a symptom came from. It does not tell you that your reading of it was the only reading available.
...
At least four symptoms, each with the cause you suspect, the test that would identify it, roughly how many people, and what it would cost you.
...
**Start here:** Take the symptom you understand least and write two possible causes for it before you write any test.

**Enough:** Every row names a cause, and the test named beside it is the one that would separate that cause from the others.
...
Made-up example. Choosing a usability test for every symptom, and learning nothing about any of them.
...
**Wrong turn:** The wrong turn is picking the test that sees the most. It is also the test that tells you the least per person about which single thing is at fault.

**Trade-off:** A narrow test asks you to commit to a suspected cause before running, and you can be wrong. It buys you an answer about one thing with three people and twenty minutes each.

**Unknown:** Still unknown: whether the cause you suspect is the only one. A narrow test that comes back clean sends you to the next suspect rather than to a conclusion.


### Symptom 1 · what happens, the cause you suspect, the test, roughly how many people, and what it costs you

Section: practice-plan. Stable action: write-symptom-1.

If you can think of two possible causes, write both, then say which one you would test first and why.

**Answer:** Symptom 1 · what happens, the cause you suspect, the test, roughly how many people, and what it costs you
...
Example (made up): people reach the right branch and hesitate between two labels. Suspected cause: the names. Test: a closed card sort with only those two categories, three people, about ten minutes each.
...
Section: practice-plan. Stable action: write-symptom-2.

Write your answer for “Symptom 2 · what happens, the cause you suspect, the test, roughly how many people, and what it costs you”. Use the task instructions below to decide what to include.

**Answer:** Symptom 2 · what happens, the cause you suspect, the test, roughly how many people, and what it costs you
...
Section: practice-plan. Stable action: write-symptom-3.

Write your answer for “Symptom 3 · what happens, the cause you suspect, the test, roughly how many people, and what it costs you”. Use the task instructions below to decide what to include.

**Answer:** Symptom 3 · what happens, the cause you suspect, the test, roughly how many people, and what it costs you
...
Section: practice-plan. Stable action: write-symptom-4.

Write your answer for “Symptom 4 · what happens, the cause you suspect, the test, roughly how many people, and what it costs you”. Use the task instructions below to decide what to include.

**Answer:** Symptom 4 · what happens, the cause you suspect, the test, roughly how many people, and what it costs you




### Separate findability from discoverability
...
**Enough:** Every symptom marked as never knowing says where the fix would sit instead.
...
Section: practice-plan. Stable action: write-findability-marks.

Write your answer for “Each symptom marked: a person looking for a thing and not reaching it, or a person who never knew it existed”. Use the task instructions below to decide what to include.

**Answer:** Each symptom marked: a person looking for a thing and not reaching it, or a person who never knew it existed
...
Check again: Each symptom names the cause you suspect, and the test beside it follows that cause.

Answers to revisit: symptom-1, symptom-2, symptom-3, symptom-4, improvement-made
...
Check again: Any symptom about a component being ignored is matched to a test that shows the layout.

Answers to revisit: unexplained-failures, symptom-sources, symptom-1, symptom-2, symptom-3, symptom-4, improvement-made
...
Check again: Every symptom names where it came from, and no rehearsal observation is described as a research finding.

Answers to revisit: unexplained-failures, symptom-sources, improvement-made

</details>


### Choose the next test and pause

Section: practice. Stable action: step-5-brief.

The test you would run next, the result that would send you to a different one, and the repair the Check questions asked for.
...
**Start here:** Write “I will run … because I suspect …, and if I see … I will run … instead”.

**Enough:** The sentence names a suspected cause and a result that would change your mind.
...
### The symptom you chose, the test you would run, and why that one rather than the others

Section: practice. Stable action: write-next-test-sentence.

Write it as “I will run … because I suspect …”. A test you cannot finish that sentence for is not chosen yet.

**Answer:** The symptom you chose, the test you would run, and why that one rather than the others
...
Section: practice. Stable action: write-change-my-mind.

Write your answer for “The result that would make you abandon that test and run a different one”. Use the task instructions below to decide what to include.

**Answer:** The result that would make you abandon that test and run a different one
...
Open Your work and choose Ready for review. The next lesson takes one page inside this structure and makes its shape perceivable.
...
Repair: For each test, complete the sentence “this cannot tell me …”. If two of your answers are the same, you have not yet distinguished the tests. Recheck: The four test descriptions with blind spots.
...
Repair: Go back through your session notes for every moment a participant could not find something and add each to the list, including the ones you assumed you understood. Recheck: The symptom list with sources.
...
Repair: For each symptom ask whether the person knew the thing existed. If they did not, no test that names the target can help, and the fix is elsewhere. Recheck: The marked symptom list.
...
[NN/g: four tests for low findability](https://www.nngroup.com/articles/navigation-ia-tests/).

</details>

## Lesson 10: Structure people can perceive: headings, landmarks and navigation

Stable ID: m06-l10-v1. Core.
...
Recommended route: Draw the page with its regions marked on paper, then record what you drew in the worksheet here so it is saved and reviewable. Photograph the sheet if you can and note the file name; the photo stays in your own folder. Alternative route: Prefer one file on your computer? Use the local text-file route below with the copyable starter table, and note the file location in Your work.

- Write answers in this course. Keep drawings in your own paper folder or file and record their location. You can stop and resume after any action.


### Read the structure tutorial

Section: practice-plan. Stable action: step-1-brief.

The heading rule in your own words, and the one page you are going to work on.
...
### The heading rule, written by you, including what skipping a level does

Section: practice-plan. Stable action: write-heading-rule.

Headings are an outline, not a size choice. Say what goes wrong when a level is skipped to make something look smaller.

**Answer:** The heading rule, written by you, including what skipping a level does
...
Section: practice-plan. Stable action: write-page-chosen.

Write your answer for “The page you are working on, and where it sits in your structure”. Use the task instructions below to decide what to include.

**Answer:** The page you are working on, and where it sits in your structure
...
Example (made up): the Saturday pottery class page, sitting under Choose a class.

</details>


### Write the heading outline

Section: practice-plan. Stable action: step-2-brief.

One page title, then every section heading in order, each one inside the heading above it.
...
**Start here:** Write the page title first, then list the sections in the order they appear on the page, before worrying about levels.

**Enough:** No level is skipped, and every heading came from your labelling table or is marked as invented today.
...
Made-up example. Writing the heading outline for a class page, and finding that three of the five headings said nothing.
...
**Wrong turn:** The wrong turn is choosing a heading level for how big it looks. The level is a claim about what sits inside what, and spending it on size quietly deletes a section from the outline.

**Trade-off:** Descriptive headings are longer and the page looks less tidy. You give up a neat column of short words to gain a page someone can skim without reading it.

**Unknown:** Still unknown: whether these headings work for someone using a screen reader. Reading them aloud yourself is a different test, and no session has been run.


### The page title, the single heading at the top

Section: practice-plan. Stable action: write-page-title.

Write your answer for “The page title, the single heading at the top”. Use the task instructions below to decide what to include.

**Answer:** The page title, the single heading at the top
...
Example (made up): Saturday pottery.

</details>


### Every section heading in order, indented to show what sits inside what

Section: practice-plan. Stable action: write-outline-list.

A numbered, indented list is enough. Two spaces of indent shows that a heading belongs inside the one above it.

**Answer:** Every section heading in order, indented to show what sits inside what
...
Example (made up): 1 What you’ll do · 2 What to bring · 3 When and where · 4 What it costs · 5 Book a place.

</details>


### Which headings came from your labelling table, and which you invented today

Section: practice-plan. Stable action: write-outline-source.

Anything invented today has no evidence behind it yet. Mark it as a guess, the way you marked labels in lesson 2.

**Answer:** Which headings came from your labelling table, and which you invented today

Anything invented today has no evidence behind it yet. Mark it as a guess, the way you marked labels in lesson 2.


### Mark the regions and the navigation kinds

Section: practice-plan. Stable action: step-3-brief.

The five regions named, and every navigation element sorted into one of the four kinds.
...
**Start here:** Draw a box around each region on your sketch and write its name in the margin. Then list every link that is not part of the main content.

**Enough:** Every link outside the main content has one of the four kinds beside it. A link you cannot classify usually belongs somewhere else.
...
Made-up example. Marking the regions on a class page sketch, and calling a whole strip navigation because it ran along the top.
...
**Wrong turn:** The wrong turn is marking regions by where things sit on the screen. One strip along the top looks like a single thing, and it usually holds three different kinds that somebody moving by region needs kept apart.

**Trade-off:** Splitting that strip means your sketch no longer matches the neat row you designed, and anyone reading it will ask why three boxes cover something that looks like one. What you gain is a jump to the main content that lands on the thing the page exists to do.

**Unknown:** Still unknown: whether somebody who moves by region would draw the line between banner and navigation where you drew it. That is a question for a person who works that way, and no such session has happened.


### The regions of the page named, and what sits in each one

Section: practice-plan. Stable action: write-region-map.

Banner, main navigation, main content, a side area if there is one, footer. Draw them on your sketch and list them here.

**Answer:** The regions of the page named, and what sits in each one
...
Section: practice-plan. Stable action: write-nav-kinds.

Write your answer for “Every navigation element, with global, local, contextual or utility written beside it”. Use the task instructions below to decide what to include.

**Answer:** Every navigation element, with global, local, contextual or utility written beside it
...
Example (made up): Classes, Book, Help — global · Beginner, Advanced — local · “see what to bring” inside the description — contextual · Sign in, Language — utility.
...
Section: practice-plan. Stable action: write-misplaced.

Write your answer for “Anything sitting in the wrong region or under the wrong kind”. Use the task instructions below to decide what to include.

**Answer:** Anything sitting in the wrong region or under the wrong kind




### Read it aloud and run the checks

Section: practice-plan. Stable action: step-4-brief.

What the headings alone said out loud, what you rewrote, and what the preliminary checks showed.
...
### What your headings alone said when you read them out, and what you rewrote afterwards
...
The page title in the browser tab, the heading order, and reaching everything with the Tab key. Write what each one showed, not a verdict.

**Answer:** The preliminary checks you ran, and what each one showed
...
Check again: No level is skipped, and each heading is a real subsection of the heading above it.

Answers to revisit: page-title, outline-list, outline-source
...
Check again: Every check has a status beside it, and the record says plainly what was not tested.

Answers to revisit: not-verified, no-at-session, artefacts, improvement-made

</details>


### Record what you could not verify, then pause

Section: practice. Stable action: step-5-brief.

What you could not check, the sentence about the missing session, where the artefacts live, and the repair the Check questions asked for.
...
**Start here:** List the preliminary checks and put run, not applicable or not run beside each. Then write the one sentence about who did not take part.

**Enough:** A reader can tell exactly which checks happened, and nothing is recorded as passed that was never run.
...
Mark each check run, not applicable, or not run. A check you skipped is not a check that passed.

**Answer:** Which checks you could not run, and why
...
Section: practice. Stable action: write-no-at-session.

Write your answer for “Your sentence saying no screen-reader session and no disabled participant took part”. Use the task instructions below to decide what to include.

**Answer:** Your sentence saying no screen-reader session and no disabled participant took part
...
Example (made up): checked by me on 8 September; no screen reader was used and no disabled participant took part.

</details>


### Where the outline, the region sketch and the check results live

Section: practice. Stable action: write-artefacts.

File names, or “paper, in my folder”. Nothing is uploaded.

**Answer:** Where the outline, the region sketch and the check results live
...
Open Your work and choose Ready for review. The next lesson takes these same labels into search, where people type their own words at you.
...
Repair: Write the outline as a numbered list and check each item is genuinely a subsection of the one above. Rewrite every heading you could move to another page without noticing. Recheck: The corrected outline.
...
Repair: Draw the page and outline each region. Then list every link outside the main content and assign it one of the four kinds; links you cannot classify usually belong somewhere else. Recheck: The region map and classification.
...
[W3C: page structure](https://www.w3.org/WAI/tutorials/page-structure/). [Web Accessibility Perspectives: Clear Layout and Design](https://www.w3.org/WAI/perspective-videos/layout/). No video needed: the assigned structure tutorial covers the same ground in text. Write the heading outline first, then read it back with everything else covered.

</details>

## Lesson 11: Search, filters and the zero-results path

Stable ID: m06-l11-v1. Core.
...
Bring: Your labelling table, your inventory and any m05 evidence of people going straight to search. Search is where your labelling failures surface as typed words.
...
### Read on prevention and recovery

Section: practice-plan. Stable action: step-1-brief.

Your own sentence on preventing a dead end against getting somebody out of one, and what your notes say about search.
...
**Start here:** Write one example of each: something the design stops happening, and something the design helps somebody recover from.
...
Section: practice-plan. Stable action: write-prevent-vs-recover.

Write your answer for “The difference between stopping a dead end and helping somebody out of one, in your own words”. Use the task instructions below to decide what to include.

**Answer:** The difference between stopping a dead end and helping somebody out of one, in your own words




### What your practice product offers today

Section: practice-plan. Stable action: write-search-today.

Choose the option that honestly describes your work.

**Answer:** What your practice product offers today (A search box on the site / No search box at all / Only the browser’s own find-in-page)




### What your m05 notes show about people going straight to search instead of the menu
...
At least twenty queries in your participants’ own words, sorted into names, descriptions and questions.
...
Made-up example. Building a twenty-query list from interview notes, and tidying every phrase into the words the site already uses.
...
**Wrong turn:** The wrong turn is writing the query list from memory instead of from the notes. Your own wording arrives faster, and it is already the wording your pages use, so every query on that list would have found something.

**Trade-off:** Copying phrases exactly gives you a messy list: repeats, half-sentences, two people asking the same thing in different words, and no clean way to sort it into three kinds. What it buys is a list that is able to fail, which is the only kind worth running.

**Unknown:** Still unknown: whether people type the words they say. A phrase somebody spoke aloud in an interview may become three words in a search box, and nobody here has been watched typing.


### At least twenty phrases your participants used, word for word, one per line
...
Example (made up): “what do I need to bring” · “fees” · “can I get my money back” · “where is it”.
...
Each query run by hand against your own content, with every failure given one cause.
...
**Start here:** Take the first query and search your content for that exact phrase before you allow yourself to think of a better one.

**Enough:** Every failed query has one cause beside it, and you could say why it is that cause and not the next one.
...
Made-up example. Running twenty queries by hand against a class provider’s pages, and blaming the wrong thing for the failures.
...
**Wrong turn:** The wrong turn is calling every failed query a search problem. It is the fix you can imagine buying, and it leaves the missing content exactly as missing as it was.

**Trade-off:** Placing nine failures one at a time takes an afternoon and gives you three pieces of work instead of one. What it buys is fixes that land on the actual fault.

**Unknown:** Still unknown: whether twenty phrases from five people cover the words other people would type. It is a starting list, not a vocabulary study.


### Query by query: would the right thing have been found?

Section: practice-plan. Stable action: write-query-results.

Search your own content by hand, with find-in-page or by reading. Write found or not found beside each one.

**Answer:** Query by query: would the right thing have been found?
...
Section: practice-plan. Stable action: write-failure-classes.

Write your answer for “Every failed query with its cause: a vocabulary gap, content nobody can reach, or a thing that does not exist”. Use the task instructions below to decide what to include.

**Answer:** Every failed query with its cause: a vocabulary gap, content nobody can reach, or a thing that does not exist
...
Section: practice-plan. Stable action: write-hardest-call.

Write your answer for “The failure you found hardest to place, and how you decided”. Use the task instructions below to decide what to include.

**Answer:** The failure you found hardest to place, and how you decided




### Design the filters and the empty state

Section: practice-plan. Stable action: step-4-brief.

Filter categories, what an empty combination does, and a zero-results screen that offers a next move.
...
**Start here:** Write the zero-results screen first, while the failures from step 3 are still in front of you.

**Enough:** Your empty screen offers at least two ways forward, and one of them does not involve typing.
...
Section: practice-plan. Stable action: write-filter-categories.

Write your answer for “Your filter categories, taken from the structure, and the words on each one”. Use the task instructions below to decide what to include.

**Answer:** Your filter categories, taken from the structure, and the words on each one
...
Section: practice-plan. Stable action: write-empty-combination.

Write your answer for “What happens when a combination returns nothing, and how the person sees which choice caused it”. Use the task instructions below to decide what to include.

**Answer:** What happens when a combination returns nothing, and how the person sees which choice caused it




### Your zero-results screen: the query shown back, the nearest things you do have, a route that does not need the same words, and a way to reach a person

Section: practice-plan. Stable action: write-zero-results-design.

Sketch it if that is easier, then describe it here in four lines.

**Answer:** Your zero-results screen: the query shown back, the nearest things you do have, a route that does not need the same words, and a way to reach a person
...
Check again: Every vocabulary gap has a fix that changes the words on the page, not only the search.

Answers to revisit: query-results, failure-classes, hardest-call, improvement-made
...
Check again: The empty-combination note names what is shown and what can be undone on its own.

Answers to revisit: filter-categories, empty-combination, zero-results-design
...
Check again: Unreachable answers sit apart from missing ones, and each class has its own fix.
...
### Decide the fixes and pause

Section: practice. Stable action: step-5-brief.

A fix for each failure class, which ones need no search engine, and the repair the Check questions asked for.
...
**Start here:** Take the vocabulary gaps first; they are usually fixed by adding the words people use to the page itself.

**Enough:** Each of your three failure classes has its own fix, and the fixes are different from each other.
...
Section: practice. Stable action: write-fix-per-class.

Write your answer for “The fix for each failure class: content wording, a missing item, or search behaviour”. Use the task instructions below to decide what to include.

**Answer:** The fix for each failure class: content wording, a missing item, or search behaviour
...
Section: practice. Stable action: write-no-engine-fixes.

Write your answer for “Which of your fixes need no search engine at all”. Use the task instructions below to decide what to include.

**Answer:** Which of your fixes need no search engine at all
...
Open Your work and choose Ready for review. The last lesson of the module puts your labels under pressure and closes everything into a change note.
...
- R36: [NN/g: preventing user errors](https://www.nngroup.com/articles/user-mistakes/) — The distinction between slips and mistakes, and the sections on prevention, feedback and recovery. Purpose: Supplies the prevention-versus-recovery frame the filter and zero-results design turns on. Free reading, no account. Verified 2026-09-06. It is about errors in general rather than search specifically; the search and filter application here is the course's own. Fallback: R02.
- R02: [Nielsen: ten usability heuristics](https://www.nngroup.com/articles/ten-usability-heuristics/) — Heuristic 1, visibility of system status, and heuristic 9, help users recognise, diagnose and recover from errors. Purpose: Sets the standard for what a person must be told when a search or filter returns nothing. Free reading, no account. Verified 2026-09-06. Heuristics identify candidate problems; the hand-run query list is the evidence in this lesson. Fallback: R11.
...
Repair: Return to your interview notes and copy out every phrase a participant used to describe something they were looking for, including the vague ones. Recheck: The verbatim query list.
...
Repair: For each failure ask whether the thing exists, whether it is reachable, and whether the words match. The first no is the cause. Recheck: The classified failure list with fixes.
...
Repair: Sketch the screen as though the person searching is about to give up, and give them three ways forward that do not require them to guess a different word. Recheck: The zero-results design.
...
Bring: The whole module: inventory, labels, structure, sort and tree-test results, page outline and search work. This lesson closes it into something another person could pick up.
...
### Read the internationalization guidance

Section: practice-plan. Stable action: step-1-brief.

What room to grow means, two India requirements that apply to your labels, and which labels you expect to break.
...
**Start here:** Write your predictions before you test anything. Being wrong about them is the useful part.
...
Section: practice-plan. Stable action: write-expansion-rule.

Write your answer for “What room to grow means for a label set, and two requirements from the India guidelines that apply to yours”. Use the task instructions below to decide what to include.

**Answer:** What room to grow means for a label set, and two requirements from the India guidelines that apply to yours
...
Section: practice-plan. Stable action: write-predicted-breaks.

Write your answer for “Which of your labels you expect to break, and why”. Use the task instructions below to decide what to include.

**Answer:** Which of your labels you expect to break, and why
...
Example (made up): “Change or cancel a booking” is the longest thing in the menu, so it goes first at any narrow width.
...
**Enough:** Each break names the label, the place it appears, and what happened to it.
...
**Wrong turn:** The wrong turn is testing a label in the one place you designed it and calling the whole set safe. A label breaks where it is tightest, which is almost never the menu.

**Trade-off:** Checking every place a label appears turns a ten-minute test into an hour. It is the difference between a note saying “fine” and a note somebody else can act on.
...
Section: practice-plan. Stable action: write-script-result.

Write your answer for “In an Indic script: clipped marks, missing characters, rows that no longer fit”. Use the task instructions below to decide what to include.

**Answer:** In an Indic script: clipped marks, missing characters, rows that no longer fit




### How you produced the second-script version

Section: practice-plan. Stable action: write-script-method.

Choose the option that honestly describes your work.

**Answer:** How you produced the second-script version (Rendered on screen / Written by hand on paper / Both)




### Test narrow and slow
...
Go back through your own break list and write one of the four words beside every line. Anything you cannot label is usually two problems written as one.
...
Write your answer for “At about 320 px: every label that wrapped, was cut off, or ran off the edge”. Use the task instructions below to decide what to include.

**Answer:** At about 320 px: every label that wrapped, was cut off, or ran off the edge




### On a throttled connection with the cache off: what arrived first, and whether it made sense on its own
...
**Start here:** Start with whatever was cut off, since that is the break that removes meaning rather than moving it.
...
Made-up example. Shortening a cut-off label so it fits the button, and losing the word that told it apart from the item beside it.
...
**Wrong turn:** The wrong turn is shortening a label to whatever fits. The fit is the visible problem and it is gone in seconds, while the word you dropped was carrying the whole difference between that label and its neighbour.

**Trade-off:** Splitting one item into two makes the menu longer, and that is a real cost: more to read, more to scan past, and one more line for a translator to handle. You pay for it with the space you were trying to save.

**Unknown:** Still unknown: whether two separate items read as two separate actions to somebody meeting them fresh. Your sort showed people separating the ideas. It did not show anybody meeting these particular words on a button.
...
Write your answer for “What you changed, label by label, and how the new label keeps the word that tells it apart”. Use the task instructions below to decide what to include.

**Answer:** What you changed, label by label, and how the new label keeps the word that tells it apart
...
Section: practice-plan. Stable action: write-split-labels.

Write your answer for “Any label that turned out to be two items”. Use the task instructions below to decide what to include.

**Answer:** Any label that turned out to be two items
...
Section: practice-plan. Stable action: write-recheck-result.

Write your answer for “The two worst cases run again, and what happened”. Use the task instructions below to decide what to include.

**Answer:** The two worst cases run again, and what happened
...
Check again: No repaired label depends on being cut short, and any split label now appears as two items.

Answers to revisit: narrow-result, slow-result, repairs, split-labels, recheck-result
...
Check again: The script result says what was checked and what could not be, with nothing assumed to have passed.

Answers to revisit: padded-result, script-result, script-method, improvement-made
...
Check again: Every line in the note either names its evidence or sits in the guesses list.

Answers to revisit: decisions-and-evidence, rejected, still-guesses, test-next, improvement-made

</details>


### Write the change note and pause

Section: practice. Stable action: step-5-brief.

The change note: each decision with its evidence, what you rejected, what is still a guess, and the repair the Check questions asked for.
...
**Start here:** Work backwards through the module, one line per decision, and leave the evidence column empty where there is none.

**Enough:** Every line either names its evidence or sits in the guesses, and somebody else could pick the structure up from this note alone.
...
Section: practice. Stable action: write-decisions-and-evidence.

Write your answer for “Every structural decision from this module, one line each, with the evidence beside it”. Use the task instructions below to decide what to include.

**Answer:** Every structural decision from this module, one line each, with the evidence beside it
...
Example (made up): split change from cancel · four of four sorters separated them · card sort, lesson 5.
...
Section: practice. Stable action: write-rejected.

Write your answer for “What you considered and did not do, and why”. Use the task instructions below to decide what to include.

**Answer:** What you considered and did not do, and why




### What is still a guess, and what remains untested
...
Section: practice. Stable action: write-test-next.

Write your answer for “What you would test next, and with whom”. Use the task instructions below to decide what to include.

**Answer:** What you would test next, and with whom
...
Open Your work and choose Ready for review. Module 7 turns this structure into task flows, and it starts from your change note.
...
Repair: For each truncating label, write a shorter version that keeps the distinguishing word. If no shorter version works, the item is probably two items. Recheck: The repaired label set and re-check results.
...
[W3C: localization versus internationalization](https://www.w3.org/International/questions/qa-i18n).
